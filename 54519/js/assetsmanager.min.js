...
! function(e) {
    ...
    e.nameSelector = r, e.typeSelector = t, e.registerAnalyzer = o, e.setIsCompatible = n, e.isCompatible = !1, e.loadConfig = i, e.loadGroup = s, e.isGroupLoaded = u, e.getGroupByName = c, e.createGroup = l, e.hasRes = f, e.getRes = p, e.getResAsync = g, e.getResByUrl = d, e.destroyRes = v, e.setMaxLoadingThread = h, e.setMaxRetryTimes = m, e.addEventListener = R, e.removeEventListener = E, e.$addResourceData = y, e.getVersionController = _, e.registerVersionController = S, e.getVirtualUrl = L;
    var D = function(r) {
        function t() {
            ...
            onLoadStart: function(r, t) {
                return r.load(t, "json").then(function(o) {
                    ...
                    for (var f = n.alias, p = a.fsData, g = function(e) {
                        ...
                        }, d = 0, v = o.resources; d < v.length; d++) {
                        var h = v[d];
                        g(h)
                    }
                    return r.save(t, o), o
