    ...
    ! function(t) {
        var r = function() {
            ...
            return t.detect = function() {
                ...
                r.isMobile = -1 != i.indexOf("mobile") || -1 != i.indexOf("android"), r.isMobile ? i.indexOf("windows") < 0 && (-1 != i.indexOf("iphone") || -1 != i.indexOf("ipad") || -1 != i.indexOf("ipod")) ? r.os = "iOS" : -1 != i.indexOf("android") && -1 != i.indexOf("linux") ? r.os = "Android" : -1 != i.indexOf("windows") && (r.os = "Windows Phone") : -1 != i.indexOf("windows nt") ? r.os = "Windows PC" : "MacIntel" == navigator.platform && navigator.maxTouchPoints > 1 ? (r.os = "iOS", r.isMobile = !0) : -1 != i.indexOf("mac os") && (r.os = "Mac OS");
    ...
    ! function(t) {
        var r = function(r) {
            ...
            return __extends(i, r), Object.defineProperty(i.prototype, "length", {
                ...
                this.loaded && this.originAudio && (this.originAudio.src = ""), this.originAudio && (this.originAudio = null), i.$clear(this.url), this.loaded = !1
            }, i.$clear = function(e) {
                i.clearAudios[e] = !0;
                var t = i.audios[e];
                t && (t.length = 0)
