...
BasicGame.Gameover.prototype = {
	...
	create: function () {
		...
		this.title = this.game.add.sprite(250, 200, 'game over');
		this.title.anchor.set(.5);
		this.title.scale.set(.5);
		this.group.add(this.title);
		this.PlayAgainButton = this.game.add.sprite(300, 500, 'btns0014');
