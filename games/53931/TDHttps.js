...
let TDinit = function () {
    ...
    v.prototype = {
        ...
        init: function () {
            ...
            //  e(window, "beforeunload", a.pageLogout),
             ...
             window.TDAPP.onPage = a.onPage,
              l.autoTrack && (a.currentPage = window.location.href, a.ref = document.referrer)
        },
        onPage: function (e) {
            var t = (new Date).getTime();
            a.pageLogout("force"), 
            a.pageEnter(e, a.currentPage, t),
             a.ref = a.currentPage, a.currentPage = e,
              a.pageStartTime = t, T.getAjax()
        },
     ...
     window.TDAPP.login = f.login, window.TDAPP.register = f.register,
      window.TDAPP.updateProfile = f.updateProfile, window.TDAPP.ProfileType = {
        0: "ANONYMOUS",
        1: "REGISTERED",
        2: "SINA_WEIBO",
        3: "QQ",
    ...
    }, window.TDAPP = window.TDAPP || {}, window.TDAPP.onPlaceOrder = n.onPlaceOrder,
     window.TDAPP.onOrderPaySucc = n.onOrderPaySucc, window.TDAPP.onCancelOrder = n.onCancelOrder;
    var S = l.localStorage,
        ...
        T = {
            ...
            setSession: function () {
                var e, t;
                if (s.get("sessionId") && S.get("appkey") == u.appkey ?
                
                t = s.get("sessionId") : (e = (new Date).getTime(), t = -1 < this.deviceId.indexOf("-") ?
                 this.deviceId.split("-")[0] + e : this.deviceId + e, this.sendInit = 0 == this.sendInit ? 2 : this.sendInit, 
                 s.add("sessionId", t))
        ...
        set: function (e, t, n, o) {
            ...
            if (e || /0{1}/.test(e)) {
                if (0 < arguments.length) try {
                    ...
                    if (null != e && (i.id = "string" != typeof e ? JSON.stringify(e) : e),
                     i.label = null != t ? "string" != typeof t ? JSON.stringify(t) : t : "", 
                     null != n && ("object" != (void 0 === (r = n) ? "undefined" : _(r)) || "[object object]" != Object.prototype.toString.call(r).toLowerCase() || r.length || (i.params = n)), o && "smart" === o) i.type = "smart";
                    else if (void 0 !== o) {
