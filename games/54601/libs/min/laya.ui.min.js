!function (t, e) {
  ...
  class s {}
  s.touchScrollEnable = !0;
  s.mouseWheelEnable = !0;
  s.showButtons = !0;
  s.popupBgColor = "#000000";
  s.popupBgAlpha = .5;
  s.closeDialogOnSide = !0;
  window.UIConfig = s;
  class i {}
  i.defaultSizeGrid = [4, 4, 4, 4, 0];
  i.labelColor = "#000000";
  i.labelPadding = [2, 2, 2, 2];
  i.inputLabelPadding = [1, 1, 1, 3];
  i.buttonStateNum = 3;
  i.buttonLabelColors = ["#32556b", "#32cc6b", "#ff0000", "#C0C0C0"];
  i.comboBoxItemColors = ["#5e95b6", "#ffffff", "#000000", "#8fa4b1", "#ffffff"];
  i.scrollBarMinNum = 15;
  i.scrollBarDelayTime = 500;
  class h extends e.Graphics {
    ...
    _createDrawTexture(t, s = 0, i = 0, h = 0, a = 0, r = null, l = 1, n = null, o = null, _) {
      ...
      this._sp && (this._sp._renderType |= e.SpriteConst.GRAPHICS, this._sp._setRenderType(this._sp._renderType));
      return e.DrawTextureCmd.create.call(this, t, s, i, h, a, r, l, n, o, _);
    }
    changeSource() {
      this._isChanged = !1;
      var t = this._source;
    ...
    static getTexture(t, s, i, h, a) {
      ...
      r && r._getSource() || (r = e.Texture.createFromTexture(t, s, i, h, a));
      return r;
    }
    _setDrawGridCmd(t) {
      var e = this._source;
      ...
      if (this._one || s && !(s.length <= 0)) {
        let e = this._one;
        e ? e == this._drawGridCmd ? this._one = t : (this.clear(), this._saveToCmd(null, t), this._saveToCmd(null, e)) : s.splice(0, 0, t);
      } else {
        this._saveToCmd(null, t);
      }
      this._drawGridCmd = t;
    }
  }
  e.ClassUtils.regClass("laya.ui.AutoBitmap", h);
  e.ClassUtils.regClass("Laya.AutoBitmap", h);
  class a extends e.Component {
    ...
    _onDisable() {
      this.owner.off(e.Event.ADDED, this, this._onAdded);
      this.owner.parent && this.owner.parent.off(e.Event.RESIZE, this, this._onParentResize);
    }
    _onAdded() {
      ...
      if (e) {
        if (isNaN(this.centerX)) {
          if (isNaN(this.left)) {
            ...
            t.x = Math.round(this.left + t.pivotX * t.scaleX);
            if (!isNaN(this.right)) {
              if (!e._width) {
                return !1;
              }
      ...
      if (e) {
        if (isNaN(this.centerY)) {
          if (isNaN(this.top)) {
            ...
            t.y = Math.round(this.top + t.pivotY * t.scaleY);
  ...
  e.ILaya.regClass(a);
  a.EMPTY = new a();
  e.ClassUtils.regClass("laya.ui.Widget", a);
  e.ClassUtils.regClass("Laya.Widget", a);
  class r extends e.Event {}
  r.SHOW_TIP = "showtip";
  r.HIDE_TIP = "hidetip";
  e.ILaya.regClass(r);
  e.ClassUtils.regClass("laya.ui.UIEvent", r);
  ...
  l._funMap = null;
  e.ClassUtils.regClass("laya.ui.UIUtils", l);
  e.ClassUtils.regClass("Laya.UIUtils", l);
  class n extends e.Sprite {
    constructor(t = !0) {
      super();
      this._anchorX = NaN;
      this._anchorY = NaN;
      this._widget = a.EMPTY;
      t && (this.preinitialize(), this.createChildren(), this.initialize());
    }
    destroy(t = !0) {
      super.destroy(t);
    ...
    _sizeChanged() {
      ...
      this._widget !== a.EMPTY && this._widget.resetLayout();
    }
    get tag() {
      return this._tag;
    }
    ...
    _getWidget() {
      this._widget === a.EMPTY && (this._widget = this.addComponent(a));
      return this._widget;
    }
    set scaleX(t) {
      this.set_scaleX(t);
    ...
    _childChanged(t = null) {
      ...
      super._childChanged(t);
    }
  }
  e.ILaya.regClass(n);
  e.ClassUtils.regClass("laya.ui.UIComponent", n);
  e.ClassUtils.regClass("Laya.UIComponent", n);
  class o extends n {
    constructor(t = null) {
      super();
      this.skin = t;
    ...
    dispose() {
      this.destroy(!0);
      e.ILaya.loader.clearRes(this._skin);
    }
    createChildren() {
    ...
    set group(t) {
      t && this._skin && e.Loader.setGroup(this._skin, t);
      this._group = t;
    }
    setSource(t, e = null) {
    ...
    set dataSource(t) {
      this._dataSource = t;
      "string" == typeof t ? this.skin = t : super.dataSource = t;
    }
    get dataSource() {
  ...
  e.ILaya.regClass(o);
  e.ClassUtils.regClass("laya.ui.Image", o);
  e.ClassUtils.regClass("Laya.Image", o);
  class _ extends o {
    constructor(t = null) {
      super();
      this.advsListArr = [];
      this.resUrl = "https://unioncdn.layabox.com/config/iconlist.json";
      this._http = new e.Browser.window.XMLHttpRequest();
      this._data = [];
    ...
    updateAdvsInfo() {
      this.visible = !1;
      this.onLunbo();
      e.ILaya.timer.loop(this._lunboTime, this, this.onLunbo);
    }
    onLunbo() {
    ...
    getAdvsQArr(t) {
      var s = [];
      var i = e.LocalStorage.getJSON("gameObj");
      for (var h in t) {
        var a = t[h];
    ...
    destroy(t = !0) {
      e.ILaya.timer.clear(this, this.onLunbo);
      super.destroy(!0);
      this.clear();
      e.ILaya.timer.clear(this, this.onGetAdvsListData);
    }
  }
  e.ClassUtils.regClass("laya.ui.AdvImage", _);
  e.ClassUtils.regClass("Laya.AdvImage", _);
  class c extends n {
    set dataSource(t) {
      this._dataSource = t;
      for (var e in t) {
    ...
    set bgColor(t) {
      this._bgColor = t;
      t ? (this._onResize(null), this.on(e.Event.RESIZE, this, this._onResize)) : (this.graphics.clear(), this.off(e.Event.RESIZE, this, this._onResize));
    }
    _onResize(t) {
      this.graphics.clear();
  ...
  e.ILaya.regClass(c);
  e.ClassUtils.regClass("laya.ui.Box", c);
  e.ClassUtils.regClass("Laya.Box", c);
  class d extends n {
    ...
    initialize() {
      ...
      this._createListener(e.Event.MOUSE_OVER, this, this.onMouse, null, !1, !1);
      this._createListener(e.Event.MOUSE_OUT, this, this.onMouse, null, !1, !1);
      this._createListener(e.Event.MOUSE_DOWN, this, this.onMouse, null, !1, !1);
      this._createListener(e.Event.MOUSE_UP, this, this.onMouse, null, !1, !1);
      this._createListener(e.Event.CLICK, this, this.onMouse, null, !1, !1);
    }
    onMouse(t) {
      if (!1 !== this.toggle || !this._selected) {
        return t.type === e.Event.CLICK ? (this.toggle && (this.selected = !this._selected), void (this._clickHandler && this._clickHandler.run())) : void (!this._selected && (this.state = d.stateMap[t.type]));
      }
    }
    get skin() {
      return this._skin;
    ...
    changeClips() {
      ...
      if (t) {
        ...
        var a = e.WeakObject.I.get(h);
        e.Utils.isOkTextureList(a) || (a = null);
        if (a) {
          this._sources = a;
        } else {
          this._sources = [];
    ...
    measureWidth() {
      ...
      return this._autoSize ? this._bitmap.width : (this.runCallLater(this.changeState), this._bitmap.width + (this._text ? this._text.width : 0));
    }
    measureHeight() {
      this.runCallLater(this.changeClips);
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.label = t + "" : super.set_dataSource(t);
    }
    get dataSource() {
  ...
  e.ILaya.regClass(d);
  e.ClassUtils.regClass("laya.ui.Button", d);
  e.ClassUtils.regClass("Laya.Button", d);
  class u extends d {
    constructor(t = null, e = "") {
      super(t, e);
      this.toggle = !0;
    ...
    set dataSource(t) {
      this._dataSource = t;
      t instanceof Boolean ? this.selected = t : "string" == typeof t ? this.selected = "true" === t : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
  ...
  e.ILaya.regClass(u);
  e.ClassUtils.regClass("laya.ui.CheckBox", u);
  e.ClassUtils.regClass("Laya.CheckBox", u);
  class g extends n {
    ...
    loadComplete(t, s) {
      if (t === this._skin && s) {
        ...
        var h = this._clipHeight || Math.ceil(s.sourceHeight / this._clipY);
        var a = this._skin + i + h;
        var r = e.WeakObject.I.get(a);
        e.Utils.isOkTextureList(r) || (r = null);
        if (r) {
          this._sources = r;
        } else {
          this._sources = [];
    ...
    play(t = 0, s = -1) {
      ...
      this.index = t;
      this._toIndex = s;
      e.ILaya.timer.loop(this.interval, this, this._loop);
      this.on(e.Event.DISPLAY, this, this._onDisplay);
      this.on(e.Event.UNDISPLAY, this, this._onDisplay);
    }
    _loop() {
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.index = parseInt(t) : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
  ...
  e.ILaya.regClass(g);
  e.ClassUtils.regClass("laya.ui.Clip", g);
  e.ClassUtils.regClass("Laya.Clip", g);
  class p extends n {
    constructor(t = !0) {
      super(!1);
      this._gridSize = 11;
    ...
    destroy(t = !0) {
      e.ILaya.stage.off(e.Event.MOUSE_DOWN, this, this.removeColorBox);
      super.destroy(t);
    ...
    createChildren() {
      ...
      this._colorPanel.addChild(this._colorTiles = new e.Sprite());
      this._colorPanel.addChild(this._colorBlock = new e.Sprite());
      this._colorPanel.addChild(this._colorInput = new e.Input());
    }
    initialize() {
      this._colorButton.on(e.Event.CLICK, this, this.onColorButtonClick);
      this._colorBlock.pos(5, 5);
      this._colorInput.pos(60, 5);
      this._colorInput.size(60, 20);
      this._colorInput.on(e.Event.CHANGE, this, this.onColorInputChange);
      this._colorInput.on(e.Event.KEY_DOWN, this, this.onColorFieldKeyDown);
      this._colorTiles.pos(5, 30);
      this._colorTiles.on(e.Event.MOUSE_MOVE, this, this.onColorTilesMouseMove);
      this._colorTiles.on(e.Event.CLICK, this, this.onColorTilesClick);
      this._colorTiles.size(20 * this._gridSize, 12 * this._gridSize);
      this._colorPanel.on(e.Event.MOUSE_DOWN, this, this.onPanelMouseDown);
    ...
    open() {
      ...
      var i = s.x + this._colorPanel.width <= t.width ? s.x : t.width - this._colorPanel.width;
      var h = s.y + this._colorButton.height;
      h = h + this._colorPanel.height <= t.height ? h : s.y - this._colorPanel.height;
      this._colorPanel.pos(i, h);
    ...
    getColorByMouse() {
      ...
      var s = Math.floor(t.y / this._gridSize);
    ...
    drawBlock(t) {
      ...
      e.clear(!0);
      var s = t || "#ffffff";
      e.drawRect(0, 0, 50, 20, s, this._borderColor);
    ...
    set skin(t) {
      this._colorButton.once(e.Event.LOADED, this, this.changeColor);
  ...
  e.ILaya.regClass(p);
  e.ClassUtils.regClass("laya.ui.ColorPicker", p);
  ...
  class C extends n {
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.text = t + "" : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
  ...
  e.ILaya.regClass(C);
  e.ClassUtils.regClass("laya.ui.Label", C);
  e.ClassUtils.regClass("Laya.Label", C);
  class m extends n {
    constructor(t = null) {
      super();
      this.isVertical = !0;
    ...
    createChildren() {
      this.addChild(this._bg = new o());
      this.addChild(this._bar = new d());
    }
    initialize() {
      this._bar.on(e.Event.MOUSE_DOWN, this, this.onBarMouseDown);
    ...
    onBarMouseDown(t) {
      var s = e.ILaya;
      this._globalSacle || (this._globalSacle = new e.Point());
      this._globalSacle.setTo(this.globalScaleX || .01, this.globalScaleY || .01);
      this._maxMove = this.isVertical ? this.height - this._bar.height : this.width - this._bar.width;
      this._tx = s.stage.mouseX;
      this._ty = s.stage.mouseY;
      s.stage.on(e.Event.MOUSE_MOVE, this, this.mouseMove);
      s.stage.once(e.Event.MOUSE_UP, this, this.mouseUp);
      s.stage.once(e.Event.MOUSE_OUT, this, this.mouseUp);
      this.showValueText();
    }
    showValueText() {
      if (this.showLabel) {
        ...
        this.isVertical ? (t.x = this._bar._x + 20, t.y = .5 * (this._bar.height - t.height) + this._bar._y) : (t.y = this._bar._y - 20, t.x = .5 * (this._bar.width - t.width) + this._bar._x);
      }
    }
    hideValueText() {
    ...
    mouseUp(t) {
      let s = e.ILaya.stage;
      s.off(e.Event.MOUSE_MOVE, this, this.mouseMove);
      s.off(e.Event.MOUSE_UP, this, this.mouseUp);
      s.off(e.Event.MOUSE_OUT, this, this.mouseUp);
      this.sendChangeEvent(e.Event.CHANGED);
      this.hideValueText();
    }
    mouseMove(t) {
      let s = e.ILaya.stage;
      var i = this._value;
      this.isVertical ? (this._bar.y += (s.mouseY - this._ty) / this._globalSacle.y, this._bar._y > this._maxMove ? this._bar.y = this._maxMove : this._bar._y < 0 && (this._bar.y = 0), this._value = this._bar._y / this._maxMove * (this._max - this._min) + this._min, this._progress && (this._progress.height = this._bar._y + .5 * this._bar.height)) : (this._bar.x += (s.mouseX - this._tx) / this._globalSacle.x, this._bar._x > this._maxMove ? this._bar.x = this._maxMove : this._bar._x < 0 && (this._bar.x = 0), this._value = this._bar._x / this._maxMove * (this._max - this._min) + this._min, this._progress && (this._progress.width = this._bar._x + .5 * this._bar.width));
      this._tx = s.mouseX;
      this._ty = s.mouseY;
      if (0 != this._tick) {
    ...
    _skinLoaded() {
      ...
      e.Loader.getRes(t) && (this._progress || (this.addChild(this._progress = new o()), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = t);
      this.setBarPoint();
    ...
    changeValue() {
      ...
      this._max >= this._min ? this._value = this._value > this._max ? this._max : this._value < this._min ? this._min : this._value : this._value = this._value > this._min ? this._min : this._value < this._max ? this._max : this._value;
      var e = this._max - this._min;
      0 === e && (e = 1);
      this.isVertical ? (this._bar.y = (this._value - this._min) / e * (this.height - this._bar.height), this._progress && (this._progress.height = this._bar._y + .5 * this._bar.height)) : (this._bar.x = (this._value - this._min) / e * (this.width - this._bar.width), this._progress && (this._progress.width = this._bar._x + .5 * this._bar.width));
    }
    get max() {
      return this._max;
    }
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.value = Number(t) : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
  ...
  m.label = null;
  e.ILaya.regClass(m);
  e.ClassUtils.regClass("laya.ui.Slider", m);
  ...
  class v extends n {
    constructor(t = null) {
      ...
      this.disableDrag = !1;
      this._showButtons = s.showButtons;
      this._scrollSize = 1;
      ...
      this._hide = !1;
      this._clickOnly = !0;
      this._touchScrollEnable = s.touchScrollEnable;
      this._mouseWheelEnable = s.mouseWheelEnable;
      this.skin = t;
      this.max = 1;
    }
    destroy(t = !0) {
    ...
    createChildren() {
      this.addChild(this.slider = new m());
    ...
    initialize() {
      ...
      this.slider.tick = 0;
      this.slider.on(e.Event.CHANGE, this, this.onSliderChange);
      this.slider.setSlider(0, 0, 0);
      this.upButton.on(e.Event.MOUSE_DOWN, this, this.onButtonMouseDown);
    ...
    onButtonMouseDown(t) {
      ...
      this.slide(s);
      e.ILaya.timer.once(i.scrollBarDelayTime, this, this.startLoop, [s]);
    ...
    onStageMouseUp(t) {
      e.ILaya.timer.clear(this, this.startLoop);
      e.ILaya.timer.clear(this, this.slide);
    }
    get skin() {
      return this._skin;
    }
    ...
    set target(t) {
      this._target && (this._target.off(e.Event.MOUSE_WHEEL, this, this.onTargetMouseWheel), this._target.off(e.Event.MOUSE_DOWN, this, this.onTargetMouseDown));
      this._target = t;
      t && (this._mouseWheelEnable && this._target.on(e.Event.MOUSE_WHEEL, this, this.onTargetMouseWheel), this._touchScrollEnable && this._target.on(e.Event.MOUSE_DOWN, this, this.onTargetMouseDown));
    }
    get hide() {
      return this._hide;
    }
    ...
    startDragForce() {
      ...
      this._lastOffset = 0;
      this._checkElastic = !1;
      this._lastPoint || (this._lastPoint = new e.Point());
      this._lastPoint.setTo(e.ILaya.stage.mouseX, e.ILaya.stage.mouseY);
      e.ILaya.timer.clear(this, this.tweenMove);
      e.Tween.clearTween(this);
      e.ILaya.stage.once(e.Event.MOUSE_UP, this, this.onStageMouseUp2);
      e.ILaya.stage.once(e.Event.MOUSE_OUT, this, this.onStageMouseUp2);
      e.ILaya.timer.frameLoop(1, this, this.loop);
    }
    cancelDragOp() {
      e.ILaya.stage.off(e.Event.MOUSE_UP, this, this.onStageMouseUp2);
      e.ILaya.stage.off(e.Event.MOUSE_OUT, this, this.onStageMouseUp2);
      e.ILaya.timer.clear(this, this.tweenMove);
      e.ILaya.timer.clear(this, this.loop);
    ...
    startTweenMoveForce(t) {
      this._lastOffset = t;
      e.ILaya.timer.frameLoop(1, this, this.tweenMove, [200]);
    }
    loop() {
      if (!this.disableDrag) {
        var t = e.ILaya.stage.mouseY;
        var s = e.ILaya.stage.mouseX;
        this._lastOffset = this.isVertical ? t - this._lastPoint.y : s - this._lastPoint.x;
        if (this._clickOnly) {
          if (!(Math.abs(this._lastOffset * (this.isVertical ? e.ILaya.stage._canvasTransform.getScaleY() : e.ILaya.stage._canvasTransform.getScaleX())) > 1)) {
            return;
          }
          this._clickOnly = !1;
    ...
    onStageMouseUp2(t) {
      ...
      e.ILaya.stage.off(e.Event.MOUSE_OUT, this, this.onStageMouseUp2);
      e.ILaya.timer.clear(this, this.loop);
      if (!(this._clickOnly && this._value >= this.min && this._value <= this.max)) {
        this._target.mouseEnabled = !0;
        if (this._isElastic) {
          ...
          for (var i = 0, h = Math.min(this._offsets.length, 3), a = 0; a < h; a++) {
            i += this._offsets[this._offsets.length - 1 - a];
          }
          this._lastOffset = i / h;
          if ((i = Math.abs(this._lastOffset)) < 2) {
    ...
    elasticOver() {
      this._isElastic = !1;
      !this.hide && this.autoHide && e.Tween.to(this, {
        alpha: 0
      }, 500);
  ...
  e.ILaya.regClass(v);
  e.ClassUtils.regClass("laya.ui.ScrollBar", v);
  e.ClassUtils.regClass("Laya.ScrollBar", v);
  class f extends v {}
  e.ILaya.regClass(f);
  e.ClassUtils.regClass("laya.ui.VScrollBar", f);
  e.ClassUtils.regClass("Laya.VScrollBar", f);
  class S extends v {
    initialize() {
      super.initialize();
  ...
  e.ILaya.regClass(S);
  e.ClassUtils.regClass("laya.ui.HScrollBar", S);
  e.ClassUtils.regClass("Laya.HScrollBar", S);
  class b extends c {
    constructor() {
      super(...arguments);
      this.selectEnable = !1;
      this.totalPage = 0;
      this.disableStopScroll = !1;
      ...
      this._cellOffset = 0;
      this._createdLine = 0;
      this._offset = new e.Point();
      this._usedCache = null;
      this._elasticEnabled = !1;
      this._preLen = 0;
    }
    destroy(t = !0) {
    ...
    set cacheAs(t) {
      super.cacheAs = t;
      this._scrollBar && (this._usedCache = null, "none" !== t ? this._scrollBar.on(e.Event.START, this, this.onScrollStart) : this._scrollBar.off(e.Event.START, this, this.onScrollStart));
    }
    get cacheAs() {
    ...
    onScrollStart() {
      ...
      super.cacheAs = "none";
      this._scrollBar.once(e.Event.END, this, this.onScrollEnd);
    }
    onScrollEnd() {
    ...
    changeCells() {
      ...
      if (this._itemRender) {
        ...
        var h = this._height ? this._height : s * this.repeatY - this._spaceY;
        this._cellSize = this._isVertical ? s : e;
        this._cellOffset = this._isVertical ? s * Math.max(this._repeatY2, this._repeatY) - h - this._spaceY : e * Math.max(this._repeatX2, this._repeatX) - i - this._spaceX;
    ...
    _createItems(t, e, s) {
      var i = this._content;
      var h = this._getOneCell();
      var a = h.width + this._spaceX;
      var r = h.height + this._spaceY;
      if (this.cacheContent) {
        var l = new c();
        l.cacheAs = "normal";
        l.pos((this._isVertical ? 0 : t) * a, (this._isVertical ? t : 0) * r);
      ...
      for (var d = t; d < s; d++) {
        for (var u = 0; u < e; u++) {
          ...
          h.y = (this._isVertical ? d : u) * r - i._y;
          h.name = "item" + (d * e + u);
          i.addChild(h);
          this.addCell(h);
        }
    ...
    createItem() {
      ...
      if ("function" == typeof this._itemRender) {
        ...
        s = e.SceneUtils.createComp(this._itemRender, null, null, t);
      }
    ...
    setContentSize(t, s) {
      ...
      this._content.height = s;
      (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content._style.scrollRect || (this._content.scrollRect = e.Rectangle.create()), this._content._style.scrollRect.setTo(-this._offset.x, -this._offset.y, t, s), this._content.scrollRect = this._content.scrollRect);
      this.event(e.Event.RESIZE);
    }
    onCellMouse(t) {
      t.type === e.Event.MOUSE_DOWN && (this._isMoved = !1);
      var s = t.currentTarget;
      var i = this._startIndex + this._cells.indexOf(s);
    ...
    onScrollBarChange(t = null) {
      ...
      var i = this._isVertical ? this.repeatY : this.repeatX;
      var h = Math.floor(e / this._cellSize);
      if (this.cacheContent) {
        r = i + 1;
        this._createdLine - h < r && (this._createItems(this._createdLine, s, this._createdLine + r), this.renderItems(this._createdLine * s, 0), this._createdLine += r);
      } else {
        var a = h * s;
        var r = 0;
        let t = !0;
      ...
      this._isVertical ? (d.y = e - this._offset.y, d.x = -this._offset.x) : (d.y = -this._offset.y, d.x = e - this._offset.x);
      this._content.scrollRect = d;
    }
    posCell(t, e) {
      if (this._scrollBar) {
        var s = this._isVertical ? this.repeatX : this.repeatY;
        var i = Math.floor(e / s) * this._cellSize;
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
    ...
    addItem(t) {
      this.array ? this._array.push(t) : this.array = [t];
      this.array = this._array;
    }
    addItemAt(t, e) {
    ...
    getCell(t) {
      this.runCallLater(this.changeCells);
      return t > -1 && this._cells ? this._cells[(t - this._startIndex) % this._cells.length] : null;
    }
    scrollTo(t) {
      if (this._scrollBar) {
  ...
  e.ILaya.regClass(b);
  e.ClassUtils.regClass("laya.ui.List", b);
  e.ClassUtils.regClass("Laya.List", b);
  class y extends n {
    ...
    destroy(t = !0) {
      e.ILaya.stage.off(e.Event.MOUSE_DOWN, this, this.removeList);
      e.ILaya.stage.off(e.Event.MOUSE_WHEEL, this, this._onStageMouseWheel);
      super.destroy(t);
    ...
    _setListEvent(t) {
      ...
      this._list.on(e.Event.MOUSE_DOWN, this, this.onListDown);
    ...
    changeList() {
      ...
      let s = this.itemPadding ? this.itemPadding : "3,3,3,3";
    ...
    onlistItemMouse(t, s) {
      ...
      if (i === e.Event.MOUSE_OVER || i === e.Event.MOUSE_OUT) {
        ...
        i === e.Event.CLICK && (this.selectedIndex = s, this.isOpen = !1);
      }
    }
    switchTo(t) {
      this.isOpen = t;
    ...
    set defaultLabel(t) {
      this._defaultLabel = t;
      this._selectedIndex < 0 && (this._button.label = t);
    }
    get selectHandler() {
    ...
    set itemPadding(t) {
      this._itemPadding = l.fillArray(this._itemPadding, t, Number);
    }
    get itemSize() {
    ...
    set isOpen(t) {
      if (this._isOpen != t) {
        ...
        if (this._isOpen) {
          ...
          var i = s.y + this._button.height;
          i = i + this._listHeight <= e.ILaya.stage.height || s.y - this._listHeight < 0 ? i : s.y - this._listHeight;
          this._list.pos(s.x, i);
          this._list.zOrder = 1001;
          e.ILaya.stage.addChild(this._list);
          e.ILaya.stage.once(e.Event.MOUSE_DOWN, this, this.removeList);
          e.ILaya.stage.on(e.Event.MOUSE_WHEEL, this, this._onStageMouseWheel);
    ...
    set dataSource(t) {
      this._dataSource = t;
      "number" == typeof t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : super.dataSource = t;
    }
    get dataSource() {
      return super.dataSource;
    }
  ...
  e.ILaya.regClass(y);
  e.ClassUtils.regClass("laya.ui.ComboBox", y);
  e.ClassUtils.regClass("Laya.ComboBox", y);
  class w extends n {
    constructor(t = null) {
      super();
      this._value = .5;
    ...
    changeValue() {
      if (this.sizeGrid) {
        ...
        var e = Number(t[3]);
        var s = Number(t[1]);
        var i = (this.width - e - s) * this._value;
        this._bar.width = e + s + i;
        this._bar.visible = this._bar.width > e + s;
      } else {
  ...
  e.ILaya.regClass(w);
  e.ClassUtils.regClass("laya.ui.ProgressBar", w);
  ...
  e.ILaya.regClass(x);
  e.ClassUtils.regClass("laya.ui.Radio", x);
  e.ClassUtils.regClass("Laya.Radio", x);
  class L extends c {
    constructor(t = null, e = null) {
      super();
      this._selectedIndex = -1;
    ...
    delItem(t, e = !0) {
      ...
      if (-1 != s) {
        ...
        for (var a = s + 1, r = this._items.length; a < r; a++) {
          var l = this._items[a];
          l.name = "item" + (a - 1);
          e && ("horizontal" == this._direction ? l.x -= h.width + this._space : l.y -= h.height + this._space);
        }
        this.initItems();
        if (this._selectedIndex > -1) {
          i = this._selectedIndex < this._items.length ? this._selectedIndex : this._selectedIndex - 1;
          this._selectedIndex = -1;
    ...
    initItems() {
      ...
      for (var t = 0; t < 1e4; t++) {
        ...
        this._items.push(s);
        s.selected = t === this._selectedIndex;
        s.clickHandler = e.Handler.create(this, this.itemClick, [t], !1);
      }
    }
    itemClick(t) {
    ...
    changeLabels() {
      ...
      if (this._items) {
        for (var t = 0, e = 0, s = this._items.length; e < s; e++) {
          var i = this._items[e];
          this._skin && (i.skin = this._skin);
          this._labelColors && (i.labelColors = this._labelColors);
          this._labelSize && (i.labelSize = this._labelSize);
          this._labelStroke && (i.labelStroke = this._labelStroke);
          this._labelStrokeColor && (i.labelStrokeColor = this._labelStrokeColor);
          this._strokeColors && (i.strokeColors = this._strokeColors);
          this._labelBold && (i.labelBold = this._labelBold);
          this._labelPadding && (i.labelPadding = this._labelPadding);
          this._labelAlign && (i.labelAlign = this._labelAlign);
          this._stateNum && (i.stateNum = this._stateNum);
          this._labelFont && (i.labelFont = this._labelFont);
          "horizontal" === this._direction ? (i.y = 0, i.x = t, t += i.width + this._space) : (i.x = 0, i.y = t, t += i.height + this._space);
        }
      }
      this._sizeChanged();
    }
  ...
  e.ILaya.regClass(L);
  e.ClassUtils.regClass("laya.ui.UIGroup", L);
  e.ClassUtils.regClass("Laya.UIGroup", L);
  class E extends L {
    createItem(t, e) {
      return new x(t, e);
    }
  ...
  e.ILaya.regClass(E);
  e.ClassUtils.regClass("laya.ui.RadioGroup", E);
  e.ClassUtils.regClass("Laya.RadioGroup", E);
  class I extends L {
    createItem(t, e) {
      return new d(t, e);
    }
  ...
  e.ILaya.regClass(I);
  e.ClassUtils.regClass("laya.ui.Tab", I);
  e.ClassUtils.regClass("Laya.Tab", I);
  class B extends c {
    constructor() {
      super(...arguments);
      this._setIndexHandler = e.Handler.create(this, this.setIndex, null, !1);
    }
    setItems(t) {
      this.removeChildren();
  ...
  e.ILaya.regClass(B);
  e.ClassUtils.regClass("laya.ui.ViewStack", B);
  e.ClassUtils.regClass("Laya.ViewStack", B);
  class k extends C {
    constructor(t = "") {
      super();
      this.text = t;
    ...
    createChildren() {
      this.addChild(this._tf = new e.Input());
      this._tf.padding = i.inputLabelPadding;
      this._tf.on(e.Event.INPUT, this, this._onInput);
      this._tf.on(e.Event.ENTER, this, this._onEnter);
      this._tf.on(e.Event.BLUR, this, this._onBlur);
      this._tf.on(e.Event.FOCUS, this, this._onFocus);
      this._tf.on(e.Event.CHANGE, this, this._onChange);
    }
    _onChange() {
      this.event(e.Event.CHANGE, this);
    }
    _onFocus() {
    ...
    _skinLoaded() {
      this._bg || (this.graphics = this._bg = new h());
      this._bg.source = e.Loader.getRes(this._skin);
  ...
  e.ILaya.regClass(k);
  e.ClassUtils.regClass("laya.ui.TextInput", k);
  e.ClassUtils.regClass("Laya.TextInput", k);
  class M extends k {
    constructor(t = "") {
      super(t);
      this.on(e.Event.CHANGE, this, this._onTextChange);
    }
    _onTextChange() {
    ...
    set vScrollBarSkin(t) {
      null == this._vScrollBar && (this.addChild(this._vScrollBar = new f()), this._vScrollBar.on(e.Event.CHANGE, this, this.onVBarChanged), this._vScrollBar.target = this._tf, this.callLater(this.changeScroll));
    ...
    set hScrollBarSkin(t) {
      null == this._hScrollBar && (this.addChild(this._hScrollBar = new S()), this._hScrollBar.on(e.Event.CHANGE, this, this.onHBarChanged), this._hScrollBar.mouseWheelEnable = !1, this._hScrollBar.target = this._tf, this.callLater(this.changeScroll));
    ...
    changeScroll() {
      let t = this._vScrollBar && this._tf.maxScrollY > 0;
      let e = this._hScrollBar && this._tf.maxScrollX > 0;
      let s = 0;
      let h = 0;
      let a = this._tf.padding || i.labelPadding;
      t && (s = this._vScrollBar.width);
      e && (h = this._hScrollBar.height);
      this._tf.width = this._width - s;
      this._tf.height = this._height - h;
      this._vScrollBar && (this._vScrollBar.x = this._width - this._vScrollBar.width - a[1], this._vScrollBar.y = a[0], this._vScrollBar.height = this._height - h - a[0] - a[2], this._vScrollBar.scrollSize = 1, this._vScrollBar.thumbPercent = this._tf.height / Math.max(this._tf.textHeight, this._tf.height), this._vScrollBar.setScroll(0, this._tf.maxScrollY + 5, this._tf.scrollY), this._vScrollBar.visible = t);
      this._hScrollBar && (this._hScrollBar.x = a[3], this._hScrollBar.y = this._height - this._hScrollBar.height - a[2], this._hScrollBar.width = this._width - s - a[1] - a[3], this._hScrollBar.scrollSize = Math.max(.033 * this._tf.width, 1), this._hScrollBar.thumbPercent = this._tf.width / Math.max(this._tf.textWidth, this._tf.width), this._hScrollBar.setScroll(0, this._tf.maxScrollX + a[1] + a[3] + 8, this._tf.scrollX), this._hScrollBar.visible = e);
    }
    scrollTo(t) {
      this.commitMeasure();
      this._tf.scrollY = t;
  ...
  e.ILaya.regClass(M);
  e.ClassUtils.regClass("laya.ui.TextArea", M);
  e.ClassUtils.regClass("Laya.TextArea", M);
  class O extends c {
    constructor() {
      super(...arguments);
      this._oldW = 0;
    ...
    onEnable() {
      e.ILaya.stage.on("resize", this, this.onResize);
      this.onResize();
    }
    onDisable() {
  ...
  e.ILaya.regClass(O);
  e.ClassUtils.regClass("laya.ui.ScaleBox", O);
  e.ClassUtils.regClass("Laya.ScaleBox", O);
  class T extends m {
    constructor(t = null) {
      super(t);
      this.isVertical = !1;
  ...
  e.ILaya.regClass(T);
  e.ClassUtils.regClass("laya.ui.HSlider", T);
  e.ClassUtils.regClass("Laya.HSlider", T);
  class z extends c {
    constructor() {
      super();
      this._usedCache = null;
    ...
    addChild(t) {
      t.on(e.Event.RESIZE, this, this.onResize);
    ...
    addChildAt(t, s) {
      t.on(e.Event.RESIZE, this, this.onResize);
      this._setScrollChanged();
      return this._content.addChildAt(t, s);
    }
    removeChild(t) {
      t.off(e.Event.RESIZE, this, this.onResize);
      this._setScrollChanged();
      return this._content.removeChild(t);
    }
    removeChildAt(t) {
      this.getChildAt(t).off(e.Event.RESIZE, this, this.onResize);
      this._setScrollChanged();
    ...
    changeScroll() {
      ...
      var s = this._vScrollBar;
      var i = this._hScrollBar;
      var h = s && e > this._height;
      var a = i && t > this._width;
      var r = h ? this._width - s.width : this._width;
      var l = a ? this._height - i.height : this._height;
      s && (s.x = this._width - s.width, s.y = 0, s.height = this._height - (a ? i.height : 0), s.scrollSize = Math.max(.033 * this._height, 1), s.thumbPercent = l / e, s.setScroll(0, e - l, s.value));
      i && (i.x = 0, i.y = this._height - i.height, i.width = this._width - (h ? s.width : 0), i.scrollSize = Math.max(.033 * this._width, 1), i.thumbPercent = r / t, i.setScroll(0, t - r, i.value));
    }
    _sizeChanged() {
      super._sizeChanged();
    ...
    setContentSize(t, s) {
      ...
      i.width = t;
      i.height = s;
      i._style.scrollRect || (i.scrollRect = e.Rectangle.create());
      i._style.scrollRect.setTo(0, 0, t, s);
    ...
    set vScrollBarSkin(t) {
      null == this._vScrollBar && (super.addChild(this._vScrollBar = new f()), this._vScrollBar.on(e.Event.CHANGE, this, this.onScrollBarChange, [this._vScrollBar]), this._vScrollBar.target = this._content, this._vScrollBar.elasticDistance = this._elasticEnabled ? 200 : 0, this._setScrollChanged());
      this._vScrollBar.skin = t;
    }
    get hScrollBarSkin() {
      return this._hScrollBar ? this._hScrollBar.skin : null;
    ...
    set hScrollBarSkin(t) {
      null == this._hScrollBar && (super.addChild(this._hScrollBar = new S()), this._hScrollBar.on(e.Event.CHANGE, this, this.onScrollBarChange, [this._hScrollBar]), this._hScrollBar.target = this._content, this._hScrollBar.elasticDistance = this._elasticEnabled ? 200 : 0, this._setScrollChanged());
      this._hScrollBar.skin = t;
    }
    get vScrollBar() {
      return this._vScrollBar;
    ...
    set cacheAs(t) {
      super.cacheAs = t;
      this._usedCache = null;
      "none" !== t ? (this._hScrollBar && this._hScrollBar.on(e.Event.START, this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on(e.Event.START, this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off(e.Event.START, this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off(e.Event.START, this, this.onScrollStart));
    }
    get cacheAs() {
      return super.cacheAs;
    }
    ...
    onScrollStart() {
      this._usedCache || (this._usedCache = super.cacheAs);
      super.cacheAs = "none";
      this._hScrollBar && this._hScrollBar.once(e.Event.END, this, this.onScrollEnd);
  ...
  e.ILaya.regClass(z);
  e.ClassUtils.regClass("laya.ui.Panel", z);
  e.ClassUtils.regClass("Laya.Panel", z);
  class U extends m {}
  e.ILaya.regClass(U);
  e.ClassUtils.regClass("laya.ui.VSlider", U);
  e.ClassUtils.regClass("Laya.VSlider", U);
  class H extends c {
    constructor() {
      super();
      this._spaceLeft = 10;
    ...
    createChildren() {
      this.addChild(this._list = new b());
      this._list.renderHandler = e.Handler.create(this, this.renderItem, null, !1);
      this._list.repeatX = 1;
      this._list.on(e.Event.CHANGE, this, this.onListChange);
    }
    onListChange(t = null) {
      this.event(e.Event.CHANGE);
    }
    ...
    onArrowClick(t) {
      ...
      this._list.array[s].isOpen = !this._list.array[s].isOpen;
    ...
    getFilterSource(t, e, s) {
      ...
      for (let i of t) {
        !i.isDirectory && String(i.label).toLowerCase().indexOf(s) > -1 && (i.x = 0, e.push(i));
        i.child && i.child.length > 0 && this.getFilterSource(i.child, e, s);
      }
    }
  }
  e.ILaya.regClass(H);
  e.ClassUtils.regClass("laya.ui.Tree", H);
  e.ClassUtils.regClass("Laya.Tree", H);
  class D extends c {
    constructor() {
      super(...arguments);
      this._space = 0;
    ...
    addChildAt(t, s) {
      t.on(e.Event.RESIZE, this, this.onResize);
      this._setItemChanged();
      return super.addChildAt(t, s);
    }
    removeChildAt(t) {
      this.getChildAt(t).off(e.Event.RESIZE, this, this.onResize);
      this._setItemChanged();
      return super.removeChildAt(t);
    }
    refresh() {
      this._setItemChanged();
    }
  ...
  e.ILaya.regClass(D);
  e.ClassUtils.regClass("laya.ui.LayoutBox", D);
  e.ClassUtils.regClass("Laya.LayoutBox", D);
  class A extends D {
    sortItem(t) {
      t && t.sort(function (t, e) {
        return t.x - e.x;
    ...
    changeItems() {
      ...
      for (var t = [], e = 0, s = 0, i = this.numChildren; s < i; s++) {
        ...
        h && (t.push(h), e = Math.max(e, h.height * h.scaleY));
      }
      this.sortItem(t);
      var a = 0;
      s = 0;
  ...
  A.BOTTOM = "bottom";
  e.ILaya.regClass(A);
  e.ClassUtils.regClass("laya.ui.HBox", A);
  e.ClassUtils.regClass("Laya.HBox", A);
  class N extends D {
    constructor() {
      super(...arguments);
      this.isSortItem = !1;
  ...
  N.RIGHT = "right";
  e.ILaya.regClass(N);
  e.ClassUtils.regClass("laya.ui.VBox", N);
  e.ClassUtils.regClass("Laya.VBox", N);
  class P extends g {
    constructor(t = null, e = null) {
      super();
      this._valueArr = "";
    ...
    createChildren() {
      this._bitmap = new h();
      this.on(e.Event.LOADED, this, this._onClipLoaded);
    }
    _onClipLoaded() {
      this.callLater(this.changeValue);
    }
    ...
    destroy(t = !0) {
      ...
      this.removeSelf();
      this.off(e.Event.LOADED, this, this._onClipLoaded);
      super.destroy(t);
    }
  }
  e.ILaya.regClass(P);
  e.ClassUtils.regClass("laya.ui.FontClip", P);
  e.ClassUtils.regClass("Laya.FontClip", P);
  class Y extends e.Scene {
    ...
    static __init__() {
      e.ILaya.ClassUtils.regShortClassName([B, d, M, p, c, O, u, g, y, n, S, T, o, C, b, z, w, x, E, v, m, I, k, Y, f, U, H, A, N, e.Animation, e.Text, P]);
    }
  ...
  Y.uiMap = {};
  e.ILaya.regClass(Y);
  e.ClassUtils.regClass("laya.ui.View", Y);
  e.ClassUtils.regClass("Laya.View", Y);
  class X {}
  class R extends e.Sprite {
    constructor() {
      super();
      this.maskLayer = new e.Sprite();
      this.popupEffect = t => {
        t.scale(1, 1);
        t._effectTween = e.Tween.from(t, {
      ...
      this.popupEffectHandler = new e.Handler(this, this.popupEffect);
      this.closeEffectHandler = new e.Handler(this, this.closeEffect);
      this.mouseEnabled = this.maskLayer.mouseEnabled = !0;
      this.zOrder = 1e3;
      e.ILaya.stage.addChild(this);
      e.ILaya.stage.on(e.Event.RESIZE, this, this._onResize);
      s.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide);
      this._onResize(null);
    }
    _closeOnSide() {
      var t = this.getChildAt(this.numChildren - 1);
      t instanceof X.Dialog && t.close("side");
    }
    setLockView(t) {
    ...
    _onResize(t = null) {
      ...
      var h = this.maskLayer.height = e.ILaya.stage.height;
      this.lockLayer && this.lockLayer.size(i, h);
      this.maskLayer.graphics.clear(!0);
      this.maskLayer.graphics.drawRect(0, 0, i, h, s.popupBgColor);
    ...
    _centerDialog(t) {
      t.x = Math.round((e.ILaya.stage.width - t.width >> 1) + t.pivotX);
      t.y = Math.round((e.ILaya.stage.height - t.height >> 1) + t.pivotY);
    }
    open(t, s = !1, i = !1) {
      s && this._closeAll();
      ...
      this.addChild(t);
      (t.isModal || this._getBit(e.Const.HAS_ZORDER)) && e.ILaya.timer.callLater(this, this._checkMask);
  ...
  e.ClassUtils.regClass("laya.ui.DialogManager", R);
  e.ClassUtils.regClass("Laya.DialogManager", R);
  class G extends Y {
    constructor() {
      super();
      this.isShowEffect = !0;
      this.isPopupCenter = !0;
      this.popupEffect = G.manager.popupEffectHandler;
      this.closeEffect = G.manager.closeEffectHandler;
      this._dealDragArea();
      this.on(e.Event.CLICK, this, this._onClick);
    }
    static get manager() {
    ...
    set dragArea(t) {
      if (t) {
        ...
        this._dragArea = new e.Rectangle(s[0], s[1], s[2], s[3]);
        this.on(e.Event.MOUSE_DOWN, this, this._onMouseDown);
      } else {
        this._dragArea = null;
        this.off(e.Event.MOUSE_DOWN, this, this._onMouseDown);
      }
    }
    _onMouseDown(t) {
    ...
    open(t = !0, e = null) {
      this._dealDragArea();
      this._param = e;
      G.manager.open(this, t, this.isShowEffect);
      G.manager.lock(!1);
    }
    close(t = null) {
      this.closeType = t;
      G.manager.close(this);
    }
    destroy(t = !0) {
  ...
  X.Dialog = G;
  e.ILaya.regClass(G);
  e.ClassUtils.regClass("laya.ui.Dialog", G);
  e.ClassUtils.regClass("Laya.Dialog", G);
  class W extends n {
    constructor() {
      super();
      this._tipBox = new n();
      this._tipBox.addChild(this._tipText = new e.Text());
      this._tipText.x = this._tipText.y = 5;
      this._tipText.color = W.tipTextColor;
      this._defaultTipHandler = this._showDefaultTip;
      e.ILaya.stage.on(r.SHOW_TIP, this, this._onStageShowTip);
      e.ILaya.stage.on(r.HIDE_TIP, this, this._onStageHideTip);
      this.zOrder = 1100;
    }
    _onStageHideTip(t) {
      e.ILaya.timer.clear(this, this._showTip);
      this.closeAll();
      this.removeSelf();
    }
    _onStageShowTip(t) {
    ...
    _showTip(t) {
      if ("string" == typeof t) {
        ...
        t instanceof e.Handler ? t.run() : t instanceof Function && t.apply();
      }
      e.ILaya.stage.on(e.Event.MOUSE_MOVE, this, this._onStageMouseMove);
      e.ILaya.stage.on(e.Event.MOUSE_DOWN, this, this._onStageMouseDown);
    ...
    _showToStage(t, s = 0, i = 0) {
      var h = t.getBounds();
      t.x = e.ILaya.stage.mouseX + s;
      t.y = e.ILaya.stage.mouseY + i;
      t._x + h.width > e.ILaya.stage.width && (t.x -= h.width + s);
      t._y + h.height > e.ILaya.stage.height && (t.y -= h.height + i);
    }
    closeAll() {
      e.ILaya.timer.clear(this, this._showTip);
      e.ILaya.stage.off(e.Event.MOUSE_MOVE, this, this._onStageMouseMove);
      e.ILaya.stage.off(e.Event.MOUSE_DOWN, this, this._onStageMouseDown);
      this.removeChildren();
    }
    showDislayTip(t) {
      this.addChild(t);
    ...
    _showDefaultTip(t) {
      ...
      s.clear(!0);
      s.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, W.tipBackColor);
  ...
  W.offsetX = 10;
  W.offsetY = 15;
  W.tipTextColor = "#ffffff";
  W.tipBackColor = "#111111";
  W.tipDelay = 200;
  e.ILaya.regClass(W);
  e.ClassUtils.regClass("laya.ui.TipManager", W);
  ...
  class V extends n {
    ...
    _onLoop() {
      ...
      this.texture.bitmap.loadImageSource(t, !0);
    }
    set width(t) {
      super.width = t;
  ...
  e.ILaya.regClass(V);
  e.ClassUtils.regClass("laya.ui.WXOpenDataViewer", V);
  e.ClassUtils.regClass("Laya.WXOpenDataViewer", V);
  t.AdvImage = _;
  t.AutoBitmap = h;
  t.Box = c;
  t.Button = d;
