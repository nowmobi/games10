...
GardenCollapse.Gameover = function (game) {
...
GardenCollapse.Gameover.prototype = {
	...
	create: function () {
		...
		title1 = this.game.add.sprite(480, 240, 'overTitle');
		title1.anchor.set(.5);
		...
		playButton1 = this.add.button(480, 430, 'retryBtn1');
		...
		menuButton1 = this.add.button(480, 500, 'menuBtn1');
		menuButton1.anchor.set(.5);
		menuButton1.scale.x = menuButton1.scale.y = .75;
		menuButton1.buttonMode = true;
		menuButton1.events.onInputOver.add(this.onMenuOver, this);
		menuButton1.events.onInputOut.add(this.MenuOut, this);
		menuButton1.events.onInputDown.add(this.isMenuClicked, this);
		menuButton1.inputEnabled = true;
		menuButton1.input.useHandCursor = true;
	...
	mainStart: function () {
		bg.destroy()
		GardenCollapse.score = GardenCollapse.levelscore
		this.state.start('Game');
	},

	onMenuOver: function (pointer) {
		menuButton1.scale.setTo(.8, .8);
	},

	MenuOut: function (pointer) {
		menuButton1.scale.setTo(.75, .75);
