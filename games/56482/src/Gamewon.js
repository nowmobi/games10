...
GardenCollapse.Gamewon = function (game) {
...
GardenCollapse.Gamewon.prototype = {
	...
	create: function () {
		...
		title1 = this.game.add.sprite(480, 240, 'congrats');
		title1.anchor.set(.5);
		...
		playButton1 = this.add.button(480, 430, 'againBtn1');
