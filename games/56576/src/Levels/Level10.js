...
var Level10= function(game,groups){
...
Level10.prototype = Object.create(Phaser.Group.prototype);
...
Level10.prototype.addgroup=function(){
...
Level10.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level10');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level10'); 
	...
	cnt=0;
 	this.AddPieces(105,100);
	this.AddPieces(220,120);
	this.AddPieces(280,260); 
	this.AddPieces(110,320); 

}

Level10.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level10';
...
Level10.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level10';
...
Level10.prototype.obHit=function(body1){
...
Level10.prototype.gotoClear=function(){
	
	this.destroy();
}
Level10.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level10.prototype.MoveUpToShoot=function(){
