...
var Level11= function(game,groups){
...
Level11.prototype = Object.create(Phaser.Group.prototype);
...
Level11.prototype.addgroup=function(){
...
Level11.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level11');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level11'); 
...
Level11.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level11';
...
Level11.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level11';
...
Level11.prototype.obHit=function(body1){
...
Level11.prototype.gotoClear=function(){

	this.destroy();
}
Level11.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level11.prototype.MoveUpToShoot=function(){
