...
var Level12= function(game,groups){
...
Level12.prototype = Object.create(Phaser.Group.prototype);
...
Level12.prototype.addgroup=function(){
...
Level12.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level12');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level12'); 
	...
	cnt=0;
 	this.AddPieces(50,195);
	 this.AddPieces(100,120);
	this.AddPieces(210,100); 
	this.AddPieces(260,200);   
	this.AddPieces(210,300); 
	this.AddPieces(95,300);  
	this.shoot=false;


}

Level12.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level12';
...
Level12.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level12';
...
Level12.prototype.obHit=function(body1){
...
Level12.prototype.gotoClear=function(){
	
	this.destroy();
}
Level12.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level12.prototype.MoveUpToShoot=function(){
