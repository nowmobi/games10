...
var Level14= function(game,groups){
...
Level14.prototype = Object.create(Phaser.Group.prototype);
...
Level14.prototype.addgroup=function(){
...
Level14.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level14');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level14'); 
	...
	cnt=0;
 	this.AddPieces(30,220);
	 this.AddPieces(152,95);
	this.AddPieces(250,130); 
	this.AddPieces(220,310);   
...
Level14.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level14';
...
Level14.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level14';
...
Level14.prototype.obHit=function(body1){
...
Level14.prototype.gotoClear=function(){
	
	this.destroy();
}
Level14.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level14.prototype.MoveUpToShoot=function(event){
