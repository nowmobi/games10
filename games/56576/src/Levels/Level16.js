...
var Level16= function(game,groups){
...
Level16.prototype = Object.create(Phaser.Group.prototype);
Level16.prototype.constructor = Level16;
Level16.prototype.init=function(){
	this.addgroup();
...
Level16.prototype.addgroup=function(){
...
Level16.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level16');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level16'); 
	...
	cnt=0;
	 ...
	 this.AddPieces(150,80);
 	this.AddPieces(290,200); 
	this.AddPieces(150,320);    
...
Level16.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level16';
...
Level16.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level16';
...
Level16.prototype.obHit=function(body1){
...
Level16.prototype.gotoClear=function(){
	
	this.destroy();
}
Level16.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level16.prototype.MoveUpToShoot=function(){
