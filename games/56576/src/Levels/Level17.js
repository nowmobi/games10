...
var Level17= function(game,groups){
...
Level17.prototype = Object.create(Phaser.Group.prototype);
Level17.prototype.constructor = Level17;
Level17.prototype.init=function(){
	this.addgroup();
...
Level17.prototype.addgroup=function(){
...
Level17.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level17');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level17'); 
	...
	cnt=0;
 	this.AddPieces(20,100);
	 this.AddPieces(140,70);
 	 this.AddPieces(250,120); 
	this.AddPieces(210,290);     
	this.AddPieces(110,320);    
	this.AddPieces(30,245); 
	this.shoot=false;
...
Level17.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level17';
...
Level17.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level17';
...
Level17.prototype.obHit=function(body1){
...
Level17.prototype.gotoClear=function(){

	this.destroy();
}
Level17.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level17.prototype.MoveUpToShoot=function(){
