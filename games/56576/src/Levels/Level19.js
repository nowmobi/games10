...
var Level19= function(game,groups){
...
Level19.prototype = Object.create(Phaser.Group.prototype);
Level19.prototype.constructor = Level19;
Level19.prototype.init=function(){
	this.addgroup();
...
Level19.prototype.addgroup=function(){
...
Level19.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level19');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level19'); 
	...
	cnt=0;
 	this.AddPieces(40,200);
	 this.AddPieces(50,130);
 	 this.AddPieces(150,100); 
	 this.AddPieces(240,140);     
	this.AddPieces(250,200);    
	this.AddPieces(250,260);  
	this.AddPieces(150,300); 
	this.AddPieces(50,260); 
	this.shoot=false;


}

Level19.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level19';
...
Level19.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level19';
...
Level19.prototype.obHit=function(body1){
...
Level19.prototype.gotoClear=function(){

	this.destroy();
}
Level19.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level19.prototype.MoveUpToShoot=function(){
