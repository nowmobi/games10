...
var Level1s = function(game,groups){
...
Level1s.prototype = Object.create(Phaser.Group.prototype);
Level1s.prototype.constructor = Level1s;
Level1s.prototype.init=function(){
...
Level1s.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 180,'shapebase_level1');
	...
	this.AddPieces(215,280);
	this.AddPieces(25,180);
	this.AddPieces(215,85);

	
	
}

Level1s.prototype.AddOriginalPiece=function(cnt){
	var names='shapepiece'+cnt+'_level1';
	this.level1main1 = this.game.add.sprite(150, 180,names);
...
Level1s.prototype.AddPieces=function(x,y){
	cnt++;
...
Level1s.prototype.obHit=function(body1){
...
Level1s.prototype.gotoClear=function(){
	console.log("clear"+this);
	this.destroy();
}
Level1s.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level1s.prototype.MoveUpToShoot=function(){
...
Level1s.prototype.update=function(){
