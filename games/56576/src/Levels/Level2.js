...
var Level2 = function(game,groups){
...
Level2.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level2');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level2'); 
	...
	this.AddPieces(30,265);
	this.AddPieces(150,80);
	this.AddPieces(260,170);
	
	
}

Level2.prototype.AddOriginalPiece=function(cnt){
	var names='shapepiece'+cnt+'_level2';
...
Level2.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level2';
...
Level2.prototype.obHit=function(body1){
...
Level2.prototype.gotoClear=function(){
	console.log("clear"+this);
	this.destroy();
}
Level2.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level2.prototype.MoveUpToShoot=function(){
