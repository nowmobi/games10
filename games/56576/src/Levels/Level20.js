...
var Level20= function(game,groups){
...
Level20.prototype = Object.create(Phaser.Group.prototype);
Level20.prototype.constructor = Level20;
Level20.prototype.init=function(){
	this.addgroup();
...
Level20.prototype.addgroup=function(){
...
Level20.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level20');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level20'); 
	...
	cnt=0;
 	this.AddPieces(60,115);
	 this.AddPieces(150,90);
 	 this.AddPieces(230,130); 
 	 this.AddPieces(240,225);     
	this.AddPieces(200,300);    
	this.AddPieces(100,300);  
	this.AddPieces(50,220);  
...
Level20.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level20';
...
Level20.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level20';
...
Level20.prototype.obHit=function(body1){
...
Level20.prototype.gotoClear=function(){

	this.destroy();
}
Level20.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level20.prototype.MoveUpToShoot=function(){
...
Level20.prototype.update=function(){
		...
		for(var i=0;i<this.levelarray1.length;i++){
			...
			this.levelarray1[i].body.rotation+=.07
		}
