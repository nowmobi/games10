...
var Level3 = function(game,groups){
...
Level3.prototype.addgroup=function(){
...
Level3.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level3');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level3'); 
	...
	this.AddPieces(80,80);
	this.AddPieces(250,275);
	this.AddPieces(105,320);
	
	
}

Level3.prototype.AddOriginalPiece=function(cnt){
	var names='shapepiece'+cnt+'_level3';
...
Level3.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level3';
...
Level3.prototype.obHit=function(body1){
...
Level3.prototype.gotoClear=function(){
	this.destroy();
}
Level3.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level3.prototype.MoveUpToShoot=function(){
