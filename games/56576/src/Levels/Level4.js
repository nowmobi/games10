...
var Level4 = function(game,groups){
...
Level4.prototype = Object.create(Phaser.Group.prototype);
...
Level4.prototype.addgroup=function(){
...
Level4.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level4');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level4'); 
	...
	cnt=0;
	this.AddPieces(20,240);
	this.AddPieces(150,80);
	this.AddPieces(270,235);

	
}

Level4.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level4';
...
Level4.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level4';
...
Level4.prototype.obHit=function(body1){
//	console.log("wwww",body1,this.game);
...
Level4.prototype.gotoClear=function(){
	console.log("clear"+this);
	this.destroy();
}
Level4.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level4.prototype.MoveUpToShoot=function(){
