...
var Level5 = function(game,groups){
...
Level5.prototype = Object.create(Phaser.Group.prototype);
...
Level5.prototype.addgroup=function(){
...
Level5.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level5');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level5'); 
	...
	this.AddPieces(250,190);
	this.AddPieces(150,300);
	this.AddPieces(50,200);
	this.shoot=false;

}

Level5.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level5';
...
Level5.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level5';
...
Level5.prototype.obHit=function(body1){
...
Level5.prototype.gotoClear=function(){
	console.log("clear"+this);
	this.destroy();
}
Level5.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level5.prototype.MoveUpToShoot=function(){
