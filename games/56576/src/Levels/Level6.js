...
var Level6 = function(game,groups){
...
Level6.prototype = Object.create(Phaser.Group.prototype);
...
Level6.prototype.addgroup=function(){
...
Level6.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level6');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level6'); 
	...
	cnt=0;
	 ...
	 this.AddPieces(200,100);
	this.AddPieces(200,280); 
	this.AddPieces(85,300); 
	this.shoot=false;

}

Level6.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level6';
...
Level6.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level6';
...
Level6.prototype.obHit=function(body1){
...
Level6.prototype.gotoClear=function(){
	console.log("clear"+this);
	this.destroy();
}
Level6.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level6.prototype.MoveUpToShoot=function(){
