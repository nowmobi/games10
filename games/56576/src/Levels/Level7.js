...
var Level7 = function(game,groups){
...
Level7.prototype = Object.create(Phaser.Group.prototype);
...
Level7.prototype.addgroup=function(){
...
Level7.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level7');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level7'); 
	...
	cnt=0;
 	this.AddPieces(20,235);
	  this.AddPieces(150,70);
	this.AddPieces(280,220); 
...
Level7.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level7';
...
Level7.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level7';
...
Level7.prototype.obHit=function(body1){
...
Level7.prototype.gotoClear=function(){
	console.log("clear"+this);

	this.destroy();
}
Level7.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level7.prototype.MoveUpToShoot=function(){
