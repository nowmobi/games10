...
var Level8= function(game,groups){
...
Level8.prototype = Object.create(Phaser.Group.prototype);
...
Level8.prototype.addgroup=function(){
...
Level8.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level8');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level8'); 
	...
	cnt=0;
 	this.AddPieces(100,100);
	this.AddPieces(200,110);
	this.AddPieces(265,205); 
	this.AddPieces(85,300); 
	this.shoot=false;

}

Level8.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level8';
...
Level8.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level8';
...
Level8.prototype.obHit=function(body1){
...
Level8.prototype.gotoClear=function(){
	console.log("clear"+this);

	this.destroy();
}
Level8.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level8.prototype.MoveUpToShoot=function(){
