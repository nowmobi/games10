...
var Level9= function(game,groups){
...
Level9.prototype = Object.create(Phaser.Group.prototype);
...
Level9.prototype.addgroup=function(){
...
Level9.prototype.LevelAdd=function(){
	this.level1main = this.game.add.sprite(150, 200,'shapebase_level9');
	...
	this.level1main.body.loadPolygon('sprite_physics', 'shapebase_level9'); 
	...
	cnt=0;
 	this.AddPieces(45,250);
	 this.AddPieces(210,110);
	this.AddPieces(230,155); 
	this.AddPieces(230,250); 
	this.AddPieces(90,300);  
	this.shoot=false;

}

Level9.prototype.AddOriginalPiece=function(cnts){
	var names='shapepiece'+cnts+'_level9';
...
Level9.prototype.AddPieces=function(x,y){
	cnt++;
	var names='piece'+cnt+'_level9';
...
Level9.prototype.obHit=function(body1){
...
Level9.prototype.gotoClear=function(){
	
 
	this.destroy();
}
Level9.prototype.changesArr=function(){
	arrofOb.splice(0,1);
	arrofOb[0].alpha=1;
}
Level9.prototype.MoveUpToShoot=function(){
