...
gdjs.Level_322Code.GDNewLightObjects1= [];
gdjs.Level_322Code.GDNewLightObjects2= [];
gdjs.Level_322Code.GDNewLightObjects3= [];
gdjs.Level_322Code.GDNewLightObjects4= [];
gdjs.Level_322Code.GDNewLight2Objects1= [];
gdjs.Level_322Code.GDNewLight2Objects2= [];
gdjs.Level_322Code.GDNewLight2Objects3= [];
gdjs.Level_322Code.GDNewLight2Objects4= [];
gdjs.Level_322Code.GDNewLight3Objects1= [];
gdjs.Level_322Code.GDNewLight3Objects2= [];
gdjs.Level_322Code.GDNewLight3Objects3= [];
gdjs.Level_322Code.GDNewLight3Objects4= [];
gdjs.Level_322Code.GDFireObjects1= [];
gdjs.Level_322Code.GDFireObjects2= [];
gdjs.Level_322Code.GDFireObjects3= [];
gdjs.Level_322Code.GDFireObjects4= [];
gdjs.Level_322Code.GDDoorLightObjects1= [];
gdjs.Level_322Code.GDDoorLightObjects2= [];
gdjs.Level_322Code.GDDoorLightObjects3= [];
gdjs.Level_322Code.GDDoorLightObjects4= [];
gdjs.Level_322Code.GDNewText3Objects1= [];
gdjs.Level_322Code.GDNewText3Objects2= [];
gdjs.Level_322Code.GDNewText3Objects3= [];
gdjs.Level_322Code.GDNewText3Objects4= [];


gdjs.Level_322Code.userFunc0x7ed8e8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Level_322Code.userFunc0x7ed8e8(runtimeScene);

}


};gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDNewLight3Objects4Objects = Hashtable.newFrom({"NewLight3": gdjs.Level_322Code.GDNewLight3Objects4});
gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDFireObjects4Objects = Hashtable.newFrom({"Fire": gdjs.Level_322Code.GDFireObjects4});
...
for (gdjs.Level_322Code.forEachIndex4 = 0;gdjs.Level_322Code.forEachIndex4 < gdjs.Level_322Code.GDSpikeObjects3.length;++gdjs.Level_322Code.forEachIndex4) {
gdjs.Level_322Code.GDFireObjects4.length = 0;

gdjs.Level_322Code.GDNewLight3Objects4.length = 0;

gdjs.Level_322Code.GDSpikeObjects4.length = 0;


gdjs.Level_322Code.forEachTemporary4 = gdjs.Level_322Code.GDSpikeObjects3[gdjs.Level_322Code.forEachIndex4];
gdjs.Level_322Code.GDSpikeObjects4.push(gdjs.Level_322Code.forEachTemporary4);
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDNewLight3Objects4Objects, (( gdjs.Level_322Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_322Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_322Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_322Code.GDSpikeObjects4[0].getPointY("Center")), "Lighting");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDFireObjects4Objects, (( gdjs.Level_322Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_322Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_322Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_322Code.GDSpikeObjects4[0].getPointY("Center")), "Objects");
}{for(var i = 0, len = gdjs.Level_322Code.GDFireObjects4.length ;i < len;++i) {
    gdjs.Level_322Code.GDFireObjects4[i].setAngle(270);
}
}}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight"), gdjs.Level_322Code.GDNewLightObjects2);
{for(var i = 0, len = gdjs.Level_322Code.GDNewLightObjects2.length ;i < len;++i) {
    gdjs.Level_322Code.GDNewLightObjects2[i].setPosition((( gdjs.Level_322Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_322Code.GDDuckObjects2[0].getPointX("")),(( gdjs.Level_322Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_322Code.GDDuckObjects2[0].getPointY("")) - 20);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight3"), gdjs.Level_322Code.GDNewLight3Objects1);
{for(var i = 0, len = gdjs.Level_322Code.GDNewLight3Objects1.length ;i < len;++i) {
    gdjs.Level_322Code.GDNewLight3Objects1[i].setRadius(gdjs.randomInRange(70, 80));
}
}{gdjs.evtTools.camera.showLayer(runtimeScene, "");
}{for(var i = 0, len = gdjs.Level_322Code.GDLevelObjects1.length ;i < len;++i) {
    gdjs.Level_322Code.GDLevelObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.Level_322Code.GDDuckObjects1.length ;i < len;++i) {
    gdjs.Level_322Code.GDDuckObjects1[i].hide();
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("DuckArtwork"), gdjs.Level_322Code.GDDuckArtworkObjects3);
{for(var i = 0, len = gdjs.Level_322Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_322Code.GDDuckArtworkObjects3[i].setPosition((( gdjs.Level_322Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_322Code.GDDuckObjects3[0].getPointX("")) + 32,(( gdjs.Level_322Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_322Code.GDDuckObjects3[0].getPointY("")) - 5);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{gdjs.Level_322Code.GDDuckObjects3_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
...
gdjs.Level_322Code.GDDuckObjects4.length = k;
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.Level_322Code.GDDuckObjects4.length; j < jLen ; ++j) {
...
gdjs.Level_322Code.GDDuckObjects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
};gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects2Objects = Hashtable.newFrom({"Duck": gdjs.Level_322Code.GDDuckObjects2});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects2Objects, gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDSpikeObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{for(var i = 0, len = gdjs.Level_322Code.GDDuckObjects2.length ;i < len;++i) {
    gdjs.Level_322Code.GDDuckObjects2[i].deleteFromScene(runtimeScene);
}
}
{ //Subevents
...
gdjs.Level_322Code.GDDuckObjects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDKeyObjects2Objects = Hashtable.newFrom({"Key": gdjs.Level_322Code.GDKeyObjects2});
...
};gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects1Objects = Hashtable.newFrom({"Duck": gdjs.Level_322Code.GDDuckObjects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects2Objects, gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDKeyObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects2Objects, gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDoorObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDuckObjects1Objects, gdjs.Level_322Code.mapOfGDgdjs_9546Level_9595322Code_9546GDDoorObjects1Objects, true, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
gdjs.Level_322Code.GDNewLightObjects1.length = 0;
gdjs.Level_322Code.GDNewLightObjects2.length = 0;
gdjs.Level_322Code.GDNewLightObjects3.length = 0;
gdjs.Level_322Code.GDNewLightObjects4.length = 0;
gdjs.Level_322Code.GDNewLight2Objects1.length = 0;
gdjs.Level_322Code.GDNewLight2Objects2.length = 0;
gdjs.Level_322Code.GDNewLight2Objects3.length = 0;
gdjs.Level_322Code.GDNewLight2Objects4.length = 0;
gdjs.Level_322Code.GDNewLight3Objects1.length = 0;
gdjs.Level_322Code.GDNewLight3Objects2.length = 0;
gdjs.Level_322Code.GDNewLight3Objects3.length = 0;
gdjs.Level_322Code.GDNewLight3Objects4.length = 0;
gdjs.Level_322Code.GDFireObjects1.length = 0;
gdjs.Level_322Code.GDFireObjects2.length = 0;
gdjs.Level_322Code.GDFireObjects3.length = 0;
gdjs.Level_322Code.GDFireObjects4.length = 0;
gdjs.Level_322Code.GDDoorLightObjects1.length = 0;
gdjs.Level_322Code.GDDoorLightObjects2.length = 0;
gdjs.Level_322Code.GDDoorLightObjects3.length = 0;
gdjs.Level_322Code.GDDoorLightObjects4.length = 0;
gdjs.Level_322Code.GDNewText3Objects1.length = 0;
gdjs.Level_322Code.GDNewText3Objects2.length = 0;
gdjs.Level_322Code.GDNewText3Objects3.length = 0;
gdjs.Level_322Code.GDNewText3Objects4.length = 0;
