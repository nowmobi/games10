...
gdjs.Level_325Code.GDNewLightObjects1= [];
gdjs.Level_325Code.GDNewLightObjects2= [];
gdjs.Level_325Code.GDNewLightObjects3= [];
gdjs.Level_325Code.GDNewLightObjects4= [];
gdjs.Level_325Code.GDNewLight2Objects1= [];
gdjs.Level_325Code.GDNewLight2Objects2= [];
gdjs.Level_325Code.GDNewLight2Objects3= [];
gdjs.Level_325Code.GDNewLight2Objects4= [];
gdjs.Level_325Code.GDNewLight3Objects1= [];
gdjs.Level_325Code.GDNewLight3Objects2= [];
gdjs.Level_325Code.GDNewLight3Objects3= [];
gdjs.Level_325Code.GDNewLight3Objects4= [];
gdjs.Level_325Code.GDFireObjects1= [];
gdjs.Level_325Code.GDFireObjects2= [];
gdjs.Level_325Code.GDFireObjects3= [];
gdjs.Level_325Code.GDFireObjects4= [];
gdjs.Level_325Code.GDDoorLightObjects1= [];
gdjs.Level_325Code.GDDoorLightObjects2= [];
gdjs.Level_325Code.GDDoorLightObjects3= [];
gdjs.Level_325Code.GDDoorLightObjects4= [];


gdjs.Level_325Code.userFunc0x9f6288 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Level_325Code.userFunc0x9f6288(runtimeScene);

}


};gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDNewLight3Objects4Objects = Hashtable.newFrom({"NewLight3": gdjs.Level_325Code.GDNewLight3Objects4});
gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDFireObjects4Objects = Hashtable.newFrom({"Fire": gdjs.Level_325Code.GDFireObjects4});
...
gdjs.copyArray(runtimeScene.getObjects("Spike"), gdjs.Level_325Code.GDSpikeObjects3);

for (gdjs.Level_325Code.forEachIndex4 = 0;gdjs.Level_325Code.forEachIndex4 < gdjs.Level_325Code.GDSpikeObjects3.length;++gdjs.Level_325Code.forEachIndex4) {
gdjs.Level_325Code.GDFireObjects4.length = 0;

gdjs.Level_325Code.GDNewLight3Objects4.length = 0;

gdjs.Level_325Code.GDSpikeObjects4.length = 0;


gdjs.Level_325Code.forEachTemporary4 = gdjs.Level_325Code.GDSpikeObjects3[gdjs.Level_325Code.forEachIndex4];
gdjs.Level_325Code.GDSpikeObjects4.push(gdjs.Level_325Code.forEachTemporary4);
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDNewLight3Objects4Objects, (( gdjs.Level_325Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_325Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_325Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_325Code.GDSpikeObjects4[0].getPointY("Center")), "Lighting");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDFireObjects4Objects, (( gdjs.Level_325Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_325Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_325Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_325Code.GDSpikeObjects4[0].getPointY("Center")), "Objects");
}{for(var i = 0, len = gdjs.Level_325Code.GDFireObjects4.length ;i < len;++i) {
    gdjs.Level_325Code.GDFireObjects4[i].setAngle(270);
}
}}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight"), gdjs.Level_325Code.GDNewLightObjects2);
{for(var i = 0, len = gdjs.Level_325Code.GDNewLightObjects2.length ;i < len;++i) {
    gdjs.Level_325Code.GDNewLightObjects2[i].setPosition((( gdjs.Level_325Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_325Code.GDDuckObjects2[0].getPointX("")),(( gdjs.Level_325Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_325Code.GDDuckObjects2[0].getPointY("")) - 20);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight3"), gdjs.Level_325Code.GDNewLight3Objects1);
{for(var i = 0, len = gdjs.Level_325Code.GDNewLight3Objects1.length ;i < len;++i) {
    gdjs.Level_325Code.GDNewLight3Objects1[i].setRadius(gdjs.randomInRange(70, 80));
}
}{gdjs.evtTools.camera.showLayer(runtimeScene, "");
}{for(var i = 0, len = gdjs.Level_325Code.GDLevelObjects1.length ;i < len;++i) {
    gdjs.Level_325Code.GDLevelObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.Level_325Code.GDDuckObjects1.length ;i < len;++i) {
    gdjs.Level_325Code.GDDuckObjects1[i].hide();
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("DuckArtwork"), gdjs.Level_325Code.GDDuckArtworkObjects3);
{for(var i = 0, len = gdjs.Level_325Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_325Code.GDDuckArtworkObjects3[i].setPosition((( gdjs.Level_325Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_325Code.GDDuckObjects3[0].getPointX("")) + 32,(( gdjs.Level_325Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_325Code.GDDuckObjects3[0].getPointY("")) - 5);
}
...
}{for(var i = 0, len = gdjs.Level_325Code.GDDuckObjects2.length ;i < len;++i) {
    gdjs.Level_325Code.GDDuckObjects2[i].deleteFromScene(runtimeScene);
}
}
{ //Subevents
...
gdjs.Level_325Code.eventsList6(runtimeScene);
}
...
gdjs.Level_325Code.eventsList9(runtimeScene);
}


};gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDDuckObjects2Objects = Hashtable.newFrom({"Duck": gdjs.Level_325Code.GDDuckObjects2});
gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDKeyObjects2Objects = Hashtable.newFrom({"Key": gdjs.Level_325Code.GDKeyObjects2});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDDuckObjects2Objects, gdjs.Level_325Code.mapOfGDgdjs_9546Level_9595325Code_9546GDKeyObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.Level_325Code.eventsList11(runtimeScene);} //End of subevents
}
...
gdjs.Level_325Code.eventsList10(runtimeScene);
}
...
gdjs.Level_325Code.GDNewLightObjects1.length = 0;
gdjs.Level_325Code.GDNewLightObjects2.length = 0;
gdjs.Level_325Code.GDNewLightObjects3.length = 0;
gdjs.Level_325Code.GDNewLightObjects4.length = 0;
gdjs.Level_325Code.GDNewLight2Objects1.length = 0;
gdjs.Level_325Code.GDNewLight2Objects2.length = 0;
gdjs.Level_325Code.GDNewLight2Objects3.length = 0;
gdjs.Level_325Code.GDNewLight2Objects4.length = 0;
gdjs.Level_325Code.GDNewLight3Objects1.length = 0;
gdjs.Level_325Code.GDNewLight3Objects2.length = 0;
gdjs.Level_325Code.GDNewLight3Objects3.length = 0;
gdjs.Level_325Code.GDNewLight3Objects4.length = 0;
gdjs.Level_325Code.GDFireObjects1.length = 0;
gdjs.Level_325Code.GDFireObjects2.length = 0;
gdjs.Level_325Code.GDFireObjects3.length = 0;
gdjs.Level_325Code.GDFireObjects4.length = 0;
gdjs.Level_325Code.GDDoorLightObjects1.length = 0;
gdjs.Level_325Code.GDDoorLightObjects2.length = 0;
gdjs.Level_325Code.GDDoorLightObjects3.length = 0;
gdjs.Level_325Code.GDDoorLightObjects4.length = 0;
