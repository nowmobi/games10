gdjs.Level_326Code = {};
gdjs.Level_326Code.localVariables = [];
gdjs.Level_326Code.GDDuckObjects3_1final = [];

gdjs.Level_326Code.forEachIndex4 = 0;

gdjs.Level_326Code.forEachObjects4 = [];

gdjs.Level_326Code.forEachTemporary4 = null;

gdjs.Level_326Code.forEachTotalCount4 = 0;
...
gdjs.Level_326Code.GDNewLightObjects1= [];
gdjs.Level_326Code.GDNewLightObjects2= [];
gdjs.Level_326Code.GDNewLightObjects3= [];
gdjs.Level_326Code.GDNewLightObjects4= [];
gdjs.Level_326Code.GDNewLight2Objects1= [];
gdjs.Level_326Code.GDNewLight2Objects2= [];
gdjs.Level_326Code.GDNewLight2Objects3= [];
gdjs.Level_326Code.GDNewLight2Objects4= [];
gdjs.Level_326Code.GDNewLight3Objects1= [];
gdjs.Level_326Code.GDNewLight3Objects2= [];
gdjs.Level_326Code.GDNewLight3Objects3= [];
gdjs.Level_326Code.GDNewLight3Objects4= [];
gdjs.Level_326Code.GDFireObjects1= [];
gdjs.Level_326Code.GDFireObjects2= [];
gdjs.Level_326Code.GDFireObjects3= [];
gdjs.Level_326Code.GDFireObjects4= [];
gdjs.Level_326Code.GDDoorLightObjects1= [];
gdjs.Level_326Code.GDDoorLightObjects2= [];
gdjs.Level_326Code.GDDoorLightObjects3= [];
gdjs.Level_326Code.GDDoorLightObjects4= [];


gdjs.Level_326Code.userFunc0xa144b0 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.Level_326Code.userFunc0xa144b0(runtimeScene);

}


};gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDNewLight3Objects4Objects = Hashtable.newFrom({"NewLight3": gdjs.Level_326Code.GDNewLight3Objects4});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDFireObjects4Objects = Hashtable.newFrom({"Fire": gdjs.Level_326Code.GDFireObjects4});
...
gdjs.copyArray(runtimeScene.getObjects("Spike"), gdjs.Level_326Code.GDSpikeObjects3);

for (gdjs.Level_326Code.forEachIndex4 = 0;gdjs.Level_326Code.forEachIndex4 < gdjs.Level_326Code.GDSpikeObjects3.length;++gdjs.Level_326Code.forEachIndex4) {
gdjs.Level_326Code.GDFireObjects4.length = 0;

gdjs.Level_326Code.GDNewLight3Objects4.length = 0;

gdjs.Level_326Code.GDSpikeObjects4.length = 0;


gdjs.Level_326Code.forEachTemporary4 = gdjs.Level_326Code.GDSpikeObjects3[gdjs.Level_326Code.forEachIndex4];
gdjs.Level_326Code.GDSpikeObjects4.push(gdjs.Level_326Code.forEachTemporary4);
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDNewLight3Objects4Objects, (( gdjs.Level_326Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_326Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_326Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_326Code.GDSpikeObjects4[0].getPointY("Center")), "Lighting");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDFireObjects4Objects, (( gdjs.Level_326Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_326Code.GDSpikeObjects4[0].getPointX("Center")), (( gdjs.Level_326Code.GDSpikeObjects4.length === 0 ) ? 0 :gdjs.Level_326Code.GDSpikeObjects4[0].getPointY("Center")), "Objects");
}{for(var i = 0, len = gdjs.Level_326Code.GDFireObjects4.length ;i < len;++i) {
    gdjs.Level_326Code.GDFireObjects4[i].setAngle(270);
}
}}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight"), gdjs.Level_326Code.GDNewLightObjects2);
{for(var i = 0, len = gdjs.Level_326Code.GDNewLightObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDNewLightObjects2[i].setPosition((( gdjs.Level_326Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_326Code.GDDuckObjects2[0].getPointX("")),(( gdjs.Level_326Code.GDDuckObjects2.length === 0 ) ? 0 :gdjs.Level_326Code.GDDuckObjects2[0].getPointY("")) - 20);
}
}}
...
{ //Subevents
gdjs.Level_326Code.eventsList2(runtimeScene);} //End of subevents
}
...
gdjs.copyArray(runtimeScene.getObjects("NewLight3"), gdjs.Level_326Code.GDNewLight3Objects1);
{for(var i = 0, len = gdjs.Level_326Code.GDNewLight3Objects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDNewLight3Objects1[i].setRadius(gdjs.randomInRange(70, 80));
}
}{gdjs.evtTools.camera.showLayer(runtimeScene, "");
}{for(var i = 0, len = gdjs.Level_326Code.GDLevelObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDLevelObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckObjects1[i].hide();
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("DuckArtwork"), gdjs.Level_326Code.GDDuckArtworkObjects3);
{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects3[i].setPosition((( gdjs.Level_326Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_326Code.GDDuckObjects3[0].getPointX("")) + 32,(( gdjs.Level_326Code.GDDuckObjects3.length === 0 ) ? 0 :gdjs.Level_326Code.GDDuckObjects3[0].getPointY("")) - 5);
}
...
};gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects = Hashtable.newFrom({"Duck": gdjs.Level_326Code.GDDuckObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDSpikeObjects2Objects = Hashtable.newFrom({"Spike": gdjs.Level_326Code.GDSpikeObjects2});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects, gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDSpikeObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckObjects2[i].deleteFromScene(runtimeScene);
}
}
{ //Subevents
...
gdjs.Level_326Code.eventsList6(runtimeScene);
}
...
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDKeyObjects2Objects = Hashtable.newFrom({"Key": gdjs.Level_326Code.GDKeyObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDSparkleParticleObjects2Objects = Hashtable.newFrom({"SparkleParticle": gdjs.Level_326Code.GDSparkleParticleObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects = Hashtable.newFrom({"Duck": gdjs.Level_326Code.GDDuckObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDoorObjects2Objects = Hashtable.newFrom({"Door": gdjs.Level_326Code.GDDoorObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects = Hashtable.newFrom({"Duck": gdjs.Level_326Code.GDDuckObjects2});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDoorObjects2Objects = Hashtable.newFrom({"Door": gdjs.Level_326Code.GDDoorObjects2});
...
};gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects1Objects = Hashtable.newFrom({"Duck": gdjs.Level_326Code.GDDuckObjects1});
gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDoorObjects1Objects = Hashtable.newFrom({"Door": gdjs.Level_326Code.GDDoorObjects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects, gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDKeyObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDSparkleParticleObjects2Objects, (( gdjs.Level_326Code.GDKeyObjects2.length === 0 ) ? 0 :gdjs.Level_326Code.GDKeyObjects2[0].getPointX("Center")), (( gdjs.Level_326Code.GDKeyObjects2.length === 0 ) ? 0 :gdjs.Level_326Code.GDKeyObjects2[0].getPointY("Center")), "Player");
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects2Objects, gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDoorObjects2Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
{ //Subevents
gdjs.Level_326Code.eventsList11(runtimeScene);} //End of subevents
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDuckObjects1Objects, gdjs.Level_326Code.mapOfGDgdjs_9546Level_9595326Code_9546GDDoorObjects1Objects, true, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
gdjs.Level_326Code.eventsList10(runtimeScene);
}
...
gdjs.Level_326Code.eventsList12(runtimeScene);
}
...
gdjs.Level_326Code.GDNewLightObjects1.length = 0;
gdjs.Level_326Code.GDNewLightObjects2.length = 0;
gdjs.Level_326Code.GDNewLightObjects3.length = 0;
gdjs.Level_326Code.GDNewLightObjects4.length = 0;
gdjs.Level_326Code.GDNewLight2Objects1.length = 0;
gdjs.Level_326Code.GDNewLight2Objects2.length = 0;
gdjs.Level_326Code.GDNewLight2Objects3.length = 0;
gdjs.Level_326Code.GDNewLight2Objects4.length = 0;
gdjs.Level_326Code.GDNewLight3Objects1.length = 0;
gdjs.Level_326Code.GDNewLight3Objects2.length = 0;
gdjs.Level_326Code.GDNewLight3Objects3.length = 0;
gdjs.Level_326Code.GDNewLight3Objects4.length = 0;
gdjs.Level_326Code.GDFireObjects1.length = 0;
gdjs.Level_326Code.GDFireObjects2.length = 0;
gdjs.Level_326Code.GDFireObjects3.length = 0;
gdjs.Level_326Code.GDFireObjects4.length = 0;
gdjs.Level_326Code.GDDoorLightObjects1.length = 0;
gdjs.Level_326Code.GDDoorLightObjects2.length = 0;
gdjs.Level_326Code.GDDoorLightObjects3.length = 0;
gdjs.Level_326Code.GDDoorLightObjects4.length = 0;

gdjs.Level_326Code.eventsList13(runtimeScene);
gdjs.Level_326Code.GDDuckObjects1.length = 0;
gdjs.Level_326Code.GDDuckObjects2.length = 0;
gdjs.Level_326Code.GDDuckObjects3.length = 0;
gdjs.Level_326Code.GDDuckObjects4.length = 0;
