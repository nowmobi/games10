...
(window.fgui = {}),
	(function (t) {
		class e {
			...
			load(t, e = null, i = null, s = null, h = 1, r = !0) {
	...
	(function (t) {
		t.AsyncOperation = class {
			...
			internalCreateObject(i) {
				(this._itemList.length = 0), (this._objectPool.length = 0);
				var s = new e(i, t.ObjectType.Component);
				(s.childCount = this.collectComponentChildren(i)),
					this._itemList.push(s),
					(this._index = 0),
					Laya.timer.frameLoop(1, this, this.run);
			}
			collectComponentChildren(i) {
				var s,
					h,
					r,
					a,
				...
				var _ = l.getInt16();
				for (r = 0; r < _; r++) {
					(a = l.getInt16()), (n = l.pos), l.seek(n, 0);
					var d = l.readByte(),
						c = l.readS(),
						u = l.readS();
					(l.pos = n),
						null != c
							? ((h =
									...
									(o =
										null != u
											? t.UIPackage.getById(u)
											: i.owner)
										? o.getItemById(c)
										: null),
							  (s = new e(h, d)),
							  null != h &&
									h.type == t.PackageItemType.Component &&
									(s.childCount =
										this.collectComponentChildren(h)))
							: ((s = new e(null, d)),
							  d == t.ObjectType.List &&
									(s.listItemCount =
										this.collectListChildren(l))),
						this._itemList.push(s),
						(l.pos = n + a);
				}
				return _;
			}
			collectListChildren(i) {
				i.seek(i.pos, 8);
				var s,
					h,
					r,
				...
				for (s = 0; s < _; s++)
					(h = i.getInt16()),
						...
						null == (r = i.readS()) && (r = l),
						r &&
							null != (a = t.UIPackage.getItemByURL(r)) &&
							((n = new e(a, a.objectType)),
							a.type == t.PackageItemType.Component &&
								(n.childCount =
									this.collectComponentChildren(a)),
			...
			run() {
				for (
					var e,
						...
						h,
						r = Laya.Browser.now(),
						a = t.UIConfig.frameTimeForAsyncUIConstruction,
						n = this._itemList.length;
					this._index < n;

				) {
					if (null != (i = this._itemList[this._index]).packageItem)
						((e = t.UIObjectFactory.newObject(
							i.packageItem
						)).packageItem = i.packageItem),
							this._objectPool.push(e),
							t.UIPackage._constructing++,
							i.packageItem.type == t.PackageItemType.Component
								? ((s =
										this._objectPool.length -
										i.childCount -
										1),
								  e.constructFromResource2(this._objectPool, s),
								  this._objectPool.splice(s, i.childCount))
								: e.constructFromResource(),
							t.UIPackage._constructing--;
					else if (
						...
						for (
							s = this._objectPool.length - i.listItemCount - 1,
								h = 0;
							h < i.listItemCount;
							h++
						)
		...
		class e extends Laya.EventDispatcher {
			...
			get selectedPage() {
				return -1 == this._selectedIndex
					? null
					: this._pageNames[this._selectedIndex];
			}
			set selectedPage(t) {
			...
			get previousPage() {
				return -1 == this._previousIndex
					? null
					: this._pageNames[this._previousIndex];
			}
			get pageCount() {
			...
			addPageAt(t, i = 0) {
				...
				i == this._pageIds.length
					? (this._pageIds.push(s), this._pageNames.push(this.name))
					: (this._pageIds.splice(i, 0, s),
					  this._pageNames.splice(i, 0, this.name));
			}
			removePage(t) {
				...
				-1 != e &&
					...
					this._selectedIndex >= this._pageIds.length
			...
			get selectedPageId() {
				return -1 == this._selectedIndex
					? null
					: this._pageIds[this._selectedIndex];
			}
			...
			set oppositePageId(t) {
				this._pageIds.indexOf(t) > 0
					? (this.selectedIndex = 0)
					: this._pageIds.length > 1 && (this.selectedIndex = 1);
			}
			get previousPageId() {
				return -1 == this._previousIndex
					? null
					: this._pageIds[this._previousIndex];
			}
			runActions() {
				if (this._actions)
			...
			setup(e) {
				...
				if (e.version >= 2)
					switch (e.getByte()) {
						...
						case 3:
							-1 ==
								(a = this._pageNames.indexOf(
									t.UIPackage.getVar(e.readS())
								)) && (a = 0);
					}
				if ((e.seek(h, 2), (r = e.getInt16()) > 0))
					for (
						null == this._actions && (this._actions = []), i = 0;
						i < r;
						i++
					) {
				...
				null != this.parent && this._pageIds.length > 0
		...
		class e {
			constructor() {
				(this._agent = new t.GLoader()),
					...
					this._agent.setPivot(0.5, 0.5, !0),
			...
			startDrag(e, i, s, h = -1) {
				if (null == this._agent.parent) {
					...
					var r = t.GRoot.inst.globalToLocal(
						Laya.stage.mouseX,
						Laya.stage.mouseY
					);
				...
				if (null != this._agent.parent) {
					...
					for (var s = t.GObject.cast(e.target); null != s; ) {
						if (s.displayObject.hasListener(t.Events.DROP))
							return (
								s.requestFocus(),
								void s.displayObject.event(t.Events.DROP, [
									i,
	...
	(function (t) {
		class e {
			static createEvent(t, i, s = null) {
				return (
					e.$event.setTo(t, i, s ? s.target : i),
					s
						? ((e.$event.touchId = s.touchId),
						  (e.$event.nativeEvent = s.nativeEvent))
						: (e.$event.nativeEvent = null),
					(e.$event._stoped = !1),
					e.$event
				);
			}
			static dispatch(t, i, s = null) {
				i.event(t, e.createEvent(t, i, s));
			}
		}
		(e.STATE_CHANGED = 'fui_state_changed'),
			...
			(e.DROP = 'fui_drop'),
			(e.FOCUS_CHANGED = 'fui_focus_changed'),
	...
	(function (t) {
		let e, i, s, h, r, a, n, o, l, _, d, c, u, g, p, f, y, m, w, v, C, b;
		!(function (t) {
			(t[(t.Common = 0)] = 'Common'),
				(t[(t.Check = 1)] = 'Check'),
				(t[(t.Radio = 2)] = 'Radio');
	...
	(function (t) {
		class e {
			...
			setXY(i, s) {
				if (this._x != i || this._y != s) {
					...
					(this._x = i),
						...
						this instanceof t.GGroup && this.moveChildren(h, r),
						this.updateGear(1),
						!this._parent ||
							this._parent instanceof t.GList ||
							(this._parent.setBoundsChangedFlag(),
							null != this._group &&
								this._group.setBoundsChangedFlag(!0),
							this.displayObject.event(t.Events.XY_CHANGED)),
						e.draggingObject != this ||
							e.sUpdateInDragging ||
							this.localToGlobalRect(
								0,
								0,
								this.width,
								this.height,
			...
			get xMin() {
				return this._pivotAsAnchor
					? this._x - this._width * this._pivotX
					: this._x;
			}
			set xMin(t) {
				this._pivotAsAnchor
					? this.setXY(t + this._width * this._pivotX, this._y)
					: this.setXY(t, this._y);
			}
			get yMin() {
				return this._pivotAsAnchor
					? this._y - this._height * this._pivotY
					: this._y;
			}
			set yMin(t) {
				this._pivotAsAnchor
					? this.setXY(this._x, t + this._height * this._pivotY)
					: this.setXY(this._x, t);
			}
			get pixelSnapping() {
			...
			set pixelSnapping(t) {
				this._pixelSnapping != t &&
					((this._pixelSnapping = t), this.handleXYChanged());
			}
			center(e = !1) {
				var i;
				(i = null != this._parent ? this.parent : this.root),
					this.setXY(
						(i.width - this.width) / 2,
			...
			setSize(e, i, s = !1) {
				if (this._rawWidth != e || this._rawHeight != i) {
					...
					(this._width = e),
						...
						(0 == this._pivotX && 0 == this._pivotY) ||
							(this._pivotAsAnchor
								? this.applyPivot()
								: (s ||
										this.setXY(
											this.x - this._pivotX * h,
											this.y - this._pivotY * r
										),
			...
			setSkew(t, e) {
				(this._skewX == t && this._skewY == e) ||
					((this._skewX = t),
					(this._skewY = e),
					null != this._displayObject &&
						(this._displayObject.skew(-t, e), this.applyPivot()));
			}
			get pivotX() {
				return this._pivotX;
			}
			...
			updatePivotOffset() {
				if (null != this._displayObject)
					if (
						!this._displayObject.transform ||
						(0 == this._pivotX && 0 == this._pivotY)
					)
						(this._pivotOffsetX = 0), (this._pivotOffsetY = 0);
					else {
						(e.sHelperPoint.x = this._pivotX * this._width),
							(e.sHelperPoint.y = this._pivotY * this._height);
						var t = this._displayObject.transform.transformPoint(
							e.sHelperPoint
						);
						(this._pivotOffsetX = this._pivotX * this._width - t.x),
							(this._pivotOffsetY =
								this._pivotY * this._height - t.y);
					}
			}
			applyPivot() {
				(0 == this._pivotX && 0 == this._pivotY) ||
			...
			set touchable(e) {
				if (this._touchable != e) {
					if (
						((this._touchable = e),
						this.updateGear(3),
						this instanceof t.GImage ||
							this instanceof t.GMovieClip ||
							(this instanceof t.GTextField &&
								!(this instanceof t.GTextInput) &&
								!(this instanceof t.GRichTextField)))
					)
						return;
					null != this._displayObject &&
			...
			get internalVisible2() {
				return (
					this._visible &&
					(!this._group || this._group.internalVisible2)
				);
			}
			...
			set sortingOrder(t) {
				if ((t < 0 && (t = 0), this._sortingOrder != t)) {
					...
					(this._sortingOrder = t),
						null != this._parent &&
							this._parent.childSortingOrderChanged(
								this,
								e,
								this._sortingOrder
							);
			...
			get inContainer() {
				return (
					null != this._displayObject &&
					null != this._displayObject.parent
				);
			}
			get onStage() {
				return (
					null != this._displayObject &&
					null != this._displayObject.stage
				);
			}
			get resourceURL() {
				return null != this.packageItem
					? 'ui://' + this.packageItem.owner.id + this.packageItem.id
					: null;
			}
			set group(t) {
				this._group != t &&
			...
			getGear(e) {
				...
				return (
					null == i &&
						(this._gears[e] = i = t.GearBase.create(this, e)),
					i
				);
			}
			updateGear(t) {
			...
			updateGearFromRelations(t, e, i) {
				null != this._gears[t] &&
					this._gears[t].updateFromRelations(e, i);
			}
			addDisplayLock() {
				var t = this._gears[0];
				if (t && t.controller) {
			...
			set draggable(t) {
				this._draggable != t &&
					((this._draggable = t), this.initDrag());
			}
			get dragBounds() {
			...
			localToGlobal(t = 0, i = 0, s = null) {
				return (
					this._pivotAsAnchor &&
						((t += this._pivotX * this._width),
						(i += this._pivotY * this._height)),
					s
						? ((s.x = t),
						  (s.y = i),
						  this._displayObject.localToGlobal(s, !1))
						: (((s = e.sHelperPoint).x = t),
						  (s.y = i),
						  this._displayObject.localToGlobal(s, !0))
				);
			}
			globalToLocal(t = 0, i = 0, s = null) {
				return (
					s
						? ((s.x = t),
						  (s.y = i),
						  this._displayObject.globalToLocal(s, !1))
						: (((s = e.sHelperPoint).x = t),
						  (s.y = i),
						  (s = this._displayObject.globalToLocal(s, !0))),
					this._pivotAsAnchor &&
						((s.x -= this._pivotX * this._width),
						(s.y -= this._pivotY * this._height)),
					s
				);
			}
			localToGlobalRect(t = 0, e = 0, i = 0, s = 0, h = null) {
				null == h && (h = new Laya.Rectangle());
			...
			globalToLocalRect(t = 0, e = 0, i = 0, s = 0, h = null) {
				null == h && (h = new Laya.Rectangle());
			...
			handleXYChanged() {
				...
				this._pivotAsAnchor &&
					...
					this._displayObject.pos(
						t + this._pivotOffsetX,
						e + this._pivotOffsetY
					);
			}
			handleSizeChanged() {
			...
			setup_beforeAdd(e, i) {
				...
				e.seek(i, 0),
					...
					2 == e.readByte() && (this.blendMode = 'lighter'),
					1 == e.readByte() &&
						t.ToolSet.setColorFilter(this._displayObject, [
							e.getFloat32(),
							e.getFloat32(),
							e.getFloat32(),
							e.getFloat32()
			...
			dragBegin() {
				null != e.draggingObject && e.draggingObject.stopDrag(),
					(e.sGlobalDragStart.x = Laya.stage.mouseX),
					(e.sGlobalDragStart.y = Laya.stage.mouseY),
					this.localToGlobalRect(
						0,
						0,
						this.width,
			...
			__moving(i) {
				...
				(null != this._touchDownPoint &&
					Math.abs(this._touchDownPoint.x - Laya.stage.mouseX) < s &&
					Math.abs(this._touchDownPoint.y - Laya.stage.mouseY) < s) ||
					(this.reset(),
					(e.sDraggingQuery = !0),
					t.Events.dispatch(
						t.Events.DRAG_START,
			...
			__moving2(i) {
				var s =
						Laya.stage.mouseX -
						e.sGlobalDragStart.x +
						e.sGlobalRect.x,
					h =
						Laya.stage.mouseY -
						e.sGlobalDragStart.y +
						e.sGlobalRect.y;
				if (null != this._dragBounds) {
					var r = t.GRoot.inst.localToGlobalRect(
						this._dragBounds.x,
						this._dragBounds.y,
						this._dragBounds.width,
						this._dragBounds.height,
						e.sDragHelperRect
					);
					(s < r.x ||
						(s + e.sGlobalRect.width > r.right &&
							(s = r.right - e.sGlobalRect.width) < r.x)) &&
						(s = r.x),
						(h < r.y ||
							(h + e.sGlobalRect.height > r.bottom &&
								(h = r.bottom - e.sGlobalRect.height) < r.y)) &&
							(h = r.y);
				}
				e.sUpdateInDragging = !0;
				var a = this.parent.globalToLocal(s, h, e.sHelperPoint);
				this.setXY(Math.round(a.x), Math.round(a.y)),
		...
		(e._gInstanceCounter = 0),
			(e.sGlobalDragStart = new Laya.Point()),
			(e.sGlobalRect = new Laya.Rectangle()),
			(e.sHelperPoint = new Laya.Point()),
			(e.sDragHelperRect = new Laya.Rectangle()),
			(t.GObject = e);
	})(fgui || (fgui = {})),
	((t = fgui || (fgui = {})).GTextField = class extends t.GObject {
		constructor() {
			super(), (this._gearColor = new t.GearColor(this));
		}
		get font() {
			return null;
		}
		...
		set autoSize(e) {
			this._autoSize != e &&
				...
				(this._heightAutoSize =
					...
					this._autoSize == t.AutoSizeType.Height),
				this.updateAutoSize());
		}
		updateAutoSize() {}
		get textWidth() {
			...
			for (var e, i, s, h, r = 0, a = ''; -1 != (e = t.indexOf('{', r)); )
				if (e > 0 && 92 == t.charCodeAt(e - 1))
					...
					if (
						...
						break;
					e != r + 1
						? (-1 != (i = (s = t.substring(r + 1, e)).indexOf('='))
								? (a +=
										null ==
										(h =
											this._templateVars[
											...
											? s.substring(i + 1)
											: h)
								: null != (h = this._templateVars[s]) &&
								  (a += h),
						  (r = e + 1))
						: ((a += t.substr(r, 2)), (r = e + 1));
				}
		...
		set templateVars(t) {
			(null == this._templateVars && null == t) ||
				((this._templateVars = t), this.flushVars());
		}
		setVar(t, e) {
			return (
	...
	(function (t) {
		class e extends t.GTextField {
			...
			createDisplayObject() {
				(this._displayObject = this._textField = new s(this)),
					(this._displayObject.$owner = this),
			...
			set text(e) {
				if (
					...
					null != this._templateVars && (i = this.parseTemplate(i)),
						this._ubbEnabled
							? (this._textField.text = t.ToolSet.removeUBB(
									t.ToolSet.encodeHTML(i)
							  ))
							: (this._textField.text = i);
				} else
					(this._textField.text = ''), this._textField.setChanged();
				this.parent &&
					this.parent._underConstruct &&
			...
			set font(e) {
				(this._font = e),
					t.ToolSet.startsWith(this._font, 'ui://')
						? (this._bitmapFont = t.UIPackage.getItemAssetByURL(
								this._font
						  ))
			...
			set color(t) {
				this._color != t &&
					((this._color = t),
					this._gearColor.controller && this._gearColor.updateState(),
					this.grayed
			...
			set singleLine(t) {
				(this._singleLine = t),
					(this._textField.wordWrap =
						!this._widthAutoSize && !this._singleLine);
			}
			get stroke() {
			...
			get textWidth() {
				return (
					this._textField._isChanged && this._textField.typeset(),
					this._textWidth
				);
			}
			ensureSizeCorrect() {
				!this._underConstruct &&
					this._textField._isChanged &&
					this._textField.typeset();
			}
			typeset() {
				null != this._bitmapFont
			...
			updateSize() {
				...
				this._widthAutoSize
					? ((t = this._textWidth),
					  this._textField.width != t &&
							((this._textField.width = t),
							'left' != this._textField.align &&
			...
			renderWithBitmapFont() {
				var s = this._displayObject.graphics;
				s.clear(),
					this._lines
						? i.returnList(this._lines)
						: (this._lines = new Array());
				var h,
					r = this.leading - 1,
					a = this.width - 2 * e.GUTTER_X,
					n = 0,
					o = 0,
					l = 0,
					_ = 0,
					...
					f = '',
					y = e.GUTTER_Y,
					m = !this._widthAutoSize && !this._singleLine,
					w = this.fontSize,
					v = this._bitmapFont.resizable
						? w / this._bitmapFont.size
						: 1;
				...
				for (var x = S.length, I = 0; I < x; ++I) {
					...
					if (10 != P) {
						if (
							...
							L
								? ((_ = Math.ceil(L.advance * v)),
								  (d = Math.ceil(L.lineHeight * v)))
								: ((_ = 0), (d = 0));
						}
						if (
							(d > l && (l = d),
							d > o && (o = d),
							0 != n && (n += this._letterSpacing),
							(n += _),
							!m || n <= a)
						)
							f += T;
							...
							if (
								...
								var O = (f += T).length - c;
								(h.text = t.ToolSet.trimRight(f.substr(0, O))),
									(h.width = g),
									(f = f.substr(O)),
									(n -= u);
							} else
								(h.text = f),
									(h.width = n - (_ + this._letterSpacing)),
									(f = T),
									(n = _),
									(o = d),
									(l = d);
							(h.y = y),
								(y += h.height + r),
								h.width > this._textWidth &&
									(this._textWidth = h.width),
								(c = 0),
								(u = 0),
								(g = 0),
								this._lines.push(h);
				...
				if (
					(f.length > 0 &&
						...
						h.width > this._textWidth &&
							(this._textWidth = h.width),
						this._lines.push(h)),
					this._textWidth > 0 && (this._textWidth += 2 * e.GUTTER_X),
					0 == this._lines.length
						? (this._textHeight = 0)
						: ((h = this._lines[this._lines.length - 1]),
						  (this._textHeight = h.y + h.height + e.GUTTER_Y)),
					(C = this._widthAutoSize
						? 0 == this._textWidth
							? 0
							: this._textWidth
						: this.width),
					(b = this._heightAutoSize
						? 0 == this._textHeight
							? 0
							: this._textHeight
						: this.height),
					...
					for (
						var E = this._lines.length,
							j = this._bitmapFont.tint ? this._color : null,
							M = 0;
						M < E;
						M++
					) {
						(h = this._lines[M]),
							...
							(x = h.text.length);
						for (var A = 0; A < x; A++)
							10 != (P = (T = h.text.charAt(A)).charCodeAt(0)) &&
								(32 != P
									? null != (L = this._bitmapFont.glyphs[T])
										? ((z =
												(h.height + h.textHeight) / 2 -
												Math.ceil(L.lineHeight * v)),
										  L.texture &&
												s.drawTexture(
													L.texture,
													k + B + Math.ceil(L.x * v),
										  ...
										  (k +=
												this._letterSpacing +
												Math.ceil(L.advance * v)))
										: (k += this._letterSpacing)
									: (k +=
											this._letterSpacing +
											Math.ceil(w / 2)));
					}
			...
			doAlign() {
				if ('top' == this.valign || 0 == this._textHeight)
					this._yOffset = e.GUTTER_Y;
				else {
					var t = this.height - this._textHeight;
					t < 0 && (t = 0),
						'middle' == this.valign
							? (this._yOffset = Math.floor(t / 2))
							: (this._yOffset = Math.floor(t));
				}
				this.handleXYChanged();
			}
			flushVars() {
		...
		class s extends Laya.Text {
			...
			set isChanged(e) {
				e &&
					!this._sizeDirty &&
					this._owner.autoSize != t.AutoSizeType.None &&
					this._owner.parent &&
					((this._sizeDirty = !0),
	...
	(function (t) {
		class e extends t.GObject {
			...
			dispose() {
				...
				for (
					null != this.scrollPane && this.scrollPane.dispose(),
						t = (e = this._children.length) - 1;
					t >= 0;
					--t
				) {
			...
			removeChildAt(e, i) {
				if (e >= 0 && e < this._children.length) {
					...
					return (
						...
						(s.group = null),
						s.inContainer &&
							(this._container.removeChild(s.displayObject),
							this._childrenRenderOrder ==
								t.ChildrenRenderOrder.Arch &&
			...
			getChildByPath(t) {
				for (
					var i, s = t.split('.'), h = s.length, r = this, a = 0;
					a < h && (i = r.getChild(s[a]));
					++a
				)
					if (a != h - 1) {
						if (!(r instanceof e)) {
			...
			childStateChanged(e) {
				if (!this._buildingDisplayList) {
					...
					if (e instanceof t.GGroup)
						...
						if (
							e.internalVisible &&
							e.displayObject != this._displayObject.mask
						) {
							if (!e.displayObject.parent) {
								...
								if (
									...
									for (
										s = 0;
										s < i && (h = this._children[s]) != e;
										s++
									)
										null != h.displayObject &&
											null != h.displayObject.parent &&
											r++;
							...
							e.displayObject.parent &&
								(this._container.removeChild(e.displayObject),
								this._childrenRenderOrder ==
									t.ChildrenRenderOrder.Arch &&
									Laya.timer.callLater(
										this,
					...
					if (0 != s)
						switch (this._childrenRenderOrder) {
							case t.ChildrenRenderOrder.Ascent:
								for (e = 0; e < s; e++)
									null !=
										(i = this._children[e]).displayObject &&
										i.internalVisible &&
			...
			adjustRadioGroupDepth(e, i) {
				var s,
					...
					n = -1;
				for (s = 0; s < r; s++)
					(h = this._children[s]) == e
						? (a = s)
						: h instanceof t.GButton &&
						  h.relatedController == i &&
						  s > n &&
						  (n = s);
				a < n &&
					(null != this._applyingController &&
						this._children[n].handleControllerChanged(
							this._applyingController
						),
			...
			isChildInView(t) {
				return null != this._displayObject.scrollRect
					? t.x + t.width >= 0 &&
							t.x <= this.width &&
							t.y + t.height >= 0 &&
							t.y <= this.height
					: null == this._scrollPane ||
							this._scrollPane.isChildInView(t);
			}
			getFirstChildInView() {
			...
			set opaque(t) {
				this._opaque != t &&
					((this._opaque = t),
					this._opaque
						? (null == this._displayObject.hitArea &&
								(this._displayObject.hitArea =
									new Laya.Rectangle()),
						  this._displayObject.hitArea instanceof
								Laya.Rectangle &&
								this._displayObject.hitArea.setTo(
									0,
									0,
									this._width,
									this._height
			...
			set margin(t) {
				this._margin.copy(t),
					null != this._displayObject.scrollRect &&
						this._container.pos(
			...
			set apexIndex(e) {
				this._apexIndex != e &&
					((this._apexIndex = e),
					this._childrenRenderOrder == t.ChildrenRenderOrder.Arch &&
						this.buildNativeDisplayList());
			}
			get mask() {
				return this._mask;
			...
			setMask(e, i) {
				if (
					(this._mask &&
						this._mask != e &&
						'destination-out' == this._mask.blendMode &&
				...
				this._mask.hitArea &&
					((this._displayObject.hitArea = new t.ChildHitArea(
						this._mask,
						i
					)),
					(this._displayObject.mouseThrough = !1),
			...
			updateHitArea() {
				if (this._displayObject.hitArea instanceof t.PixelHitTest) {
					...
					0 != this.sourceWidth &&
						(e.scaleX = this._width / this.sourceWidth),
						0 != this.sourceHeight &&
							(e.scaleY = this._height / this.sourceHeight);
				} else
					this._displayObject.hitArea instanceof Laya.Rectangle &&
						this._displayObject.hitArea.setTo(
							0,
							0,
							this._width,
			...
			setupOverflow(e) {
				e == t.OverflowType.Hidden
					? (this._displayObject == this._container &&
							((this._container = new Laya.Sprite()),
							this._displayObject.addChild(this._container)),
					  this.updateMask(),
					  this._container.pos(this._margin.left, this._margin.top))
					: (0 == this._margin.left && 0 == this._margin.top) ||
					  (this._displayObject == this._container &&
							((this._container = new Laya.Sprite()),
							this._displayObject.addChild(this._container)),
					  this._container.pos(this._margin.left, this._margin.top));
			...
			handleGrayedChanged() {
				...
				if (null == t)
					for (
						var e = this.grayed, i = this._children.length, s = 0;
						s < i;
						++s
					)
			...
			handleControllerChanged(t) {
				super.handleControllerChanged(t),
					null != this._scrollPane &&
						this._scrollPane.handleControllerChanged(t);
			}
			setBoundsChangedFlag() {
				(this._scrollPane || this._trackBounds) &&
					(this._boundsChanged ||
			...
			setBounds(t, e, i, s) {
				(this._boundsChanged = !1),
					this._scrollPane &&
						this._scrollPane.setContentSize(
							Math.round(t + i),
							Math.round(e + s)
						);
			}
			get viewWidth() {
				return null != this._scrollPane
					? this._scrollPane.viewWidth
					: this.width - this._margin.left - this._margin.right;
			}
			set viewWidth(t) {
				null != this._scrollPane
					? (this._scrollPane.viewWidth = t)
					: (this.width = t + this._margin.left + this._margin.right);
			}
			get viewHeight() {
				return null != this._scrollPane
					? this._scrollPane.viewHeight
					: this.height - this._margin.top - this._margin.bottom;
			}
			set viewHeight(t) {
				null != this._scrollPane
					? (this._scrollPane.viewHeight = t)
					: (this.height =
							t + this._margin.top + this._margin.bottom);
			}
			getSnappingPosition(t, e, i = null) {
				return this.getSnappingPositionWithDir(t, e, 0, 0, i);
			}
			getSnappingPositionWithDir(t, e, i, s, h = null) {
				h || (h = new Laya.Point());
			...
			childSortingOrderChanged(t, e, i = 0) {
				if (0 == i)
					this._sortingChildCount--,
					...
					s < h
						? this._setChildIndex(t, s, h - 1)
						: this._setChildIndex(t, s, h);
				}
			}
			constructFromResource() {
			...
			constructFromResource2(e, i) {
				var s, h, r, a, n, o, l, _;
				this.packageItem.decoded ||
					((this.packageItem.decoded = !0),
					t.TranslationHelper.translateComponent(this.packageItem));
				var d = this.packageItem.rawData;
				d.seek(0, 0),
					(this._underConstruct = !0),
					(this.sourceWidth = d.getInt32()),
					(this.sourceHeight = d.getInt32()),
					(this.initWidth = this.sourceWidth),
					(this.initHeight = this.sourceHeight),
					this.setSize(this.sourceWidth, this.sourceHeight),
					d.readBool() &&
						((this.minWidth = d.getInt32()),
						(this.maxWidth = d.getInt32()),
						(this.minHeight = d.getInt32()),
						(this.maxHeight = d.getInt32())),
					d.readBool() &&
						((n = d.getFloat32()),
						(o = d.getFloat32()),
						this.internalSetPivot(n, o, d.readBool())),
					d.readBool() &&
						((this._margin.top = d.getInt32()),
						(this._margin.bottom = d.getInt32()),
						(this._margin.left = d.getInt32()),
						(this._margin.right = d.getInt32()));
				var c = d.readByte();
				if (c == t.OverflowType.Scroll) {
					var u = d.pos;
					d.seek(0, 7), this.setupScroll(d), (d.pos = u);
				...
				var g,
					p = d.getInt16();
				for (s = 0; s < p; s++) {
					(a = d.getInt16()), (a += d.pos);
					var f = new t.Controller();
					this._controllers.push(f),
						(f.parent = this),
						f.setup(d),
						(d.pos = a);
				}
				...
				var y = d.getInt16();
				for (s = 0; s < y; s++) {
					if (((h = d.getInt16()), (r = d.pos), null != e))
						g = e[i + s];
					else {
						d.seek(r, 0);
						var m,
						...
						null != v &&
							(b =
								...
								(m =
									null != C
										? t.UIPackage.getById(C)
										: this.packageItem.owner)
									? m.getItemById(v)
									: null),
							null != b
								? (((g =
										t.UIObjectFactory.newObject(
											b
										)).packageItem = b),
								  g.constructFromResource())
								: (g = t.UIObjectFactory.newObject2(w));
					}
					(g._underConstruct = !0),
						g.setup_beforeAdd(d, r),
						(g.parent = this),
				...
				for (
					...
					(a = d.getInt16()),
						(a += d.pos),
						d.seek(d.pos, 3),
						this._children[s].relations.setup(d, !1),
						(d.pos = a);
				for (d.seek(0, 2), d.skip(2), s = 0; s < y; s++)
					(a = d.getInt16()),
						(a += d.pos),
						(g = this._children[s]).setup_afterAdd(d, d.pos),
						(g._underConstruct = !1),
						(d.pos = a);
				d.seek(0, 4), d.skip(2), (this.opaque = d.readBool());
				var S = d.getInt16();
				-1 != S &&
					this.setMask(
						this.getChildAt(S).displayObject,
						d.readBool()
					);
				var x,
					I = d.readS();
				(l = d.getInt32()),
					(_ = d.getInt32()),
					I
						? (b = this.packageItem.owner.getItemById(I)) &&
						  b.pixelHitTestData &&
						  (x = new t.PixelHitTest(b.pixelHitTestData, l, _))
						: 0 != l &&
						  -1 != _ &&
						  (x = new t.ChildHitArea(
								this.getChildAt(_).displayObject
						  )),
					x &&
						((this._displayObject.hitArea = x),
						(this._displayObject.mouseThrough = !1),
						(this._displayObject.hitTestPrior = !0)),
					d.seek(0, 5);
				var T = d.getInt16();
				for (s = 0; s < T; s++) {
					...
					P.setup(d), this._transitions.push(P), (d.pos = a);
				}
				this._transitions.length > 0 &&
					...
					this.buildNativeDisplayList(),
					this.setBoundsChangedFlag(),
					this.packageItem.objectType != t.ObjectType.Component &&
						this.constructExtension(d),
					this.onConstruct();
			}
			...
			setup_afterAdd(t, e) {
				...
				for (
					-1 != h &&
						null != this._scrollPane &&
						(this._scrollPane.pageController =
							this._parent.getControllerAt(h)),
						i = t.getInt16(),
						s = 0;
					s < i;
					s++
	...
	(function (t) {
		class e extends t.GComponent {
			constructor() {
				super(),
					...
					(this._soundVolumeScale =
						t.UIConfig.buttonSoundVolumeScale),
			...
			set icon(t) {
				(this._icon = t),
					(t =
						this._selected && this._selectedIcon
							? this._selectedIcon
							: this._icon),
				...
				(this._title = t),
					this._titleObject &&
						(this._titleObject.text =
							this._selected && this._selectedTitle
								? this._selectedTitle
								: this._title),
					this.updateGear(6);
			}
			...
			set selected(i) {
				if (this._mode != t.ButtonMode.Common && this._selected != i) {
					if (
						...
						this._buttonController.hasPage(e.DISABLED)
							? this._selected
								? this.setState(e.SELECTED_DISABLED)
								: this.setState(e.DISABLED)
							: this._selected
							? this.setState(
									this._over ? e.SELECTED_OVER : e.DOWN
							  )
							: this.setState(this._over ? e.OVER : e.UP),
						this._selectedTitle &&
							this._titleObject &&
							(this._titleObject.text = this._selected
								? this._selectedTitle
								: this._title),
						this._selectedIcon)
					) {
						var s = this._selected
							? this._selectedIcon
							: this._icon;
						null != this._iconObject && (this._iconObject.icon = s);
					}
					this._relatedController &&
						this._parent &&
						!this._parent._buildingDisplayList &&
						(this._selected
							? ((this._relatedController.selectedPageId =
									this._relatedPageId),
							  this._relatedController.autoRadioGroupDepth &&
									this._parent.adjustRadioGroupDepth(
										this,
										this._relatedController
									))
							: this._mode == t.ButtonMode.Check &&
							  this._relatedController.selectedPageId ==
									this._relatedPageId &&
							  (this._relatedController.oppositePageId =
									this._relatedPageId));
				}
			}
			get selected() {
			...
			getTextField() {
				return this._titleObject instanceof t.GTextField
					? this._titleObject
					: this._titleObject instanceof t.GLabel ||
					  this._titleObject instanceof e
					? this._titleObject.getTextField()
					: null;
			}
			fireClick(i = !0) {
				i &&
					this._mode == t.ButtonMode.Common &&
					(this.setState(e.OVER),
			...
			setState(i) {
				if (
					(this._buttonController &&
						(this._buttonController.selectedPage = i),
					1 == this._downEffect)
				) {
					...
					if (
						i == e.DOWN ||
						i == e.SELECTED_OVER ||
						i == e.SELECTED_DISABLED
					)
						for (
							var h = 255 * this._downEffectValue,
								r = Laya.Utils.toHexColor(
									(h << 16) + (h << 8) + h
								),
								a = 0;
							a < s;
							...
							n instanceof t.GTextField ||
								n.setProp(t.ObjectPropID.Color, r);
						}
					else
						for (a = 0; a < s; a++)
							(n = this.getChildAt(a)) instanceof t.GTextField ||
								n.setProp(t.ObjectPropID.Color, '#FFFFFF');
				} else
					2 == this._downEffect &&
						(i == e.DOWN ||
						i == e.SELECTED_OVER ||
			...
			handleControllerChanged(t) {
				super.handleControllerChanged(t),
					this._relatedController == t &&
						(this.selected =
							this._relatedPageId == t.selectedPageId);
			}
			handleGrayedChanged() {
				this._buttonController &&
				this._buttonController.hasPage(e.DISABLED)
					? this.grayed
						? this._selected &&
						  this._buttonController.hasPage(e.SELECTED_DISABLED)
							? this.setState(e.SELECTED_DISABLED)
							: this.setState(e.DISABLED)
						: this._selected
			...
			constructExtension(i) {
				...
				s && (this._sound = s),
					...
					null != this._titleObject &&
						(this._title = this._titleObject.text),
					null != this._iconObject &&
			...
			setup_afterAdd(t, e) {
				...
				super.setup_afterAdd(t, e),
					t.seek(e, 6) &&
						t.readByte() == this.packageItem.objectType &&
						(null != (i = t.readS()) && (this.title = i),
						...
						(s = t.getInt16()) >= 0 &&
							(this._relatedController =
								this.parent.getControllerAt(s)),
						(this._relatedPageId = t.readS()),
						null != (i = t.readS()) && (this._sound = i),
						t.readBool() &&
							(this._soundVolumeScale = t.getFloat32()),
						(this.selected = t.readBool()));
			}
			__rollover() {
				this._buttonController &&
					this._buttonController.hasPage(e.OVER) &&
					((this._over = !0),
					this._down ||
						(this.grayed &&
							this._buttonController.hasPage(e.DISABLED)) ||
						this.setState(
							this._selected ? e.SELECTED_OVER : e.OVER
						));
			}
			__rollout() {
				this._buttonController &&
					...
					this._down ||
						(this.grayed &&
							this._buttonController.hasPage(e.DISABLED)) ||
						this.setState(this._selected ? e.DOWN : e.UP));
			}
			__mousedown(i) {
				(this._down = !0),
					...
					this._mode == t.ButtonMode.Common &&
						...
						this._buttonController.hasPage(e.DISABLED)
							? this.setState(e.SELECTED_DISABLED)
							: this.setState(e.DOWN)),
					null != this._linkedPopup &&
						(this._linkedPopup instanceof t.Window
			...
			__click(e) {
				if (this._sound) {
					...
					i
						? t.GRoot.inst.playOneShotSound(i.file)
						: t.GRoot.inst.playOneShotSound(this._sound);
				}
				this._mode == t.ButtonMode.Check
					? this._changeStateOnClick &&
					  ((this.selected = !this._selected),
					  t.Events.dispatch(
							t.Events.STATE_CHANGED,
							this.displayObject,
							e
					  ))
					: this._mode == t.ButtonMode.Radio
					? this._changeStateOnClick &&
					  !this._selected &&
					  ((this.selected = !0),
					  t.Events.dispatch(
		...
		t.GComboBox = class extends t.GComponent {
			constructor() {
				super(),
					(this._visibleItemCount =
						t.UIConfig.defaultComboBoxVisibleItemCount),
				...
				t ? (this._items = t.concat()) : (this._items.length = 0),
					this._items.length > 0
						? (this._selectedIndex >= this._items.length
						  ...
						  null != this._icons &&
								this._selectedIndex < this._icons.length &&
			...
			getTextField() {
				return this._titleObject instanceof t.GTextField
					? this._titleObject
					: this._titleObject instanceof t.GLabel ||
					  this._titleObject instanceof t.GButton
					? this._titleObject.getTextField()
					: null;
			}
			setState(t) {
				this._buttonController &&
					(this._buttonController.selectedPage = t);
			}
			...
			updateSelectionController() {
				if (
					null != this._selectionController &&
					!this._selectionController.changing &&
			...
			constructExtension(e) {
				...
				if (
					...
					if (
						...
						return void Laya.Log.print(
							this.resourceURL +
								': 下拉框的弹出元件里必须包含名为list的列表'
						);
					this._list.on(t.Events.CLICK_ITEM, this, this.__clickItem),
						this._list.addRelation(
							this.dropdown,
							t.RelationType.Width
						),
						this._list.removeRelation(
							this.dropdown,
							t.RelationType.Height
						),
						this.dropdown.addRelation(
							this._list,
							t.RelationType.Height
						),
						this.dropdown.removeRelation(
							this._list,
							t.RelationType.Width
						),
						this.dropdown.displayObject.on(
							Laya.Event.UNDISPLAY,
							this,
							this.__popupWinClosed
						);
				}
				this.on(Laya.Event.ROLL_OVER, this, this.__rollover),
					this.on(Laya.Event.ROLL_OUT, this, this.__rollout),
				...
				if (
					...
					for (i = 0; i < a; i++)
						(h = t.getInt16()),
							...
							null != (r = t.readS()) &&
								(null == this._icons && (this._icons = []),
								(this._icons[i] = r)),
							(t.pos = h);
					null != (r = t.readS())
						? ((this.text = r),
						  (this._selectedIndex = this._items.indexOf(r)))
						: this._items.length > 0
						? ((this._selectedIndex = 0),
			...
			showDropdown() {
				if (this._itemsUpdated) {
					...
					for (var e = this._items.length, i = 0; i < e; i++) {
						...
						(s.name =
							i < this._values.length ? this._values[i] : ''),
							(s.text = this._items[i]),
							(s.icon =
								null != this._icons && i < this._icons.length
									? this._icons[i]
									: null);
					}
				...
				var h = null;
				this._popupDirection == t.PopupDirection.Down
					? (h = !0)
					: this._popupDirection == t.PopupDirection.Up && (h = !1),
					this.root.togglePopup(this.dropdown, this, h),
					this.dropdown.parent && this.setState(t.GButton.DOWN);
			}
			__popupWinClosed() {
				this._over
					? this.setState(t.GButton.OVER)
					: this.setState(t.GButton.UP);
			}
			__clickItem(t, e) {
				Laya.timer.callLater(this, this.__clickItem2, [
					this._list.getChildIndex(t),
					e
				]);
			}
			__clickItem2(e, i) {
				this.dropdown.parent instanceof t.GRoot &&
			...
			__mousedown(e) {
				e.target instanceof Laya.Input ||
					((this._down = !0),
	...
	(function (t) {
		t.GGraph = class extends t.GObject {
			...
			drawRegularPolygon(t, e, i, s, h = 0, r = null) {
				(this._type = 3),
					(this._lineSize = t),
					(this._lineColor = e),
					(this._fillColor = i),
					...
					if (1 == this._type)
						if (null != this._cornerRadius) {
							var o = [
								...
								['lineTo', i - this._cornerRadius[1], 0],
								[
									'arcTo',
									i,
									0,
								...
								['lineTo', i, s - this._cornerRadius[3]],
								[
									'arcTo',
									i,
									s,
									i - this._cornerRadius[3],
									s,
									this._cornerRadius[3]
								],
								['lineTo', this._cornerRadius[2], s],
								[
									'arcTo',
									0,
									s,
									0,
									s - this._cornerRadius[2],
						...
						for (
							var _,
								d = Laya.Utils.toRadian(this._startAngle),
								c = (2 * Math.PI) / this._sides,
								u = 0;
							u < this._sides;
							u++
						) {
			...
			getProp(e) {
				return e == t.ObjectPropID.Color
					? this.color
					: super.getProp(e);
			}
			setProp(e, i) {
				e == t.ObjectPropID.Color
					? (this.color = i)
					: super.setProp(e, i);
			}
			handleSizeChanged() {
			...
			setup_beforeAdd(t, e) {
				if (
					...
					if (3 == this._type)
						...
						4 == this._type &&
						((this._sides = t.getInt16()),
						(this._startAngle = t.getFloat32()),
						(s = t.getInt16()) > 0)
					)
						for (this._distances = [], i = 0; i < s; i++)
	...
	(function (t) {
		t.GGroup = class extends t.GObject {
			...
			set layout(t) {
				this._layout != t &&
					((this._layout = t), this.setBoundsChangedFlag());
			}
			get lineGap() {
			...
			set lineGap(t) {
				this._lineGap != t &&
					((this._lineGap = t), this.setBoundsChangedFlag(!0));
			}
			get columnGap() {
			...
			set columnGap(t) {
				this._columnGap != t &&
					((this._columnGap = t), this.setBoundsChangedFlag(!0));
			}
			...
			set mainGridMinSize(t) {
				this._mainGridMinSize != t &&
					((this._mainGridMinSize = t), this.setBoundsChangedFlag());
			}
			get mainGridIndex() {
			...
			set mainGridIndex(t) {
				this._mainGridIndex != t &&
					((this._mainGridIndex = t), this.setBoundsChangedFlag());
			}
			setBoundsChangedFlag(e = !1) {
				0 == this._updating &&
					null != this._parent &&
					(e || (this._percentReady = !1),
					this._boundsChanged ||
						((this._boundsChanged = !0),
						this._layout != t.GroupLayoutType.None &&
							Laya.timer.callLater(
								this,
								this.ensureBoundsCorrect
							)));
			...
			ensureSizeCorrect() {
				null != this._parent &&
					...
					this._autoSizeDisabled
						...
						: (this.handleLayout(), this.updateBounds()));
			}
			ensureBoundsCorrect() {
				null != this._parent &&
					this._boundsChanged &&
			...
			updateBounds() {
				...
				var t,
					...
					o = !0;
				for (t = 0; t < s; t++)
					(e = this._parent.getChildAt(t)).group != this ||
						(this._excludeInvisibles && !e.internalVisible3) ||
						((i = e.xMin) < h && (h = i),
						(i = e.yMin) < r && (r = i),
			...
			handleLayout() {
				...
				if (
					...
					for (s = this._parent.numChildren, i = 0; i < s; i++)
						(e = this._parent.getChildAt(i)).group == this &&
							((this._excludeInvisibles && !e.internalVisible3) ||
								((e.xMin = h),
								0 != e.width &&
									(h += e.width + this._columnGap)));
			...
			moveChildren(t, e) {
				if (0 == (1 & this._updating) && null != this._parent) {
					...
					for (i = 0; i < h; i++)
						(s = this._parent.getChildAt(i)).group == this &&
							s.setXY(s.x + t, s.y + e);
					this._updating &= 2;
				}
			}
				...
				if (
					...
					if (
						...
						if (!this._percentReady) {
							...
							var a = 0;
							for (s = 0; s < r; s++)
								(h = this._parent.getChildAt(s)).group ==
									this &&
									((this._excludeInvisibles &&
										!h.internalVisible3) ||
										(a == this._mainGridIndex &&
											(this._mainChildIndex = s),
										this._numChildren++,
										1 == this._layout
											? (this._totalSize += h.width)
											: (this._totalSize += h.height)),
									a++);
							for (
								-1 != this._mainChildIndex &&
									(1 == this._layout
										? ((h = this._parent.getChildAt(
												this._mainChildIndex
										  )),
										  (this._totalSize +=
												this._mainGridMinSize -
												h.width),
										  (h._sizePercentInGroup =
												this._mainGridMinSize /
												this._totalSize))
										: ((h = this._parent.getChildAt(
												this._mainChildIndex
						...
						if (1 == this._layout) {
							(n =
								this.width -
								(this._numChildren - 1) * this._columnGap),
								-1 != this._mainChildIndex &&
									n >= this._totalSize &&
									((h = this._parent.getChildAt(
										this._mainChildIndex
							...
							(n =
								this.height -
								(this._numChildren - 1) * this._lineGap),
								-1 != this._mainChildIndex &&
									n >= this._totalSize &&
									((h = this._parent.getChildAt(
										this._mainChildIndex
	...
	(function (t) {
		t.GImage = class extends t.GObject {
			...
			set color(t) {
				this.image.color != t &&
					((this.image.color = t), this.updateGear(4));
			}
			get flip() {
				return this._flip;
			}
			set flip(e) {
				if (this._flip != e) {
					...
					var i = 1,
						s = 1;
					(this._flip != t.FlipType.Horizontal &&
						this._flip != t.FlipType.Both) ||
						(i = -1),
						(this._flip != t.FlipType.Vertical &&
							this._flip != t.FlipType.Both) ||
							(s = -1),
						this.setScale(i, s),
						this.handleXYChanged();
			...
			constructFromResource() {
				(this._contentItem = this.packageItem.getBranch()),
					...
					(this.image.tileGridIndice =
						this._contentItem.tileGridIndice),
					(this.image.texture = this._contentItem.texture),
					this.setSize(this.sourceWidth, this.sourceHeight);
			}
			handleXYChanged() {
				super.handleXYChanged(),
					this._flip != t.FlipType.None &&
						(-1 == this.scaleX && (this.image.x += this.width),
			...
			setup_beforeAdd(t, e) {
				super.setup_beforeAdd(t, e),
					...
					0 != this.image.fillMethod &&
						((this.image.fillOrigin = t.readByte()),
	...
	(function (t) {
		class e extends t.GComponent {
			...
			set editable(t) {
				this._titleObject &&
					(this._titleObject.asTextInput.editable = t);
			}
			get editable() {
				return (
					!!(
						this._titleObject &&
						this._titleObject instanceof t.GTextInput
					) && this._titleObject.asTextInput.editable
				);
			}
			getTextField() {
				return this._titleObject instanceof t.GTextField
			...
			setup_afterAdd(t, e) {
				if (
					...
					if ((0 != s && (this.titleFontSize = s), t.readBool())) {
						...
						null != h
							? (null != (i = t.readS()) && (h.promptText = i),
							  null != (i = t.readS()) && (h.restrict = i),
							  0 != (s = t.getInt32()) && (h.maxLength = s),
							  0 != (s = t.getInt32()) &&
									(4 == s
										? (h.keyboardType =
	...
	(function (t) {
		class e extends t.GComponent {
			...
			set lineCount(e) {
				this._lineCount != e &&
					((this._lineCount = e),
					(this._layout != t.ListLayoutType.FlowVertical &&
						this._layout != t.ListLayoutType.Pagination) ||
						(this.setBoundsChangedFlag(),
						this._virtual && this.setVirtualListChangedFlag(!0)));
			}
			get columnCount() {
			...
			set columnCount(e) {
				this._columnCount != e &&
					((this._columnCount = e),
					(this._layout != t.ListLayoutType.FlowHorizontal &&
						this._layout != t.ListLayoutType.Pagination) ||
						(this.setBoundsChangedFlag(),
						this._virtual && this.setVirtualListChangedFlag(!0)));
			}
			...
			addChildAt(e, i) {
				if ((super.addChildAt(e, i), e instanceof t.GButton)) {
					var s = e;
			...
			removeChildAt(t, e) {
				...
				return (
					e
						? i.dispose()
						: i.off(Laya.Event.CLICK, this, this.__clickItem),
					i
				);
			}
			...
			get selectedIndex() {
				...
				if (this._virtual)
					for (e = 0; e < this._realNumItems; e++) {
						...
						if (
							(i.obj instanceof t.GButton && i.obj.selected) ||
							(null == i.obj && i.selected)
						)
			...
			getSelection(e) {
				...
				if ((e || (e = new Array()), this._virtual))
					for (i = 0; i < this._realNumItems; i++) {
						...
						if (
							(s.obj instanceof t.GButton && s.obj.selected) ||
							(null == s.obj && s.selected)
						) {
							var h = i;
							if (
								this._loop &&
								((h = i % this._numItems), -1 != e.indexOf(h))
							)
								continue;
							e.push(h);
						}
			...
			addSelection(e, i) {
				if (this._selectionMode != t.ListSelectionMode.None) {
					...
					if (this._virtual) {
						...
						null != h.obj && (s = h.obj.asButton),
							(h.selected = !0);
					} else s = this.getChildAt(e).asButton;
					null == s ||
						s.selected ||
						((s.selected = !0), this.updateSelectionController(e));
				}
			}
			removeSelection(e) {
				if (this._selectionMode != t.ListSelectionMode.None) {
			...
			selectReverse() {
				...
				if (this._virtual)
					...
					for (e = 0; e < h; e++) {
						var r = this._children[e].asButton;
						null != r &&
							((r.selected = !r.selected), r.selected && (i = e));
					}
				}
				-1 != i && this.updateSelectionController(i);
			}
					...
					switch (e) {
						case 1:
							if (
								...
								this._layout ==
									t.ListLayoutType.FlowHorizontal ||
								this._layout == t.ListLayoutType.Pagination
							) {
								for (
									var s = this._children[i], h = 0, r = i - 1;
									r >= 0;
									r--
								) {
			...
			__clickItem(e) {
				if (null == this._scrollPane || !this._scrollPane.isDragged) {
					...
					this.setSelectionOnEvent(i, e),
						this._scrollPane &&
							this.scrollItemToViewOnClick &&
							this._scrollPane.scrollToView(i, !0),
			...
			setSelectionOnEvent(e, i) {
				if (
					...
					this._selectionMode != t.ListSelectionMode.None
				) {
					var s = !1,
						h = e,
						r = this.childIndexToItemIndex(this.getChildIndex(e));
					if (this._selectionMode == t.ListSelectionMode.Single)
						h.selected ||
							(this.clearSelectionExcept(h), (h.selected = !0));
					else if (i.shiftKey) {
						if (!h.selected)
							if (-1 != this._lastSelectedIndex) {
								var a,
									n = Math.min(this._lastSelectedIndex, r),
									o = Math.max(this._lastSelectedIndex, r);
								if (
									((o = Math.min(o, this.numItems - 1)),
									this._virtual)
								)
									for (a = n; a <= o; a++) {
										var l = this._virtualItems[a];
										l.obj instanceof t.GButton &&
											(l.obj.selected = !0),
											(l.selected = !0);
									}
								else
									for (a = n; a <= o; a++) {
										var _ = this.getChildAt(a).asButton;
										null != _ && (_.selected = !0);
									}
								s = !0;
							} else h.selected = !0;
						...
						i.ctrlKey ||
						this._selectionMode ==
							t.ListSelectionMode.Multiple_SingleClick
							? (h.selected = !h.selected)
							: h.selected
							? this.clearSelectionExcept(h)
							: (this.clearSelectionExcept(h), (h.selected = !0));
					s || (this._lastSelectedIndex = r),
						h.selected && this.updateSelectionController(r);
				}
			}
			resizeToFit(e = 1e6, i = 0) {
				this.ensureBoundsCorrect();
				var s = this.numItems;
				if ((e > s && (e = s), this._virtual))
					Math.ceil(e / this._curLineItemCount),
						...
						this._layout == t.ListLayoutType.FlowHorizontal
							? (this.viewHeight =
									this.lineCount * this._itemSize.y +
									Math.max(0, this.lineCount - 1) *
										this._lineGap)
							: (this.viewWidth =
									this.lineCount * this._itemSize.x +
									Math.max(0, this.lineCount - 1) *
										this._columnGap);
				else if (0 == e)
					this._layout == t.ListLayoutType.SingleColumn ||
					...
					for (
						...
						h >= 0 &&
						((r = this.getChildAt(h)),
						this.foldInvisibleItems && !r.visible);
			...
			updateSelectionController(t) {
				if (
					null != this._selectionController &&
					!this._selectionController.changing &&
					t < this._selectionController.pageCount
				) {
			...
			shouldSnapToNext(e, i, s) {
				return (
					(e < 0 &&
						i > t.UIConfig.defaultScrollSnappingThreshold * s) ||
					(e > 0 &&
						i >
							(1 - t.UIConfig.defaultScrollSnappingThreshold) *
								s) ||
					(0 == e && i > s / 2)
				);
			}
			getSnappingPositionWithDir(i, s, h, r, a = null) {
				var n, o, l;
				return this._virtual
					? (a || (a = new Laya.Point()),
					  ...
					  this._layout == t.ListLayoutType.FlowHorizontal
							? ((n = s),
							  ...
							  o < this._virtualItems.length &&
									o < this._realNumItems &&
									((l = this._virtualItems[o].height),
									this.shouldSnapToNext(r, n - s, l) &&
										(s += l + this._lineGap)))
							: this._layout == t.ListLayoutType.SingleRow ||
							  this._layout == t.ListLayoutType.FlowVertical
							? ((n = i),
							  ...
							  o < this._virtualItems.length &&
									o < this._realNumItems &&
									((l = this._virtualItems[o].width),
									this.shouldSnapToNext(h, n - i, l) &&
										(i += l + this._columnGap)))
							: ((n = i),
							  (e.pos_param = i),
					  ...
					  (a.y = s),
					  a)
					: super.getSnappingPositionWithDir(i, s, h, r, a);
			}
			scrollToView(e, i = !1, s = !1) {
				if (this._virtual) {
					...
					if (
						...
						throw new Error(
							'Invalid child index: ' +
								e +
								'>' +
								this._virtualItems.length
						);
					var h;
					this._loop &&
						(e =
							Math.floor(this._firstIndex / this._numItems) *
								this._numItems +
							e);
					var r,
					...
					if (
						...
						for (
							r = this._curLineItemCount - 1;
							r < e;
							r += this._curLineItemCount
						)
							n += this._virtualItems[r].height + this._lineGap;
						h = new Laya.Rectangle(
							0,
							n,
							this._itemSize.x,
							a.height
						...
						var o =
							e /
							(this._curLineItemCount * this._curLineItemCount2);
						h = new Laya.Rectangle(
							o * this.viewWidth +
								(e % this._curLineItemCount) *
									(a.width + this._columnGap),
							((e / this._curLineItemCount) %
								this._curLineItemCount2) *
								(a.height + this._lineGap),
							a.width,
							a.height
						);
					}
					(s = !0),
						null != this._scrollPane &&
							this._scrollPane.scrollToView(h, i, s);
				} else {
					var l = this.getChildAt(e);
					null != this._scrollPane
						? this._scrollPane.scrollToView(l, i, s)
						: null != this._parent &&
						  null != this._parent.scrollPane &&
						  this._parent.scrollPane.scrollToView(l, i, s);
				}
			}
			getFirstChildInView() {
			...
			childIndexToItemIndex(e) {
				...
				if (this._layout == t.ListLayoutType.Pagination) {
					for (var i = this._firstIndex; i < this._realNumItems; i++)
						if (null != this._virtualItems[i].obj && --e < 0)
							return i;
					return e;
				}
				return (
				...
				if (!this._virtual) {
					...
					if (e) {
						if (
							...
							throw new Error(
								'Loop list instanceof not supported for FlowHorizontal or FlowVertical this.layout!'
							);
					...
					if (
						...
						if (null == i)
							throw new Error(
								'Virtual List must have a default list item resource.'
							);
			...
			set numItems(t) {
				...
				if (this._virtual) {
					...
					(this._numItems = t),
						this._loop
							? (this._realNumItems = 6 * this._numItems)
							: (this._realNumItems = this._numItems);
					var s = this._virtualItems.length;
					if (this._realNumItems > s)
						for (e = s; e < this._realNumItems; e++) {
							var h = new i();
							(h.width = this._itemSize.x),
								(h.height = this._itemSize.y),
								this._virtualItems.push(h);
						}
					else
						for (e = this._realNumItems; e < s; e++)
							this._virtualItems[e].selected = !1;
					0 != this._virtualListChanged &&
					...
					if (t > r)
						for (e = r; e < t; e++)
							null == this.itemProvider
								? this.addItemFromPool()
								: this.addItemFromPool(
										this.itemProvider.runWith(e)
								  );
					else this.removeChildrenToPool(t, r);
					if (null != this.itemRenderer)
						for (e = 0; e < t; e++)
			...
			getIndexOnPos1(t) {
				...
				if (this.numChildren > 0 && !t) {
					if ((s = this.getChildAt(0).y) > e.pos_param) {
						for (
							i = this._firstIndex - this._curLineItemCount;
							i >= 0;
							i -= this._curLineItemCount
						)
							if (
								(s -=
									this._virtualItems[i].height +
									this._lineGap) <= e.pos_param
							)
								return (e.pos_param = s), i;
						return (e.pos_param = 0), 0;
					}
					for (
						i = this._firstIndex;
						i < this._realNumItems;
						i += this._curLineItemCount
					) {
						if (
							(h =
				...
				for (
					...
					if (
						(h = s + this._virtualItems[i].height + this._lineGap) >
						e.pos_param
					)
						return (e.pos_param = s), i;
					s = h;
			...
			getIndexOnPos2(t) {
				...
				var i, s, h;
				if (this.numChildren > 0 && !t) {
					if ((s = this.getChildAt(0).x) > e.pos_param) {
						for (
							i = this._firstIndex - this._curLineItemCount;
							i >= 0;
							i -= this._curLineItemCount
							...
							if (
								(s -=
									this._virtualItems[i].width +
									this._columnGap) <= e.pos_param
							)
								return (e.pos_param = s), i;
						return (e.pos_param = 0), 0;
					}
				...
				for (
					...
					if (
						(h =
							s + this._virtualItems[i].width + this._columnGap) >
						e.pos_param
					)
						return (e.pos_param = s), i;
					s = h;
			...
			getIndexOnPos3(t) {
				...
				var i,
					s,
					h = this.viewWidth,
					r = Math.floor(e.pos_param / h),
					a = r * (this._curLineItemCount * this._curLineItemCount2),
					n = r * h;
				for (i = 0; i < this._curLineItemCount; i++) {
					if (
						(s =
							n +
							this._virtualItems[a + i].width +
							this._columnGap) > e.pos_param
					)
						return (e.pos_param = n), a + i;
					n = s;
				}
				return (e.pos_param = n), a + this._curLineItemCount - 1;
			}
			handleScroll(e) {
				if (!this._eventLocked) {
					if (
						...
						for (var i = 0; this.handleScroll1(e); )
							if (((e = !1), ++i > 20)) {
								console.log(
									'FairyGUI: list will never be <the> filled item renderer function always returns a different size.'
								);
								break;
							}
			...
			handleScroll1(i) {
				...
				if (((s = e.pos_param), a == this._firstIndex && !i)) return !1;
				...
				var o,
					...
					S =
						(this._scrollPane.viewWidth -
							this._columnGap * (this._curLineItemCount - 1)) /
						this._curLineItemCount;
				for (
					this.itemInfoVer++;
					u < this._realNumItems && (r || w < h);

				) {
					if (
						((null == (l = this._virtualItems[u]).obj || i) &&
							(null != this.itemProvider &&
								(null ==
									(b = this.itemProvider.runWith(
										u % this._numItems
									)) && (b = this._defaultItem),
						...
						if (g) {
							for (c = y; c >= n; c--)
								if (
									null != (_ = this._virtualItems[c]).obj &&
									_.updateFlag != this.itemInfoVer &&
									_.obj.resourceURL == b
								) {
									_.obj instanceof t.GButton &&
										(_.selected = _.obj.selected),
										(l.obj = _.obj),
										(_.obj = null),
										c == y && y--;
									break;
						...
						null != l.obj
							? this.setChildIndex(
									l.obj,
									g ? u - a : this.numChildren
							  )
							: ((l.obj = this._pool.getObject(b)),
							  g
									? this.addChildAt(l.obj, u - a)
									: this.addChild(l.obj)),
							l.obj instanceof t.GButton &&
								(l.obj.selected = l.selected),
							(o = !0);
					} else o = i;
					o &&
						(this._autoResizeItem &&
							(this._layout == t.ListLayoutType.SingleColumn ||
								this._columnCount > 0) &&
							l.obj.setSize(S, l.obj.height, !0),
						this.itemRenderer.runWith([u % this._numItems, l.obj]),
						u % this._curLineItemCount == 0 &&
							((v += Math.ceil(l.obj.height) - l.height),
							u == a &&
								n > a &&
								(C = Math.ceil(l.obj.height) - l.height)),
						...
						u % this._curLineItemCount ==
							this._curLineItemCount - 1 &&
							((m = 0), (w += l.height + this._lineGap)),
						u++;
				}
				for (d = 0; d < p; d++)
					(l = this._virtualItems[n + d]).updateFlag !=
						this.itemInfoVer &&
						null != l.obj &&
						(l.obj instanceof t.GButton &&
							(l.selected = l.obj.selected),
				...
				return (
					(0 == v && 0 == C) ||
						this._scrollPane.changeContentSizeOnScrolling(
							0,
							v,
							0,
							C
					...
					u > 0 &&
						this.numChildren > 0 &&
						this._container.y < 0 &&
						this.getChildAt(0).y > -this._container.y
				);
			}
			handleScroll2(i) {
				...
				var o,
					...
					S =
						(this._scrollPane.viewHeight -
							this._lineGap * (this._curLineItemCount - 1)) /
						this._curLineItemCount;
				for (
					this.itemInfoVer++;
					u < this._realNumItems && (r || m < h);
					...
					o &&
						(this._autoResizeItem &&
							(this._layout == t.ListLayoutType.SingleRow ||
								this._lineCount > 0) &&
							l.obj.setSize(l.obj.width, S, !0),
						this.itemRenderer.runWith([u % this._numItems, l.obj]),
						u % this._curLineItemCount == 0 &&
							((v += Math.ceil(l.obj.width) - l.width),
							u == a &&
								n > a &&
								(C = Math.ceil(l.obj.width) - l.width)),
						(l.width = Math.ceil(l.obj.width)),
						(l.height = Math.ceil(l.obj.height))),
						(l.updateFlag = this.itemInfoVer),
						l.obj.setXY(m, w),
						u == a && (h += l.width),
						(w += l.height + this._lineGap),
						u % this._curLineItemCount ==
							this._curLineItemCount - 1 &&
							((w = 0), (m += l.width + this._columnGap)),
						u++;
				}
				for (d = 0; d < p; d++)
					(l = this._virtualItems[n + d]).updateFlag !=
				...
				return (
					...
					u > 0 &&
						this.numChildren > 0 &&
						this._container.x < 0 &&
						this.getChildAt(0).x > -this._container.x
				);
			}
			handleScroll3(i) {
				var s = this._scrollPane.scrollingPosX;
				...
				if (((s = e.pos_param), h != this._firstIndex || i)) {
					...
					var a,
						...
						_,
						d = r,
						c = this._virtualItems.length,
						u = this._curLineItemCount * this._curLineItemCount2,
						g = h % this._curLineItemCount,
						p = this.viewWidth,
						f = Math.floor(h / u) * u,
						y = f + 2 * u,
						m = this._defaultItem,
						...
						v =
							(this._scrollPane.viewHeight -
								this._lineGap * (this._curLineItemCount2 - 1)) /
							this._curLineItemCount2;
					for (this.itemInfoVer++, n = f; n < y; n++)
						if (!(n >= this._realNumItems)) {
							if (((_ = n % this._curLineItemCount), n - f < u)) {
								if (_ < g) continue;
							} else if (_ > g) continue;
							(o = this._virtualItems[n]).updateFlag =
								this.itemInfoVer;
						}
					var C = null,
						b = 0;
								...
								-1 == b && (b = this.getChildIndex(C) + 1),
									null == o.obj
										? (null != this.itemProvider &&
												(null ==
													(m =
														this.itemProvider.runWith(
															n % this._numItems
														)) &&
													(m = this._defaultItem),
												(m =
													t.UIPackage.normalizeURL(
														m
													))),
										  (o.obj = this._pool.getObject(m)),
										  this.addChildAt(o.obj, b))
										: (b = this.setChildIndexBefore(
												o.obj,
												b
										  )),
									b++,
									o.obj instanceof t.GButton &&
										(o.obj.selected = o.selected),
									(a = !0);
							...
							a &&
								(this._autoResizeItem &&
									...
									this._curLineItemCount2 == this._lineCount
										...
										: this._curLineItemCount ==
										  this._columnCount
										? o.obj.setSize(w, o.obj.height, !0)
										: this._curLineItemCount2 ==
												this._lineCount &&
										  o.obj.setSize(o.obj.width, v, !0)),
								this.itemRenderer.runWith([
									n % this._numItems,
									o.obj
								]),
					...
					for (n = f; n < y; n++)
						n >= this._realNumItems ||
							((o = this._virtualItems[n]).updateFlag ==
								this.itemInfoVer && o.obj.setXY(x, I),
							o.height > T && (T = o.height),
							n % this._curLineItemCount ==
							this._curLineItemCount - 1
								? ((x = S),
								  (I += T + this._lineGap),
								  (T = 0),
								  n == f + u - 1 && ((x = S += p), (I = 0)))
								: (x += o.width + this._columnGap));
					for (n = d; n < c; n++)
						(o = this._virtualItems[n]).updateFlag !=
							this.itemInfoVer &&
							null != o.obj &&
							(o.obj instanceof t.GButton &&
								(o.selected = o.obj.selected),
			...
			handleArchOrder1() {
				if (this.childrenRenderOrder == t.ChildrenRenderOrder.Arch) {
					for (
						var e = this._scrollPane.posY + this.viewHeight / 2,
						...
						var n = this.getChildAt(a);
						(this.foldInvisibleItems && !n.visible) ||
							((s = Math.abs(e - n.y - n.height / 2)) < i &&
								((i = s), (h = a)));
					}
					this.apexIndex = h;
				}
			...
			handleArchOrder2() {
				if (this.childrenRenderOrder == t.ChildrenRenderOrder.Arch) {
					for (
						var e = this._scrollPane.posX + this.viewWidth / 2,
							i = Number.POSITIVE_INFINITY,
							s = 0,
							h = 0,
							r = this.numChildren,
			...
			handleAlign(t, e) {
				var i = 0,
					s = 0;
				e < this.viewHeight &&
					('middle' == this._verticalAlign
						? (s = Math.floor((this.viewHeight - e) / 2))
						: 'bottom' == this._verticalAlign &&
						  (s = this.viewHeight - e)),
					t < this.viewWidth &&
						('center' == this._align
							? (i = Math.floor((this.viewWidth - t) / 2))
							: 'right' == this._align &&
							  (i = this.viewWidth - t)),
					(i == this._alignOffset.x && s == this._alignOffset.y) ||
						(this._alignOffset.setTo(i, s),
						null != this._scrollPane
			...
			updateBounds() {
				if (!this._virtual) {
					...
					if (this._layout == t.ListLayoutType.SingleColumn) {
						for (e = 0; e < u; e++)
							(i = this.getChildAt(e)),
								(this.foldInvisibleItems && !i.visible) ||
									(0 != n && (n += this._lineGap),
									(i.y = n),
									this._autoResizeItem &&
										i.setSize(g, i.height, !0),
						...
						if (
							...
							this._autoResizeItem &&
							this._scrollPane &&
							this._scrollPane._displayInDemand &&
							this._scrollPane.vtScrollBar
						)
							for (
								g += this._scrollPane.vtScrollBar.width, e = 0;
								e < u;
								e++
							)
								(i = this.getChildAt(e)),
						...
						for (e = 0; e < u; e++)
							(i = this.getChildAt(e)),
								(this.foldInvisibleItems && !i.visible) ||
									(0 != a && (a += this._columnGap),
									(i.x = a),
									this._autoResizeItem &&
										i.setSize(i.width, p, !0),
									(a += Math.ceil(i.width)),
						...
						if (
							...
							this._scrollPane &&
							this._scrollPane._displayInDemand &&
							this._scrollPane.hzScrollBar
						)
							for (
								p += this._scrollPane.hzScrollBar.height, e = 0;
								e < u;
								e++
							)
								(i = this.getChildAt(e)),
								...
								(i = this.getChildAt(e)),
									(this.foldInvisibleItems && !i.visible) ||
										...
										((0 != this._lineCount &&
											...
											((n = 0),
											(a +=
												Math.ceil(o) + this._columnGap),
											(o = 0),
											(_ = 0)),
										i.setXY(a, n),
										(n += Math.ceil(i.height)) > l &&
											(l = n),
										i.width > o && (o = i.width),
										_++);
						...
						if (
							(this._autoResizeItem &&
								...
								(m = Math.floor(
									(p -
										(this._lineCount - 1) * this._lineGap) /
										this._lineCount
								)),
			...
			setup_beforeAdd(e, i) {
				...
				super.setup_beforeAdd(e, i),
					...
					(s = e.readByte()),
					(this._align =
						0 == s ? 'left' : 1 == s ? 'center' : 'right'),
					(s = e.readByte()),
					(this._verticalAlign =
						0 == s ? 'top' : 1 == s ? 'middle' : 'bottom'),
				...
				e.readBool() && e.skip(8),
					e.version >= 2 &&
						((this.scrollItemToViewOnClick = e.readBool()),
			...
			readItems(t) {
				...
				for (e = t.getInt16(), i = 0; i < e; i++)
					if (
						...
						null != r && (this.addChild(r), this.setupItem(t, r)),
							(t.pos = s);
					} else t.pos = s;
			}
			setupItem(e, i) {
				var s, h, r;
				if (
					(null != (s = e.readS()) && (i.text = s),
					null != (s = e.readS()) &&
						i instanceof t.GButton &&
						(i.selectedTitle = s),
					...
					for (h = e.getInt16(), r = 0; r < h; r++) {
						...
						(s = e.readS()), null != a && (a.selectedPageId = s);
					}
					if (e.version >= 2)
						for (h = e.getInt16(), r = 0; r < h; r++) {
							var n = e.readS(),
			...
			setup_afterAdd(t, e) {
				...
				-1 != i &&
					(this._selectionController =
						this._parent.getControllerAt(i));
			}
		}
		t.GList = e;
		class i {
		...
		t.GObjectPool = class {
			...
			getObject(e) {
				...
				return null != i && i.length > 0
					? (this._count--, i.shift())
					: t.UIPackage.createObjectFromURL(e);
			}
			returnObject(t) {
				var e = t.resourceURL;
				if (e) {
					var i = this._pool[e];
					null == i && ((i = []), (this._pool[e] = i)),
						this._count++,
						i.push(t);
				}
			}
	...
	(function (t) {
		class e extends t.GObject {
			...
			dispose() {
				null == this._contentItem &&
					null != this._content.texture &&
			...
			set url(t) {
				this._url != t &&
					((this._url = t), this.loadContent(), this.updateGear(7));
			}
			get icon() {
				return this._url;
			}
			...
			set shrinkOnly(t) {
				this._shrinkOnly != t &&
					((this._shrinkOnly = t), this.updateLayout());
			}
			get autoSize() {
				return this._autoSize;
			}
			set autoSize(t) {
				this._autoSize != t &&
					((this._autoSize = t), this.updateLayout());
			}
			get playing() {
			...
			set playing(t) {
				this._content.playing != t &&
					((this._content.playing = t), this.updateGear(5));
			}
			get frame() {
			...
			set frame(t) {
				this._content.frame != t &&
					((this._content.frame = t), this.updateGear(5));
			}
			get color() {
				return this._content.color;
			}
			set color(t) {
				this._content.color != t &&
					((this._content.color = t), this.updateGear(4));
			}
			get showErrorSign() {
			...
			loadContent() {
				this.clearContent(),
					this._url &&
						(t.ToolSet.startsWith(this._url, 'ui://')
			...
			loadFromPackage(e) {
				if (
					...
					if (
						...
						(this._contentItem =
							this._contentItem.getHighResolution()),
						this._contentItem.load(),
						this._autoSize &&
							this.setSize(
								this._contentSourceWidth,
								this._contentSourceHeight
							),
						this._contentItem.type == t.PackageItemType.Image)
					)
						null == this._contentItem.texture
							? this.setErrorState()
							: ((this._content.texture =
									this._contentItem.texture),
							  (this._content.scale9Grid =
									this._contentItem.scale9Grid),
							  (this._content.scaleByTile =
									this._contentItem.scaleByTile),
							  (this._content.tileGridIndice =
									this._contentItem.tileGridIndice),
							  (this._contentSourceWidth =
									this._contentItem.width),
							  (this._contentSourceHeight =
									this._contentItem.height),
							  this.updateLayout());
					else if (
						this._contentItem.type == t.PackageItemType.MovieClip
					)
						(this._contentSourceWidth = this._contentItem.width),
							(this._contentSourceHeight =
								this._contentItem.height),
							(this._content.interval =
								this._contentItem.interval),
							(this._content.swing = this._contentItem.swing),
							(this._content.repeatDelay =
								this._contentItem.repeatDelay),
							(this._content.frames = this._contentItem.frames),
							this.updateLayout();
					else if (
						this._contentItem.type == t.PackageItemType.Component
					) {
						var i = t.UIPackage.createObjectFromURL(e);
						i
							? i instanceof t.GComponent
								? ((this._content2 = i.asCom),
								  this._displayObject.addChild(
										this._content2.displayObject
								  ),
								  this.updateLayout())
								: (i.dispose(), this.setErrorState())
							: this.setErrorState();
			...
			loadExternal() {
				t.AssetProxy.inst.load(
					this._url,
					Laya.Handler.create(this, this.__getResCompleted),
					null,
					Laya.Loader.IMAGE
				);
			}
			...
			onExternalLoadSuccess(t) {
				(this._content.texture = t),
					...
					(this._contentSourceWidth = t.width),
					(this._contentSourceHeight = t.height),
					this.updateLayout();
			}
			...
			setErrorState() {
				this._showErrorSign &&
					(null == this._errorSign &&
						null != t.UIConfig.loaderErrorSign &&
						(this._errorSign = e._errorSignPool.getObject(
							t.UIConfig.loaderErrorSign
						)),
					null != this._errorSign &&
						(this._errorSign.setSize(this.width, this.height),
						this._displayObject.addChild(
							this._errorSign.displayObject
						)));
			}
			clearErrorState() {
				null != this._errorSign &&
					(this._displayObject.removeChild(
						this._errorSign.displayObject
					),
				...
				if (
					...
					if (
						...
						this._autoSize &&
							...
							0 == this._contentWidth &&
								(this._contentWidth = 50),
							0 == this._contentHeight &&
						...
						var e,
							...
							h = 1;
						this._fill != t.LoaderFillType.None &&
							((s = this.width / this._contentSourceWidth),
							(h = this.height / this._contentSourceHeight),
							(1 == s && 1 == h) ||
								(this._fill == t.LoaderFillType.ScaleMatchHeight
									? (s = h)
									: this._fill ==
									  t.LoaderFillType.ScaleMatchWidth
									? (h = s)
									: this._fill == t.LoaderFillType.Scale
									? s > h
										? (s = h)
										: (h = s)
									: this._fill ==
											t.LoaderFillType.ScaleNoBorder &&
									  (s > h ? (h = s) : (s = h)),
								this._shrinkOnly &&
									(s > 1 && (s = 1), h > 1 && (h = 1)),
								(this._contentWidth =
									this._contentSourceWidth * s),
								(this._contentHeight =
									this._contentSourceHeight * h))),
							null != this._content2
								? this._content2.setScale(s, h)
								: this._content.size(
										this._contentWidth,
										this._contentHeight
								  ),
							...
							(i =
								'middle' == this._valign
									...
									: 0),
							null != this._content2
								? this._content2.setXY(e, i)
								: this._content.pos(e, i);
					}
				else
					this._autoSize &&
						((this._updatingLayout = !0),
			...
			clearContent() {
				this.clearErrorState(),
					...
					null != this._content2 &&
						(this._content2.dispose(), (this._content2 = null)),
			...
			setup_beforeAdd(t, e) {
				...
				super.setup_beforeAdd(t, e),
					...
					(i = t.readByte()),
					(this._align =
						0 == i ? 'left' : 1 == i ? 'center' : 'right'),
					(i = t.readByte()),
					(this._valign =
						0 == i ? 'top' : 1 == i ? 'middle' : 'bottom'),
	...
	(function (t) {
		t.GMovieClip = class extends t.GObject {
			...
			set playing(t) {
				this._movieClip.playing != t &&
					((this._movieClip.playing = t), this.updateGear(5));
			}
			get frame() {
				return this._movieClip.frame;
			}
			set frame(t) {
				this._movieClip.frame != t &&
					((this._movieClip.frame = t), this.updateGear(5));
			}
			get timeScale() {
			...
			setPlaySettings(t = 0, e = -1, i = 0, s = -1, h = null) {
	...
	(function (t) {
		t.GProgressBar = class extends t.GComponent {
			...
			tweenValue(e, i) {
				...
				return (
					null != h ? ((s = h.value.x), h.kill()) : (s = this._value),
					(this._value = e),
					t.GTween.to(s, this._value, i)
						.setTarget(this, this.update)
						.setEase(t.EaseType.Linear)
				);
			}
			update(e) {
				var i = t.ToolSet.clamp01(
				...
				if (this._titleObject)
					switch (this._titleType) {
						...
						case t.ProgressTitleType.ValueAndMax:
							this._titleObject.text =
								Math.round(e) + '/' + Math.round(this._max);
							break;
				...
				this._reverse
					? (this._barObjectH &&
							(this._barObjectH instanceof t.GImage &&
							this._barObjectH.fillMethod != t.FillMethod.None
								? (this._barObjectH.fillAmount = 1 - i)
								: ((this._barObjectH.width = Math.round(s * i)),
								  (this._barObjectH.x =
										this._barStartX +
										(s - this._barObjectH.width)))),
					  this._barObjectV &&
							(this._barObjectV instanceof t.GImage &&
							this._barObjectV.fillMethod != t.FillMethod.None
								? (this._barObjectV.fillAmount = 1 - i)
								: ((this._barObjectV.height = Math.round(
										h * i
								  )),
								  (this._barObjectV.y =
										this._barStartY +
										(h - this._barObjectV.height)))))
					: (this._barObjectH &&
							(this._barObjectH instanceof t.GImage &&
							this._barObjectH.fillMethod != t.FillMethod.None
								? (this._barObjectH.fillAmount = i)
								: (this._barObjectH.width = Math.round(s * i))),
					  this._barObjectV &&
							(this._barObjectV instanceof t.GImage &&
							this._barObjectV.fillMethod != t.FillMethod.None
								? (this._barObjectV.fillAmount = i)
								: (this._barObjectV.height = Math.round(
										h * i
								  )))),
					this._aniObject instanceof t.GMovieClip &&
						(this._aniObject.frame = Math.round(100 * i));
			}
			constructExtension(t) {
				t.seek(0, 6),
					...
					this._barObjectH &&
						...
						(this._barMaxWidthDelta =
							this.width - this._barMaxWidth),
						(this._barStartX = this._barObjectH.x)),
					this._barObjectV &&
						((this._barMaxHeight = this._barObjectV.height),
						(this._barMaxHeightDelta =
							this.height - this._barMaxHeight),
			...
			handleSizeChanged() {
				super.handleSizeChanged(),
					this._barObjectH &&
						(this._barMaxWidth =
							this.width - this._barMaxWidthDelta),
					this._barObjectV &&
						(this._barMaxHeight =
							this.height - this._barMaxHeightDelta),
					this._underConstruct || this.update(this._value);
			}
			setup_afterAdd(t, e) {
				super.setup_afterAdd(t, e),
					t.seek(e, 6) && t.readByte() == this.packageItem.objectType
						? ((this._value = t.getInt32()),
		...
		t.GRichTextField = class extends t.GTextField {
			...
			set text(e) {
				...
				try {
					...
					if (
						(this._ubbEnabled
							? (this._div.innerHTML = t.ToolSet.parseUBB(i))
							: (this._div.innerHTML = i),
						this._widthAutoSize || this._heightAutoSize)
					)
						this._widthAutoSize
							? (s = this._div.contextWidth) > 0 && (s += 8)
							: (s = this._width),
							(h = this._heightAutoSize
								? this._div.contextHeight
								: this._height),
							(this._updatingSize = !0),
							this.setSize(s, h),
							(this._updatingSize = !1);
			...
			set color(t) {
				this._color != t &&
					((this._color = t),
					(this._div.style.color = t),
					this._gearColor.controller &&
	...
	(function (t) {
		class e extends t.GComponent {
			constructor() {
				super(),
					null == e._inst && (e._inst = this),
					(this.opaque = !1),
					(this._popupStack = []),
					(this._justClosedPopups = []),
					this.displayObject.once(
						Laya.Event.DISPLAY,
						this,
						this.__addedToStage
					);
			...
			static get inst() {
				return null == e._inst && new e(), e._inst;
			}
			showWindow(t) {
				this.addChild(t),
					t.requestFocus(),
					t.x > this.width
						? (t.x = this.width - t.width)
						: t.x + t.width < 0 && (t.x = 0),
					t.y > this.height
						? (t.y = this.height - t.height)
						: t.y + t.height < 0 && (t.y = 0),
			...
			bringToFront(e) {
				...
				for (
					i =
						null == this._modalLayer.parent || e.modal
							? s - 1
							: this.getChildIndex(this._modalLayer) - 1;
					i >= 0;
					i--
				) {
			...
			showModalWait(e = null) {
				null != t.UIConfig.globalModalWaiting &&
					(null == this._modalWaitPane &&
						(this._modalWaitPane = t.UIPackage.createObjectFromURL(
							t.UIConfig.globalModalWaiting
						)),
			...
			closeModalWait() {
				null != this._modalWaitPane &&
					null != this._modalWaitPane.parent &&
					this.removeChild(this._modalWaitPane);
			}
			closeAllExceptModals() {
				for (
					var e = this._children.slice(), i = e.length, s = 0;
					s < i;
					s++
				) {
					var h = e[s];
			...
			showPopup(t, e = null, i = null) {
				if (this._popupStack.length > 0) {
					var s = this._popupStack.indexOf(t);
					if (-1 != s)
						for (var h = this._popupStack.length - 1; h >= s; h--)
							this.removeChild(this._popupStack.pop());
				}
				if ((this._popupStack.push(t), null != e))
					for (var r = e; null != r; ) {
						if (r.parent == this) {
							t.sortingOrder < r.sortingOrder &&
								(t.sortingOrder = r.sortingOrder);
							break;
						}
						r = r.parent;
				...
				var n,
					...
					_ = 0;
				e
					? ((a = e.localToGlobal()), (l = e.width), (_ = e.height))
					: (a = this.globalToLocal(
							Laya.stage.mouseX,
							Laya.stage.mouseY
					  )),
					(n = a.x) + t.width > this.width && (n = n + l - t.width),
					(o = a.y + _),
					((null == i && o + t.height > this.height) || 0 == i) &&
						(o = a.y - t.height - 1) < 0 &&
						((o = 0), (n += l / 2)),
					(t.x = n),
					(t.y = o);
			}
			togglePopup(t, e = null, i = null) {
				-1 == this._justClosedPopups.indexOf(t) &&
					this.showPopup(t, e, i);
			}
			hidePopup(t = null) {
				if (null != t) {
			...
			closePopup(e) {
				null != e.parent &&
					(e instanceof t.Window ? e.hide() : this.removeChild(e));
			}
			showTooltips(e) {
				if (null == this._defaultTooltipWin) {
					...
					if (!i)
						return void Laya.Log.print(
							'UIConfig.tooltipsWin not defined'
						);
					this._defaultTooltipWin =
						t.UIPackage.createObjectFromURL(i);
				}
				(this._defaultTooltipWin.text = e),
					this.showTooltipsWin(this._defaultTooltipWin);
			}
			showTooltipsWin(t, e = null) {
				this.hideTooltips(), (this._tooltipWin = t);
				var i = 0,
					s = 0;
				null == e
					? ((i = Laya.stage.mouseX + 10),
					  (s = Laya.stage.mouseY + 20))
					: ((i = e.x), (s = e.y));
				var h = this.globalToLocal(i, s);
				(i = h.x),
					(s = h.y),
					i + this._tooltipWin.width > this.width &&
						(i = i - this._tooltipWin.width - 1) < 0 &&
						(i = 10),
					s + this._tooltipWin.height > this.height &&
						((s = s - this._tooltipWin.height - 1),
						i - this._tooltipWin.width - 1 > 0 &&
							(i = i - this._tooltipWin.width - 1),
						s < 0 && (s = 10)),
			...
			hideTooltips() {
				null != this._tooltipWin &&
					(this._tooltipWin.parent &&
						this.removeChild(this._tooltipWin),
					(this._tooltipWin = null));
			}
			getObjectUnderPoint(t, e) {
				return null;
			}
			get focus() {
				return (
					this._focusedObject &&
						!this._focusedObject.onStage &&
						(this._focusedObject = null),
					this._focusedObject
				);
			}
			set focus(t) {
				if (t && (!t.focusable || !t.onStage))
					throw 'invalid this.focus target';
				this.setFocus(t);
			}
			setFocus(e) {
				this._focusedObject != e &&
					((this._focusedObject = e),
					this.displayObject.event(t.Events.FOCUS_CHANGED));
			}
			get volumeScale() {
			...
			playOneShotSound(e, i = 1) {
				t.ToolSet.startsWith(e, 'ui://') ||
			...
			adjustModalLayer() {
				...
				null != this._modalWaitPane &&
					null != this._modalWaitPane.parent &&
					this.setChildIndex(this._modalWaitPane, e - 1);
				for (var i = e - 1; i >= 0; i--) {
					var s = this.getChildAt(i);
					if (s instanceof t.Window && s.modal)
						return void (null == this._modalLayer.parent
							? this.addChildAt(this._modalLayer, i)
							: this.setChildIndexBefore(this._modalLayer, i));
				}
				null != this._modalLayer.parent &&
			...
			__addedToStage() {
				Laya.stage.on(
					...
					this._modalLayer.drawRect(
						0,
						null,
						t.UIConfig.modalLayerColor
					),
					this._modalLayer.addRelation(this, t.RelationType.Size),
					this.displayObject.stage.on(
						Laya.Event.RESIZE,
						this,
						this.__winResize
					),
			...
			checkPopups(t) {
				if (
					...
					for (
						var e = t;
						e != this.displayObject.stage && null != e;
						...
						if (e.$owner) {
							...
							if (-1 != i) {
								for (
									var s = this._popupStack.length - 1;
									s > i;
									s--
								) {
	...
	(function (t) {
		class e extends t.GComponent {
			...
			setDisplayPerc(t) {
				this._vertical
					? (this._fixedGripSize ||
							(this._grip.height = Math.floor(
								t * this._bar.height
							)),
					  (this._grip.y =
							this._bar.y +
							(this._bar.height - this._grip.height) *
								this._scrollPerc))
					: (this._fixedGripSize ||
							(this._grip.width = Math.floor(
								t * this._bar.width
							)),
					  (this._grip.x =
							this._bar.x +
							(this._bar.width - this._grip.width) *
								this._scrollPerc)),
			...
			get minSize() {
				return this._vertical
					? (null != this._arrowButton1
							? this._arrowButton1.height
							: 0) +
							(null != this._arrowButton2
								? this._arrowButton2.height
								: 0)
					: (null != this._arrowButton1
							? this._arrowButton1.width
							: 0) +
							(null != this._arrowButton2
								? this._arrowButton2.width
								: 0);
			}
			get gripDragging() {
				...
				t.seek(0, 6),
					...
					this._grip
						? ((this._bar = this.getChild('bar')),
						  this._bar
								? ((this._arrowButton1 =
										this.getChild('arrow1')),
								  (this._arrowButton2 =
										this.getChild('arrow2')),
								  this._grip.on(
										Laya.Event.MOUSE_DOWN,
										this,
										this.__gripMouseDown
								  ),
								  this._arrowButton1 &&
			...
			__gripMouseMove() {
				var t = this.globalToLocal(
					Laya.stage.mouseX,
					Laya.stage.mouseY,
					e.sScrollbarHelperPoint
				);
				if (this._vertical) {
			...
			__barMouseDown(t) {
				var i = this._grip.globalToLocal(
					Laya.stage.mouseX,
					Laya.stage.mouseY,
					e.sScrollbarHelperPoint
				);
		...
		class e extends t.GComponent {
			...
			set wholeNumbers(t) {
				this._wholeNumbers != t &&
					((this._wholeNumbers = t), this.update());
			}
			get min() {
				return this._min;
			}
			...
			updateWithPercent(e, i) {
				if (((e = t.ToolSet.clamp01(e)), i)) {
					var s = t.ToolSet.clamp(
						this._min + (this._max - this._min) * e,
						this._min,
						this._max
					);
					this._wholeNumbers &&
						((s = Math.round(s)),
						(e = t.ToolSet.clamp01(
							(s - this._min) / (this._max - this._min)
						))),
						s != this._value &&
							((this._value = s),
							t.Events.dispatch(
				...
				this._reverse
					? (this._barObjectH &&
							((this._barObjectH.width = Math.round(h * e)),
							(this._barObjectH.x =
								this._barStartX +
								(h - this._barObjectH.width))),
					  this._barObjectV &&
							((this._barObjectV.height = Math.round(r * e)),
							(this._barObjectV.y =
								this._barStartY +
								(r - this._barObjectV.height))))
					: (this._barObjectH &&
							(this._barObjectH.width = Math.round(h * e)),
					  this._barObjectV &&
							(this._barObjectV.height = Math.round(r * e)));
			...
			__gripMouseDown(e) {
				(this.canDrag = !0),
					e.stopPropagation(),
					(this._clickPos = this.globalToLocal(
						Laya.stage.mouseX,
						Laya.stage.mouseY
					)),
					(this._clickPercent = t.ToolSet.clamp01(
						(this._value - this._min) / (this._max - this._min)
					)),
					Laya.stage.on(
						Laya.Event.MOUSE_MOVE,
			...
			__gripMouseMove(t) {
				if (this.canDrag) {
					var i,
						s = this.globalToLocal(
							Laya.stage.mouseX,
							Laya.stage.mouseY,
							e.sSilderHelperPoint
						),
						h = s.x - this._clickPos.x,
						r = s.y - this._clickPos.y;
					this._reverse && ((h = -h), (r = -r)),
						(i = this._barObjectH
							? this._clickPercent + h / this._barMaxWidth
							: this._clickPercent + r / this._barMaxHeight),
			...
			__barMouseDown(i) {
				if (this.changeOnClick) {
					var s,
						h = this._gripObject.globalToLocal(
							i.stageX,
							i.stageY,
							e.sSilderHelperPoint
						),
		...
		t.GTextInput = class extends t.GTextField {
			...
			set promptText(e) {
				...
				(this._input.prompt = i),
					t.ToolSet.defaultUBBParser.lastColor &&
						(this._input.promptColor =
							t.ToolSet.defaultUBBParser.lastColor);
			}
			get promptText() {
				return this._prompt;
		...
		class e extends t.GList {
			...
			getSelectedNode() {
				return -1 != this.selectedIndex
					? this.getChildAt(this.selectedIndex)._treeNode
					: null;
			}
			getSelectedNodes(t) {
				t || (t = new Array()),
					(e.helperIntList.length = 0),
					super.getSelection(e.helperIntList);
				for (
					var i = e.helperIntList.length, s = new Array(), h = 0;
					h < i;
					h++
				) {
					var r = this.getChildAt(e.helperIntList[h])._treeNode;
					s.push(r);
				}
				return s;
			}
			selectNode(t, e) {
				for (var i = t.parent; null != i && i != this._rootNode; )
			...
			createCell(e) {
				...
				var s,
					h = i.getChild('indent');
				null != h && (h.width = (e.level - 1) * this._indent),
					(s = i.getController('expanded')) &&
						(s.on(
							t.Events.STATE_CHANGED,
							this,
							this.__expandedStateChanged
						),
						(s.selectedIndex = e.expanded ? 1 : 0)),
					(s = i.getController('leaf')) &&
						(s.selectedIndex = e.isFolder ? 0 : 1),
			...
			_afterInserted(t) {
				...
				this.addChildAt(t._cell, e),
					this.treeNodeRender &&
						this.treeNodeRender.runWith([t, t._cell]),
			...
			getInsertIndexForNode(t) {
				...
				null == e && (e = t.parent);
				for (
					var i = this.getChildIndex(e._cell) + 1,
						s = t.level,
						h = this.numChildren,
						r = i;
					r < h && !(this.getChildAt(r)._treeNode.level <= s);
					r++
				)
					i++;
				return i;
			...
			_afterExpanded(t) {
				if (t != this._rootNode) {
					if (
						(null != this.treeNodeWillExpand &&
							this.treeNodeWillExpand.runWith([t, !0]),
						null != t._cell)
					) {
						this.treeNodeRender &&
							this.treeNodeRender.runWith([t, t._cell]);
						...
						e && (e.selectedIndex = 1),
							t._cell.on(
								Laya.Event.MOUSE_DOWN,
								this,
								this.__cellMouseDown
							),
							null != t._cell.parent &&
								this.checkChildren(
									t,
									this.getChildIndex(t._cell)
								);
					}
			...
			_afterCollapsed(t) {
				if (t != this._rootNode) {
					if (
						(this.treeNodeWillExpand &&
							this.treeNodeWillExpand.runWith([t, !1]),
						null != t._cell)
					) {
						this.treeNodeRender &&
							this.treeNodeRender.runWith([t, t._cell]);
						var e = t._cell.getController('expanded');
						e && (e.selectedIndex = 0),
							null != t._cell.parent && this.hideFolderNode(t);
					}
				} else this.checkChildren(this._rootNode, 0);
			}
			_afterMoved(t) {
			...
			checkChildren(t, e) {
				for (var i = t.numChildren, s = 0; s < i; s++) {
					...
					null == h._cell && this.createCell(h),
						h._cell.parent || this.addChildAt(h._cell, e),
						h.isFolder &&
							h.expanded &&
							(e = this.checkChildren(h, e));
				}
				return e;
			}
			hideFolderNode(t) {
			...
			removeNode(t) {
				if (
					(null != t._cell &&
						(null != t._cell.parent && this.removeChild(t._cell),
	...
	((fgui || (fgui = {})).GTreeNode = class {
				...
				return (
					t._parent == this
						...
						: (t._parent && t._parent.removeChild(t),
						  ...
						  ((null != this._tree &&
								this == this._tree.rootNode) ||
								(null != this._cell &&
									null != this._cell.parent &&
									this._expanded)) &&
								this._tree._afterInserted(t)),
					t
				);
		...
		removeChildAt(t) {
			if (t >= 0 && t < this.numChildren) {
				...
				return (
					...
					(e._parent = null),
					null != this._tree &&
						(e._setTree(null), this._tree._afterRemoved(e)),
					e
				);
			}
			throw 'Invalid child index';
		}
		removeChildren(t = 0, e = -1) {
		...
		getNextSibling() {
			if (null == this._parent) return null;
			var t = this._parent._children.indexOf(this);
			return t < 0 || t >= this._parent._children.length - 1
				? null
				: this._parent._children[t + 1];
		}
		setChildIndex(t, e) {
			var i = this._children.indexOf(t);
			if (-1 == i) throw 'Not a child of this container';
			...
			e < 0 ? (e = 0) : e > s && (e = s),
				i != e &&
					(this._children.splice(i, 1),
					this._children.splice(e, 0, t),
					((null != this._tree && this == this._tree.rootNode) ||
						(null != this._cell &&
							null != this._cell.parent &&
							this._expanded)) &&
						this._tree._afterMoved(t));
		}
		swapChildren(t, e) {
			var i = this._children.indexOf(t),
				s = this._children.indexOf(e);
		...
		_setTree(t) {
			if (
				((this._tree = t),
				null != this._tree &&
					this._tree.treeNodeWillExpand &&
					this._expanded &&
					this._tree.treeNodeWillExpand.runWith([this, !0]),
				null != this._children)
			)
				for (var e = this._children.length, i = 0; i < e; i++) {
					var s = this._children[i];
	...
	(function (t) {
		t.PopupMenu = class {
			...
			addItemAt(t, e, i = null) {
				...
				return null != h && (h.selectedIndex = 0), s;
			}
			addSeperator() {
			...
			setItemVisible(t, e) {
				...
				i.visible != e &&
					((i.visible = e), this._list.setBoundsChangedFlag());
			}
			setItemGrayed(t, e) {
			...
			setItemCheckable(t, e) {
				var i = this._list
					.getChild(t)
					.asButton.getController('checked');
				null != i &&
					(e
						? 0 == i.selectedIndex && (i.selectedIndex = 1)
						: (i.selectedIndex = 0));
			}
			setItemChecked(t, e) {
				var i = this._list
			...
			show(e = null, i = null) {
				(null != e ? e.root : t.GRoot.inst).showPopup(
					this.contentPane,
					e instanceof t.GRoot ? null : e,
					i
				);
			}
			__clickItem(t) {
			...
			__clickItem2(e) {
				if (e instanceof t.GButton)
					if (e.grayed) this._list.selectedIndex = -1;
					else {
						...
						null != i &&
							...
							(1 == i.selectedIndex
								? (i.selectedIndex = 2)
								: (i.selectedIndex = 1)),
							this._contentPane.parent.hidePopup(
								this.contentPane
							),
		...
		t.RelationItem = class {
			...
			internalAdd(i, s) {
				if (i == t.RelationType.Size)
					return (
						this.internalAdd(t.RelationType.Width, s),
				...
				(h.percent = s),
					(h.type = i),
					(h.axis =
						i <= t.RelationType.Right_Right ||
						i == t.RelationType.Width ||
						(i >= t.RelationType.LeftExt_Left &&
							i <= t.RelationType.RightExt_Right)
							? 0
							: 1),
					this._defs.push(h),
					(s ||
						i == t.RelationType.Left_Center ||
						i == t.RelationType.Center_Center ||
						i == t.RelationType.Right_Center ||
						i == t.RelationType.Top_Middle ||
						i == t.RelationType.Middle_Middle ||
						i == t.RelationType.Bottom_Middle) &&
						(this._owner.pixelSnapping = !0);
			}
			remove(e) {
				if (e == t.RelationType.Size)
					return (
			...
			dispose() {
				null != this._target &&
					(this.releaseRefTarget(), (this._target = null));
			}
			get isEmpty() {
			...
			applyOnSelfResized(e, i, s) {
				...
				if (0 != h) {
					for (
						var r = this._owner.x, a = this._owner.y, n = 0;
						n < h;
						n++
					)
			...
			applyOnXYChanged(e, i, s) {
				...
				switch (e.type) {
					...
					case t.RelationType.LeftExt_Right:
						this._owner != this._target.parent
							? ((h = this._owner.xMin),
							  (this._owner.width = this._owner._rawWidth - i),
							  (this._owner.xMin = h + i))
							: (this._owner.width = this._owner._rawWidth - i);
						break;
			...
			applyOnSizeChanged(e) {
				...
				switch (
					(0 == e.axis
						? (this._target != this._owner.parent &&
								((h = this._target.x),
								this._target.pivotAsAnchor &&
									(r = this._target.pivotX)),
						  e.percent
								? 0 != this._targetWidth &&
								  (a = this._target._width / this._targetWidth)
								: (a = this._target._width - this._targetWidth))
						: (this._target != this._owner.parent &&
								((h = this._target.y),
								this._target.pivotAsAnchor &&
									(r = this._target.pivotY)),
						  e.percent
								? 0 != this._targetHeight &&
								  (a =
										this._target._height /
										this._targetHeight)
								: (a =
										this._target._height -
										this._targetHeight)),
					...
					case t.RelationType.Left_Left:
						e.percent
							? (this._owner.xMin =
									h + (this._owner.xMin - h) * a)
							: 0 != r && (this._owner.x += a * -r);
						break;
					case t.RelationType.Left_Center:
						e.percent
							? (this._owner.xMin =
									h + (this._owner.xMin - h) * a)
							: (this._owner.x += a * (0.5 - r));
						break;
					case t.RelationType.Left_Right:
						e.percent
							? (this._owner.xMin =
					...
					case t.RelationType.Top_Top:
						e.percent
							? (this._owner.yMin =
									h + (this._owner.yMin - h) * a)
							: 0 != r && (this._owner.y += a * -r);
						break;
					case t.RelationType.Top_Middle:
						e.percent
							? (this._owner.yMin =
									h + (this._owner.yMin - h) * a)
							: (this._owner.y += a * (0.5 - r));
						break;
					case t.RelationType.Top_Bottom:
						e.percent
							? (this._owner.yMin =
					...
					case t.RelationType.Width:
						(i =
							this._owner._underConstruct &&
							this._owner == this._target.parent
								? this._owner.sourceWidth -
								  this._target.initWidth
								: this._owner._rawWidth - this._targetWidth),
							e.percent && (i *= a),
							this._target == this._owner.parent
								? this._owner.pivotAsAnchor
									? ((s = this._owner.xMin),
									  this._owner.setSize(
											this._target._width + i,
											this._owner._rawHeight,
											!0
									  ),
									  (this._owner.xMin = s))
								...
								: (this._owner.width = this._target._width + i);
						break;
					case t.RelationType.Height:
						(i =
							this._owner._underConstruct &&
							this._owner == this._target.parent
								? this._owner.sourceHeight -
								  this._target.initHeight
								: this._owner._rawHeight - this._targetHeight),
							e.percent && (i *= a),
							this._target == this._owner.parent
								? this._owner.pivotAsAnchor
									? ((s = this._owner.yMin),
					...
					case t.RelationType.RightExt_Left:
						(s = this._owner.xMin),
							(i = e.percent
								? h +
								  (s + this._owner._rawWidth - h) * a -
								  (s + this._owner._rawWidth)
								: a * -r),
							(this._owner.width = this._owner._rawWidth + i),
							(this._owner.xMin = s);
						break;
							...
							e.percent
								? this._owner == this._target.parent
									? this._owner._underConstruct
										...
										: (this._owner.width =
												h +
												(this._owner._rawWidth - h) * a)
									: ((i =
											h +
											(s + this._owner._rawWidth - h) *
												a -
											(s + this._owner._rawWidth)),
									  (this._owner.width =
											this._owner._rawWidth + i),
									  (this._owner.xMin = s))
								: this._owner == this._target.parent
								? this._owner._underConstruct
									? (this._owner.width =
					...
					case t.RelationType.BottomExt_Top:
						(s = this._owner.yMin),
							(i = e.percent
								? h +
								  (s + this._owner._rawHeight - h) * a -
								  (s + this._owner._rawHeight)
								: a * -r),
							(this._owner.height = this._owner._rawHeight + i),
							(this._owner.yMin = s);
						break;
							...
							e.percent
								? this._owner == this._target.parent
									? this._owner._underConstruct
										...
										: (this._owner.height =
												h +
												(this._owner._rawHeight - h) *
													a)
									: ((i =
											h +
											(s + this._owner._rawHeight - h) *
												a -
											(s + this._owner._rawHeight)),
									  (this._owner.height =
											this._owner._rawHeight + i),
									  (this._owner.yMin = s))
								: this._owner == this._target.parent
								? this._owner._underConstruct
									? (this._owner.height =
			...
			addRefTarget() {
				this._target != this._owner.parent &&
					this._target.on(
						t.Events.XY_CHANGED,
						this,
						this.__targetXYChanged
					),
					this._target.on(
						t.Events.SIZE_CHANGED,
						this,
						this.__targetSizeChanged
					),
					this._target.on(
						t.Events.SIZE_DELAY_CHANGE,
						this,
						this.__targetSizeWillChange
					),
			...
			releaseRefTarget() {
				null != this._target.displayObject &&
					(this._target.off(
						t.Events.XY_CHANGED,
						this,
						this.__targetXYChanged
			...
			__targetXYChanged() {
				if (
					...
					(null != this._owner.group && this._owner.group._updating)
				)
					return (
						(this._targetX = this._target.x),
				...
				for (
					var t = this._owner.x,
						e = this._owner.y,
						i = this._target.x - this._targetX,
						s = this._target.y - this._targetY,
						h = this._defs.length,
						r = 0;
					r < h;
					r++
				...
				if (
					((this._targetX = this._target.x),
					(this._targetY = this._target.y),
					(t != this._owner.x || e != this._owner.y) &&
						((t = this._owner.x - t),
						(e = this._owner.y - e),
					...
					h = this._owner.parent._transitions.length;
					for (var a = 0; a < h; a++)
						this._owner.parent._transitions[a].updateFromRelations(
							this._owner.id,
							t,
							e
						);
			...
			__targetSizeChanged() {
				if (
					(this._owner.relations.sizeDirty &&
				...
				(i == this._owner._rawWidth && s == this._owner._rawHeight) ||
		...
		t.Relations = class {
			...
			remove(t, e = 0) {
				for (var i = this._items.length, s = 0; s < i; ) {
					...
					h.target == t
						? (h.remove(e),
						  h.isEmpty
								? (h.dispose(), this._items.splice(s, 1), i--)
								: s++)
						: s++;
				}
			}
			...
			clearFor(t) {
				for (var e = this._items.length, i = 0; i < e; ) {
					var s = this._items[i];
					s.target == t
						? (s.dispose(), this._items.splice(i, 1), e--)
						: i++;
				}
			}
			clearAll() {
				...
				for (var s, h = e.readByte(), r = 0; r < h; r++) {
					...
					s =
						-1 == a
							? this._owner.parent
							: i
							? this._owner.getChildAt(a)
							: this._owner.parent.getChildAt(a);
					var n = new t.RelationItem(this._owner);
	...
	(function (t) {
		class e {
			constructor(e) {
				(this._owner = e),
					...
					(this._decelerationRate =
						t.UIConfig.defaultScrollDecelerationRate),
					this._owner.on(
						Laya.Event.MOUSE_DOWN,
						this,
						this.__mouseDown
			...
			setup(e) {
				...
				var i = e.readByte(),
					s = e.getInt32();
				e.readBool() &&
					((this._scrollBarMargin.top = e.getInt32()),
				...
				var h = e.readS(),
					...
					n = e.readS();
				if (
					((this._displayOnLeft = 0 != (1 & s)),
					(this._snapToItem = 0 != (2 & s)),
					(this._displayInDemand = 0 != (4 & s)),
					(this._pageMode = 0 != (8 & s)),
					(this._touchEffect =
						!!(16 & s) ||
						(!(32 & s) && t.UIConfig.defaultScrollTouchEffect)),
					(this._bouncebackEffect =
						!!(64 & s) ||
						(!(128 & s) && t.UIConfig.defaultScrollBounceEffect)),
					(this._inertiaDisabled = 0 != (256 & s)),
					0 == (512 & s) &&
						(this._maskContainer.scrollRect = new Laya.Rectangle()),
					(this._floating = 0 != (1024 & s)),
					i == t.ScrollBarDisplayType.Default &&
						(i = t.UIConfig.defaultScrollBarDisplay),
					i != t.ScrollBarDisplayType.Hidden)
				) {
					if (
						this._scrollType == t.ScrollType.Both ||
						this._scrollType == t.ScrollType.Vertical
					) {
						var o = h || t.UIConfig.verticalScrollBar;
						if (o) {
							if (
								((this._vtScrollBar =
									t.UIPackage.createObjectFromURL(o)),
								!this._vtScrollBar)
							)
								throw 'cannot create scrollbar from ' + o;
							this._vtScrollBar.setScrollPane(this, !0),
								this._owner.displayObject.addChild(
									this._vtScrollBar.displayObject
								);
						}
					}
					if (
						(this._scrollType == t.ScrollType.Both ||
							this._scrollType == t.ScrollType.Horizontal) &&
						(o = r || t.UIConfig.horizontalScrollBar)
					) {
						if (
							((this._hzScrollBar =
								t.UIPackage.createObjectFromURL(o)),
					...
					(this._scrollBarDisplayAuto =
						i == t.ScrollBarDisplayType.Auto),
						this._scrollBarDisplayAuto &&
							(this._vtScrollBar &&
								(this._vtScrollBar.displayObject.visible = !1),
							this._hzScrollBar &&
								(this._hzScrollBar.displayObject.visible = !1));
				...
				if (
					...
					throw new Error(
						'FairyGUI: cannot create scrollPane this.header from ' +
							a
					);
				if (
					n &&
					((this._footer = t.UIPackage.createObjectFromURL(n)),
					null == this._footer)
				)
					throw new Error(
						'FairyGUI: cannot create scrollPane this.footer from ' +
							n
					);
				(null == this._header && null == this._footer) ||
					(this._refreshBarAxis =
						this._scrollType == t.ScrollType.Both ||
						this._scrollType == t.ScrollType.Vertical
							? 'y'
							: 'x'),
			...
			setPosX(e, i) {
				this._owner.ensureBoundsCorrect(),
					...
					(e = t.ToolSet.clamp(e, 0, this._overlapSize.x)) !=
						this._xPos && ((this._xPos = e), this.posChanged(i));
			}
			get posY() {
				return this._yPos;
			}
			...
			setPosY(e, i) {
				this._owner.ensureBoundsCorrect(),
					...
					(e = t.ToolSet.clamp(e, 0, this._overlapSize.y)) !=
						this._yPos && ((this._yPos = e), this.posChanged(i));
			}
			get contentWidth() {
			...
			set viewWidth(t) {
				(t = t + this._owner.margin.left + this._owner.margin.right),
					null == this._vtScrollBar ||
						this._floating ||
						(t += this._vtScrollBar.width),
					(this._owner.width = t);
			}
			get viewHeight() {
			...
			set viewHeight(t) {
				(t = t + this._owner.margin.top + this._owner.margin.bottom),
					null == this._hzScrollBar ||
						this._floating ||
						(t += this._hzScrollBar.height),
			...
			get currentPageX() {
				...
				return (
					this._xPos - t * this._pageSize.x >
						0.5 * this._pageSize.x && t++,
					t
				);
			}
			set currentPageX(t) {
			...
			get currentPageY() {
				...
				return (
					this._yPos - t * this._pageSize.y >
						0.5 * this._pageSize.y && t++,
					t
				);
			}
			set currentPageY(t) {
			...
			setCurrentPageX(t, e) {
				this._pageMode &&
					...
					this._overlapSize.x > 0 &&
						this.setPosX(t * this._pageSize.x, e));
			}
			setCurrentPageY(t, e) {
				this._pageMode &&
					(this._owner.ensureBoundsCorrect(),
					this._overlapSize.y > 0 &&
						this.setPosY(t * this._pageSize.y, e));
			}
			get isBottomMost() {
				return (
					this._yPos == this._overlapSize.y ||
					0 == this._overlapSize.y
				);
			}
			get isRightMost() {
				return (
					this._xPos == this._overlapSize.x ||
					0 == this._overlapSize.x
				);
			}
			get pageController() {
			...
			scrollUp(t = 1, e) {
				this._pageMode
					? this.setPosY(this._yPos - this._pageSize.y * t, e)
					: this.setPosY(this._yPos - this._scrollStep * t, e);
			}
			scrollDown(t = 1, e) {
				this._pageMode
					? this.setPosY(this._yPos + this._pageSize.y * t, e)
			...
			scrollLeft(t = 1, e) {
				this._pageMode
					? this.setPosX(this._xPos - this._pageSize.x * t, e)
					: this.setPosX(this._xPos - this._scrollStep * t, e);
			}
			scrollRight(t = 1, e) {
				this._pageMode
					? this.setPosX(this._xPos + this._pageSize.x * t, e)
			...
			scrollToView(i, s, h) {
				...
				if (
					...
					i instanceof t.GObject
						? i.parent != this._owner
							? (i.parent.localToGlobalRect(
									i.x,
									i.y,
									i.width,
									i.height,
							  ...
							  (r = this._owner.globalToLocalRect(
									...
									e.sHelperRect.y,
									e.sHelperRect.width,
									e.sHelperRect.height,
									e.sHelperRect
							  )))
							: (r = e.sHelperRect).setTo(
									i.x,
									i.y,
									i.width,
									i.height
					...
					h || r.y <= this._yPos || r.height >= this._viewSize.y
						? this._pageMode
							? this.setPosY(
									Math.floor(r.y / this._pageSize.y) *
										this._pageSize.y,
									s
							  )
							: this.setPosY(r.y, s)
						: r.y + r.height > a &&
						  (this._pageMode
								...
								: r.height <= this._viewSize.y / 2
								? this.setPosY(
										r.y + 2 * r.height - this._viewSize.y,
										s
								  )
								: this.setPosY(
										r.y + r.height - this._viewSize.y,
										s
								  ));
				}
				if (this._overlapSize.x > 0) {
					var n = this._xPos + this._viewSize.x;
					h || r.x <= this._xPos || r.width >= this._viewSize.x
						? this._pageMode
							? this.setPosX(
									Math.floor(r.x / this._pageSize.x) *
										this._pageSize.x,
									s
							  )
							: this.setPosX(r.x, s)
						: r.x + r.width > n &&
						  (this._pageMode
								...
								: r.width <= this._viewSize.x / 2
								? this.setPosX(
										r.x + 2 * r.width - this._viewSize.x,
										s
								  )
								: this.setPosX(
										r.x + r.width - this._viewSize.x,
										s
								  ));
				}
				!s && this._needRefresh && this.refresh();
			}
			isChildInView(t) {
				...
				return !(
					this._overlapSize.x > 0 &&
					((e = t.x + this._container.x) < -t.width ||
						e > this._viewSize.x)
				);
			}
			cancelDragging() {
				this._owner.displayObject.stage.off(
					Laya.Event.MOUSE_MOVE,
					this,
					this.__mouseMove
				),
			...
			lockHeader(t) {
				this._headerLockedSize != t &&
					((this._headerLockedSize = t),
					!this._refreshEventDispatching &&
						this._container[this._refreshBarAxis] >= 0 &&
						(this._tweenStart.setTo(
							this._container.x,
							this._container.y
						),
						this._tweenChange.setTo(0, 0),
						(this._tweenChange[this._refreshBarAxis] =
							this._headerLockedSize -
							this._tweenStart[this._refreshBarAxis]),
						this._tweenDuration.setTo(
							e.TWEEN_TIME_DEFAULT,
							e.TWEEN_TIME_DEFAULT
						),
						this.startTween(2)));
			}
			lockFooter(t) {
				if (
					...
					((this._footerLockedSize = t),
					!this._refreshEventDispatching &&
						this._container[this._refreshBarAxis] <=
							-this._overlapSize[this._refreshBarAxis])
				) {
					this._tweenStart.setTo(
						this._container.x,
						this._container.y
					...
					0 == i
						? (i = Math.max(
								this._contentSize[this._refreshBarAxis] +
									this._footerLockedSize -
									this._viewSize[this._refreshBarAxis],
								0
						  ))
						: (i += this._footerLockedSize),
						(this._tweenChange[this._refreshBarAxis] =
							-i - this._tweenStart[this._refreshBarAxis]),
						this._tweenDuration.setTo(
							e.TWEEN_TIME_DEFAULT,
							e.TWEEN_TIME_DEFAULT
						),
			...
			handleControllerChanged(e) {
				this._pageController == e &&
					(this._scrollType == t.ScrollType.Horizontal
						? this.setCurrentPageX(e.selectedIndex, !0)
						: this.setCurrentPageY(e.selectedIndex, !0));
			}
			updatePageController() {
				var e;
				if (
					null != this._pageController &&
					!this._pageController.changing &&
					(e =
						this._scrollType == t.ScrollType.Horizontal
							? this.currentPageX
							: this.currentPageY) <
						this._pageController.pageCount
				) {
			...
			adjustMaskContainer() {
				...
				(t =
					...
					!this._floating
						? Math.floor(
								this._owner.margin.left +
									this._vtScrollBar.width
						  )
						: Math.floor(this._owner.margin.left)),
					(e = Math.floor(this._owner.margin.top)),
					this._maskContainer.pos(t, e),
					0 != this._owner._alignOffset.x ||
					0 != this._owner._alignOffset.y
						? (null == this._alignContainer &&
								((this._alignContainer = new Laya.Sprite()),
								this._maskContainer.addChild(
									this._alignContainer
								),
								this._alignContainer.addChild(this._container)),
						  this._alignContainer.pos(
								this._owner._alignOffset.x,
								this._owner._alignOffset.y
						  ))
						: this._alignContainer &&
			...
			setSize(t, e) {
				this.adjustMaskContainer(),
					this._hzScrollBar &&
						...
						this._vtScrollBar && !this._vScrollNone
							? ((this._hzScrollBar.width =
									t -
									this._vtScrollBar.width -
									this._scrollBarMargin.left -
									this._scrollBarMargin.right),
							  this._displayOnLeft
									? (this._hzScrollBar.x =
											this._scrollBarMargin.left +
											this._vtScrollBar.width)
					...
					this._vtScrollBar &&
						(this._displayOnLeft ||
							(this._vtScrollBar.x = t - this._vtScrollBar.width),
						this._hzScrollBar
							? (this._vtScrollBar.height =
									e -
									this._hzScrollBar.height -
									this._scrollBarMargin.top -
									this._scrollBarMargin.bottom)
							: (this._vtScrollBar.height =
									e -
									this._scrollBarMargin.top -
									this._scrollBarMargin.bottom),
					...
					(this._viewSize.x -=
						this._owner.margin.left + this._owner.margin.right),
					(this._viewSize.y -=
						this._owner.margin.top + this._owner.margin.bottom),
			...
			setContentSize(t, e) {
				(this._contentSize.x == t && this._contentSize.y == e) ||
			...
			changeContentSizeOnScrolling(t, e, i, s) {
				...
				(this._contentSize.x += t),
					...
					1 == this._tweening
						? (0 != t &&
								h &&
								this._tweenChange.x < 0 &&
								((this._xPos = this._overlapSize.x),
								(this._tweenChange.x =
									-this._xPos - this._tweenStart.x)),
						  0 != e &&
								r &&
								this._tweenChange.y < 0 &&
								((this._yPos = this._overlapSize.y),
								(this._tweenChange.y =
									-this._yPos - this._tweenStart.y)))
						: 2 == this._tweening
						? (0 != i &&
								((this._container.x -= i),
			...
			handleSizeChanged() {
				this._displayInDemand &&
					((this._vScrollNone =
						this._contentSize.y <= this._viewSize.y),
					(this._hScrollNone =
						this._contentSize.x <= this._viewSize.x)),
					this._vtScrollBar &&
						(0 == this._contentSize.y
							? this._vtScrollBar.setDisplayPerc(0)
							: this._vtScrollBar.setDisplayPerc(
									Math.min(
										1,
										this._viewSize.y / this._contentSize.y
									)
							  )),
					this._hzScrollBar &&
						(0 == this._contentSize.x
							? this._hzScrollBar.setDisplayPerc(0)
							: this._hzScrollBar.setDisplayPerc(
									Math.min(
										1,
										this._viewSize.x / this._contentSize.x
									)
							  )),
				...
				if (
					(e &&
						((e.width = this._viewSize.x),
						(e.height = this._viewSize.y),
						this._vScrollNone &&
							this._vtScrollBar &&
							(e.width += this._vtScrollBar.width),
						this._hScrollNone &&
							this._hzScrollBar &&
							(e.height += this._hzScrollBar.height),
						(this._maskContainer.scrollRect = e)),
					this._scrollType == t.ScrollType.Horizontal ||
					this._scrollType == t.ScrollType.Both
						? (this._overlapSize.x = Math.ceil(
								Math.max(
									0,
									this._contentSize.x - this._viewSize.x
								)
					...
					this._scrollType == t.ScrollType.Both
						...
						: (this._overlapSize.y = 0),
					(this._xPos = t.ToolSet.clamp(
						this._xPos,
						0,
						this._overlapSize.x
					)),
					(this._yPos = t.ToolSet.clamp(
						this._yPos,
						0,
						this._overlapSize.y
					)),
			...
			posChanged(t) {
				0 == this._aniFlag
					? (this._aniFlag = t ? 1 : -1)
					: 1 != this._aniFlag || t || (this._aniFlag = -1),
					(this._needRefresh = !0),
			...
			refresh() {
				(this._needRefresh = !1),
					...
					(this._pageMode || this._snapToItem) &&
						(e.sEndPos.setTo(-this._xPos, -this._yPos),
						this.alignPosition(e.sEndPos, !1),
						(this._xPos = -e.sEndPos.x),
						(this._yPos = -e.sEndPos.y)),
					this.refresh2(),
					t.Events.dispatch(
						t.Events.SCROLL,
						this._owner.displayObject
					),
					this._needRefresh &&
						((this._needRefresh = !1),
						Laya.timer.clear(this, this.refresh),
			...
			refresh2() {
				var t, i;
				1 != this._aniFlag || this._dragged
					? (0 != this._tweening && this.killTween(),
					  this._container.pos(
							Math.floor(-this._xPos),
							Math.floor(-this._yPos)
					  ),
					  this.loopCheckingCurrent())
					: (this._overlapSize.x > 0
							? (t = -Math.floor(this._xPos))
							: (0 != this._container.x &&
									(this._container.x = 0),
							  (t = 0)),
					  this._overlapSize.y > 0
							? (i = -Math.floor(this._yPos))
							: (0 != this._container.y &&
									(this._container.y = 0),
							  (i = 0)),
					  t != this._container.x || i != this._container.y
							? (this._tweenDuration.setTo(
									e.TWEEN_TIME_GO,
									e.TWEEN_TIME_GO
							  ),
							  ...
							  this._tweenChange.setTo(
									t - this._tweenStart.x,
									i - this._tweenStart.y
							  ),
							  this.startTween(1))
							: 0 != this._tweening && this.killTween()),
					this._pageMode && this.updatePageController();
			...
			__mouseDown() {
				if (this._touchEffect) {
					0 != this._tweening
						? (this.killTween(), (this._dragged = !0))
						: (this._dragged = !1);
					var t = this._owner.globalToLocal(
						Laya.stage.mouseX,
						Laya.stage.mouseY,
						e.sHelperPoint
					);
					this._containerPos.setTo(
						this._container.x,
						this._container.y
					),
						this._beginTouchPos.setTo(t.x, t.y),
						this._lastTouchPos.setTo(t.x, t.y),
						this._lastTouchGlobalPos.setTo(
							Laya.stage.mouseX,
							Laya.stage.mouseY
						),
						...
						this._owner.displayObject.stage.on(
							Laya.Event.MOUSE_MOVE,
							this,
							this.__mouseMove
						),
			...
			__mouseMove() {
				if (
					...
					(null == e.draggingPane || e.draggingPane == this) &&
					null == t.GObject.draggingObject
				) {
					var i,
						s,
						h,
						r = t.UIConfig.touchScrollSensitivity,
						a = this._owner.globalToLocal(
							Laya.stage.mouseX,
							Laya.stage.mouseY,
							e.sHelperPoint
						);
					if (this._scrollType == t.ScrollType.Vertical) {
						if (!this._isHoldAreaDone) {
							if (
								((e._gestureFlag |= 1),
								(i = Math.abs(this._beginTouchPos.y - a.y)) < r)
							)
								return;
							if (
								0 != (2 & e._gestureFlag) &&
								i < Math.abs(this._beginTouchPos.x - a.x)
							)
								return;
						}
						s = !0;
						...
						if (!this._isHoldAreaDone) {
							if (
								((e._gestureFlag |= 2),
								(i = Math.abs(this._beginTouchPos.x - a.x)) < r)
							)
								return;
							if (
								0 != (1 & e._gestureFlag) &&
								i < Math.abs(this._beginTouchPos.y - a.y)
							)
								return;
						}
						h = !0;
					...
					var n = Math.floor(
							this._containerPos.x + a.x - this._beginTouchPos.x
						),
						o = Math.floor(
							this._containerPos.y + a.y - this._beginTouchPos.y
						);
					s &&
						(o > 0
							? this._bouncebackEffect
								? null != this._header &&
								  0 != this._header.maxHeight
									? (this._container.y = Math.floor(
											Math.min(
												0.5 * o,
												this._header.maxHeight
											)
									  ))
									: (this._container.y = Math.floor(
											Math.min(
												0.5 * o,
												this._viewSize.y * e.PULL_RATIO
											)
									  ))
								: (this._container.y = 0)
							: o < -this._overlapSize.y
							? this._bouncebackEffect
								? null != this._footer &&
								  this._footer.maxHeight > 0
									? (this._container.y = Math.floor(
											Math.max(
												0.5 * (o + this._overlapSize.y),
												-this._footer.maxHeight
											) - this._overlapSize.y
									  ))
									: (this._container.y = Math.floor(
											Math.max(
						...
						h &&
							(n > 0
								? this._bouncebackEffect
									? null != this._header &&
									  0 != this._header.maxWidth
										? (this._container.x = Math.floor(
												Math.min(
													0.5 * n,
													this._header.maxWidth
												)
										  ))
										: (this._container.x = Math.floor(
												Math.min(
									...
									: (this._container.x = 0)
								: n < 0 - this._overlapSize.x
								? this._bouncebackEffect
									? null != this._footer &&
									  this._footer.maxWidth > 0
										? (this._container.x = Math.floor(
												Math.max(
													0.5 *
														(n +
					...
					var l =
							Laya.stage.frameRate == Laya.Stage.FRAME_SLOW
								? 30
								: 60,
						_ = Laya.timer.currTimer / 1e3,
						d = Math.max(_ - this._lastMoveTime, 1 / l),
						c = a.x - this._lastTouchPos.x,
						u = a.y - this._lastTouchPos.y;
					if ((h || (c = 0), s || (u = 0), 0 != d)) {
						var g = d * l - 1;
						if (g > 1) {
							var p = Math.pow(0.833, g);
							(this._velocity.x = this._velocity.x * p),
								(this._velocity.y = this._velocity.y * p);
						}
						(this._velocity.x = t.ToolSet.lerp(
							this._velocity.x,
							(60 * c) / l / d,
							10 * d
						)),
							(this._velocity.y = t.ToolSet.lerp(
								this._velocity.y,
								(60 * u) / l / d,
								10 * d
							));
					}
					var f = this._lastTouchGlobalPos.x - Laya.stage.mouseX,
						y = this._lastTouchGlobalPos.y - Laya.stage.mouseY;
					0 != c
						? (this._velocityScale = Math.abs(f / c))
						: 0 != u && (this._velocityScale = Math.abs(y / u)),
						this._lastTouchPos.setTo(a.x, a.y),
						this._lastTouchGlobalPos.setTo(
							Laya.stage.mouseX,
							Laya.stage.mouseY
						),
						(this._lastMoveTime = _),
						this._overlapSize.x > 0 &&
							(this._xPos = t.ToolSet.clamp(
								-this._container.x,
								0,
			...
			__mouseUp() {
				...
				if (
					(this._container.x > 0
						? ((e.sEndPos.x = 0), (i = !0))
						: this._container.x < -this._overlapSize.x &&
						  ((e.sEndPos.x = -this._overlapSize.x), (i = !0)),
					this._container.y > 0
						? ((e.sEndPos.y = 0), (i = !0))
						: this._container.y < -this._overlapSize.y &&
						  ((e.sEndPos.y = -this._overlapSize.y), (i = !0)),
					i)
				) {
					if (
						(this._tweenChange.setTo(
							e.sEndPos.x - this._tweenStart.x,
							e.sEndPos.y - this._tweenStart.y
						),
						this._tweenChange.x <
							-t.UIConfig.touchDragSensitivity ||
						this._tweenChange.y < -t.UIConfig.touchDragSensitivity
							? ((this._refreshEventDispatching = !0),
							  t.Events.dispatch(
									t.Events.PULL_DOWN_RELEASE,
									this._owner.displayObject
							  ),
							...
							: (this._tweenChange.x >
							  ...
							  ((this._refreshEventDispatching = !0),
							  t.Events.dispatch(
									t.Events.PULL_UP_RELEASE,
									this._owner.displayObject
							  ),
							  (this._refreshEventDispatching = !1)),
						this._headerLockedSize > 0 &&
							0 == e.sEndPos[this._refreshBarAxis])
					)
						(e.sEndPos[this._refreshBarAxis] =
							this._headerLockedSize),
							(this._tweenChange.x =
								e.sEndPos.x - this._tweenStart.x),
							(this._tweenChange.y =
						...
						0 == s
							...
							: (s += this._footerLockedSize),
							(e.sEndPos[this._refreshBarAxis] = -s),
							(this._tweenChange.x =
								e.sEndPos.x - this._tweenStart.x),
							(this._tweenChange.y =
								e.sEndPos.y - this._tweenStart.y);
					...
					if (this._inertiaDisabled)
						...
						var h =
								Laya.stage.frameRate == Laya.Stage.FRAME_SLOW
									...
									: 60,
							r =
								(Laya.timer.currTimer / 1e3 -
									this._lastMoveTime) *
									h -
								1;
						if (r > 1) {
							var a = Math.pow(0.833, r);
					...
					if (
						...
						this.loopCheckingTarget(e.sEndPos),
						(this._pageMode || this._snapToItem) &&
							this.alignPosition(e.sEndPos, !0),
						(this._tweenChange.x =
							e.sEndPos.x - this._tweenStart.x),
						(this._tweenChange.y =
							e.sEndPos.y - this._tweenStart.y),
					...
					(this._pageMode || this._snapToItem) &&
						(this.fixDuration('x', e.sOldChange.x),
			...
			__mouseWheel(t) {
				if (this._mouseWheelEnabled) {
					var e = t.delta;
					(e = e > 0 ? -1 : e < 0 ? 1 : 0),
						this._overlapSize.x > 0 && 0 == this._overlapSize.y
							? this._pageMode
								? this.setPosX(
										this._xPos + this._pageSize.x * e,
										!1
								  )
								: this.setPosX(
										this._xPos + this._mouseWheelStep * e,
										!1
								  )
							: this._pageMode
							? this.setPosY(
									this._yPos + this._pageSize.y * e,
									!1
							  )
							: this.setPosY(
									this._yPos + this._mouseWheelStep * e,
									!1
							  );
				}
			}
			updateScrollBarPos() {
				null != this._vtScrollBar &&
					this._vtScrollBar.setScrollPerc(
						0 == this._overlapSize.y
							? 0
							: t.ToolSet.clamp(
									-this._container.y,
					...
					null != this._hzScrollBar &&
						this._hzScrollBar.setScrollPerc(
							0 == this._overlapSize.x
								? 0
								: t.ToolSet.clamp(
										-this._container.x,
			...
			updateScrollBarVisible() {
				this._vtScrollBar &&
					(this._viewSize.y <= this._vtScrollBar.minSize ||
					this._vScrollNone
						? (this._vtScrollBar.displayObject.visible = !1)
						: this.updateScrollBarVisible2(this._vtScrollBar)),
					this._hzScrollBar &&
						(this._viewSize.x <= this._hzScrollBar.minSize ||
						this._hScrollNone
							? (this._hzScrollBar.displayObject.visible = !1)
			...
			updateScrollBarVisible2(e) {
				this._scrollBarDisplayAuto && t.GTween.kill(e, !1, 'alpha'),
					...
					this._dragged ||
					e.gripDragging
						? ((e.alpha = 1), (e.displayObject.visible = !0))
						: e.displayObject.visible &&
						  t.GTween.to(1, 0, 0.5)
								.setDelay(0.5)
								.onComplete(this.__barTweenComplete)
								.setTarget(e, 'alpha');
			}
			...
			loopCheckingCurrent() {
				var t = !1;
				return (
					1 == this._loop && this._overlapSize.x > 0
						? this._xPos < 0.001
			...
			loopCheckingTarget2(t, e) {
				...
				t[e] > 0
					? ((i = this.getLoopPartSize(2, e)),
					  (s = this._tweenStart[e] - i) <= 0 &&
							s >= -this._overlapSize[e] &&
							((t[e] -= i), (this._tweenStart[e] = s)))
					: t[e] < -this._overlapSize[e] &&
					  ((i = this.getLoopPartSize(2, e)),
					  (s = this._tweenStart[e] + i) <= 0 &&
							s >= -this._overlapSize[e] &&
							((t[e] += i), (this._tweenStart[e] = s)));
			...
			loopCheckingNewPos(e, i) {
				...
				return (
					e < 0.001
						? (e += this.getLoopPartSize(2, i)) > h &&
						  ((s = this.getLoopPartSize(6, i)),
						  (s = Math.ceil((e - h) / s) * s),
						  (h = t.ToolSet.clamp(h + s, 0, this._overlapSize[i])),
						  (r = !0))
						: e >= this._overlapSize[i] &&
						  (e -= this.getLoopPartSize(2, i)) < h &&
						  ((s = this.getLoopPartSize(6, i)),
						  (s = Math.ceil((h - e) / s) * s),
						  (h = t.ToolSet.clamp(h - s, 0, this._overlapSize[i])),
					...
					r &&
						('x' == i
							? (this._container.x = -Math.floor(h))
							: (this._container.y = -Math.floor(h))),
					e
				);
			}
			alignPosition(t, i) {
				if (this._pageMode)
					(t.x = this.alignByPage(t.x, 'x', i)),
						(t.y = this.alignByPage(t.y, 'y', i));
				else if (this._snapToItem) {
					var s = 0,
						h = 0;
					i &&
						((s = t.x - this._containerPos.x),
						(h = t.y - this._containerPos.y));
					var r = this._owner.getSnappingPositionWithDir(
						-t.x,
						-t.y,
						s,
						h,
			...
			alignByPage(e, i, s) {
				...
				if (e > 0) h = 0;
					...
					var r = s
							? e - this._containerPos[i]
							: e - this._container[i],
						a = Math.min(
							this._pageSize[i],
							this._contentSize[i] - (h + 1) * this._pageSize[i]
						),
						n = -e - h * this._pageSize[i];
					Math.abs(r) > this._pageSize[i]
						? n > 0.5 * a && h++
						: n >
								a *
									(r < 0
										? t.UIConfig
												.defaultScrollPagingThreshold
										: 1 -
										  t.UIConfig
												.defaultScrollPagingThreshold) &&
						  h++,
						(e = -h * this._pageSize[i]) < -this._overlapSize[i] &&
							(e = -this._overlapSize[i]);
				}
				if (s) {
					var o,
					...
					o =
						l > 0
							? 0
							: l < -this._overlapSize[i]
							? Math.ceil(
									this._contentSize[i] / this._pageSize[i]
							  ) - 1
							: Math.floor(-l / this._pageSize[i]);
					var _ = Math.floor(
						-this._containerPos[i] / this._pageSize[i]
					);
					Math.abs(h - _) > 1 &&
						Math.abs(o - _) <= 1 &&
						(e = -(h = h > _ ? _ + 1 : _ - 1) * this._pageSize[i]);
				}
				return e;
			}
			...
			updateTargetAndDuration2(t, i) {
				var s = this._velocity[i],
					h = 0;
				if (t > 0) t = 0;
				else if (t < -this._overlapSize[i]) t = -this._overlapSize[i];
				else {
					var r = Math.abs(s) * this._velocityScale;
					Laya.Browser.onMobile &&
						(r *=
							1136 /
							Math.max(Laya.stage.width, Laya.stage.height));
					var a = 0;
					this._pageMode || !Laya.Browser.onMobile
						? r > 500 && (a = Math.pow((r - 500) / 500, 2))
						: r > 1e3 && (a = Math.pow((r - 1e3) / 1e3, 2)),
						0 != a &&
							(a > 1 && (a = 1),
							(r *= a),
							(s *= a),
							...
							(h =
								Math.log(60 / r) /
								Math.log(this._decelerationRate) /
								60),
							(t += Math.floor(s * h * 0.4)));
				}
				return (
					h < e.TWEEN_TIME_DEFAULT && (h = e.TWEEN_TIME_DEFAULT),
					(this._tweenDuration[i] = h),
					t
				);
			}
			fixDuration(t, i) {
				if (
					!(
						0 == this._tweenChange[t] ||
						Math.abs(this._tweenChange[t]) >= Math.abs(i)
					)
				) {
					var s =
						Math.abs(this._tweenChange[t] / i) *
						this._tweenDuration[t];
					s < e.TWEEN_TIME_DEFAULT && (s = e.TWEEN_TIME_DEFAULT),
						(this._tweenDuration[t] = s);
				}
			}
			startTween(t) {
			...
			checkRefreshBar() {
				if (null != this._header || null != this._footer) {
					...
					if (null != this._header)
						if (t > 0) {
							null == this._header.displayObject.parent &&
								this._maskContainer.addChildAt(
									this._header.displayObject,
									0
								);
							var i = e.sHelperPoint;
							i.setTo(this._header.width, this._header.height),
								(i[this._refreshBarAxis] = t),
								this._header.setSize(i.x, i.y);
						} else
							null != this._header.displayObject.parent &&
								this._maskContainer.removeChild(
									this._header.displayObject
								);
					if (null != this._footer) {
						var s = this._overlapSize[this._refreshBarAxis];
						t < -s || (0 == s && this._footerLockedSize > 0)
							? (null == this._footer.displayObject.parent &&
									this._maskContainer.addChildAt(
										this._footer.displayObject,
										0
									),
							  (i = e.sHelperPoint).setTo(
									this._footer.x,
									this._footer.y
							  ),
							  (i[this._refreshBarAxis] =
									s > 0
										? t +
										  this._contentSize[
												this._refreshBarAxis
							  ...
							  this._footer.setXY(i.x, i.y),
							  i.setTo(this._footer.width, this._footer.height),
							  (i[this._refreshBarAxis] =
									s > 0
										? -s - t
										: this._viewSize[this._refreshBarAxis] -
										  this._footer[this._refreshBarAxis]),
							  this._footer.setSize(i.x, i.y))
							: null != this._footer.displayObject.parent &&
							  this._maskContainer.removeChild(
									this._footer.displayObject
							  );
			...
			runTween(t) {
				...
				if (0 != this._tweenChange[t]) {
					if (
						((this._tweenTime[t] += Laya.timer.delta / 1e3),
						...
						i =
							this._tweenStart[t] +
							Math.floor(this._tweenChange[t] * s);
					}
					var h = 0,
						r = -this._overlapSize[t];
					if (
						(this._headerLockedSize > 0 &&
							this._refreshBarAxis == t &&
							(h = this._headerLockedSize),
					...
					2 == this._tweening && this._bouncebackEffect
						? (i > 20 + h && this._tweenChange[t] > 0) ||
						  (i > h && 0 == this._tweenChange[t])
							? ((this._tweenTime[t] = 0),
							  (this._tweenDuration[t] = e.TWEEN_TIME_DEFAULT),
							  (this._tweenChange[t] = -i + h),
							  (this._tweenStart[t] = i))
							: ((i < r - 20 && this._tweenChange[t] < 0) ||
									(i < r && 0 == this._tweenChange[t])) &&
							  ((this._tweenTime[t] = 0),
							  (this._tweenDuration[t] = e.TWEEN_TIME_DEFAULT),
							  (this._tweenChange[t] = r - i),
							  (this._tweenStart[t] = i))
						: i > h
						? ((i = h), (this._tweenChange[t] = 0))
						: i < r && ((i = r), (this._tweenChange[t] = 0));
		...
		(e._gestureFlag = 0),
			(e.sHelperPoint = new Laya.Point()),
			(e.sHelperRect = new Laya.Rectangle()),
			(e.sEndPos = new Laya.Point()),
			(e.sOldChange = new Laya.Point()),
			(e.TWEEN_TIME_GO = 0.5),
			(e.TWEEN_TIME_DEFAULT = 0.3),
			(e.PULL_RATIO = 0.5),
			(t.ScrollPane = e);
	})(fgui || (fgui = {})),
	(function (t) {
		class e {
			...
			play(t = null, e = 1, i = 0, s = 0, h = -1) {
				this._play(t, e, i, s, h, !1);
			}
			playReverse(t = null, e = 1, i = 0, s = 0, h = -1) {
				this._play(t, 1, i, s, h, !0);
			}
			changePlayTimes(t) {
				this._totalTimes = t;
			}
			setAutoPlay(t, e = 1, i = 0) {
				this._autoPlay != t &&
					((this._autoPlay = t),
					...
					this._autoPlay
						...
						: this._owner.onStage || this.stop(!1, !0));
			}
			_play(e = null, s = 1, h = 0, r = 0, a = -1, n = !1) {
				this.stop(!0, !0),
					(this._totalTimes = s),
					(this._reversed = n),
					(this._startTime = r),
				...
				for (var o = this._items.length, l = 0; l < o; l++) {
					...
					if (
						(null == _.target
							? _.targetId
								? (_.target = this._owner.getChildById(
										_.targetId
								  ))
								: (_.target = this._owner)
							: _.target != this._owner &&
							  _.target.parent != this._owner &&
							  (_.target = null),
						null != _.target && _.type == i.Transition)
					) {
						var d = _.target.getTransition(_.value.transName);
						if ((d == this && (d = null), null != d))
				...
				0 == h
					? this.onDelayedPlay()
					: t.GTween.delayedCall(h).onComplete(
							this.onDelayedPlay,
							this
					  );
			}
					...
					null != t.tweener &&
						...
						t.type != i.Shake ||
							...
							t.target.setXY(
								...
								t.target.y - t.value.lastOffsetY
							),
				...
				if (this._playing && this._paused != e) {
					...
					for (var h = this._items.length, r = 0; r < h; r++) {
						...
						null != a.target &&
							(a.type == i.Transition
								? null != a.value.trans &&
								  a.value.trans.setPaused(e)
								: a.type == i.Animation &&
								  (e
										? ((a.value.flag = a.target.getProp(
												t.ObjectPropID.Playing
										  )),
										  a.target.setProp(
												t.ObjectPropID.Playing,
												!1
			...
			dispose() {
				...
				for (var e = this._items.length, i = 0; i < e; i++) {
					var s = this._items[i];
					null != s.tweener && (s.tweener.kill(), (s.tweener = null)),
						(s.target = null),
						(s.hook = null),
			...
			setValue(t, ...e) {
				for (var s, h = this._items.length, r = !1, a = 0; a < h; a++) {
					...
					if (n.label == t)
						(s =
							null != n.tweenConfig
								? n.tweenConfig.startValue
								: n.value),
							(r = !0);
					else {
						if (
							null == n.tweenConfig ||
							n.tweenConfig.endLabel != t
						)
							continue;
					...
					switch (n.type) {
						...
						case i.Color:
							...
							break;
						case i.Animation:
							(s.frame = parseInt(e[0])),
								e.length > 1 && (s.playing = e[1]);
							break;
						case i.Visible:
							s.visible = e[0];
							break;
						case i.Sound:
							(s.sound = e[0]),
								e.length > 1 && (s.volume = parseFloat(e[1]));
							break;
						case i.Transition:
							(s.transName = e[0]),
								e.length > 1 && (s.playTimes = parseInt(e[1]));
							break;
						case i.Shake:
							(s.amplitude = parseFloat(e[0])),
								e.length > 1 && (s.duration = parseFloat(e[1]));
							break;
						case i.ColorFilter:
							(s.f1 = parseFloat(e[0])),
								(s.f2 = parseFloat(e[1])),
			...
			setTarget(t, e) {
				for (var i = this._items.length, s = !1, h = 0; h < i; h++) {
					...
					r.label == t &&
						((r.targetId =
							e == this._owner || null == e ? '' : e.id),
						this._playing
							? r.targetId.length > 0
								? (r.target = this._owner.getChildById(
										r.targetId
								  ))
								: (r.target = this._owner)
							: (r.target = null),
						(s = !0));
				}
				if (!s) throw new Error('this.label not exists');
			...
			getLabelTime(t) {
				for (var e = this._items.length, i = 0; i < e; i++) {
					...
					if (null != s.tweenConfig && s.tweenConfig.endLabel == t)
			...
			set timeScale(e) {
				if (
					this._timeScale != e &&
					((this._timeScale = e), this._playing)
				)
					for (var s = this._items.length, h = 0; h < s; h++) {
						var r = this._items[h];
						null != r.tweener
							? r.tweener.setTimeScale(e)
							: r.type == i.Transition
							? null != r.value.trans &&
							  (r.value.trans.timeScale = e)
							: r.type == i.Animation &&
							  null != r.target &&
							  r.target.setProp(t.ObjectPropID.TimeScale, e);
					}
			}
			updateFromRelations(t, e, s) {
				var h = this._items.length;
				if (0 != h)
					for (var r = 0; r < h; r++) {
						var a = this._items[r];
						a.type == i.XY &&
							a.targetId == t &&
							(null != a.tweenConfig
								? (a.tweenConfig.startValue.b3 ||
										((a.tweenConfig.startValue.f1 += e),
										(a.tweenConfig.startValue.f2 += s)),
								  a.tweenConfig.endValue.b3 ||
										((a.tweenConfig.endValue.f1 += e),
										(a.tweenConfig.endValue.f2 += s)))
								: a.value.b3 ||
								  ((a.value.f1 += e), (a.value.f2 += s)));
					}
			}
			onOwnerAddedToStage() {
				this._autoPlay &&
			...
			onOwnerRemovedFromStage() {
				0 == (this._options & e.OPTION_AUTO_STOP_DISABLED) &&
					this.stop(
						0 != (this._options & e.OPTION_AUTO_STOP_AT_END),
						!1
					);
			}
			onDelayedPlay() {
				if (
					...
					if (
						0 !=
						(this._options & e.OPTION_IGNORE_DISPLAY_CONTROLLER)
					)
						for (var t = this._items.length, i = 0; i < t; i++) {
							var s = this._items[i];
							null != s.target &&
								s.target != this._owner &&
								(s.displayLockToken =
									s.target.addDisplayLock());
						}
			...
			playItem(e) {
				...
				if (null != e.tweenConfig) {
					if (
						...
						switch (
							(this._reversed
								? ((h = e.tweenConfig.endValue),
								  (r = e.tweenConfig.startValue))
								: ((h = e.tweenConfig.startValue),
								  (r = e.tweenConfig.endValue)),
							(e.value.b1 = h.b1 || r.b1),
							(e.value.b2 = h.b2 || r.b2),
							e.type)
						) {
							case i.XY:
							case i.Size:
						...
						e.tweener
							.setDelay(s)
							.setEase(e.tweenConfig.easeType)
							.setRepeat(e.tweenConfig.repeat, e.tweenConfig.yoyo)
							...
							this._endTime >= 0 &&
								e.tweener.setBreakpoint(this._endTime - s),
							this._totalTasks++;
					}
				} else
					e.type == i.Shake
						? ((s = this._reversed
						  ...
						  (e.tweener = t.GTween.shake(
								...
								.onComplete(this.onTweenComplete, this)),
						  this._endTime >= 0 &&
								e.tweener.setBreakpoint(this._endTime - e.time),
						  this._totalTasks++)
						: (s = this._reversed
								? this._totalDuration - e.time
								: e.time) <= this._startTime
						? (this.applyValue(e), this.callHook(e, !1))
						: (-1 == this._endTime || s <= this._endTime) &&
						  (this._totalTasks++,
						  (e.tweener = t.GTween.delayedCall(s)
								.setTimeScale(this._timeScale)
								.setTarget(e)
			...
			skipAnimations() {
				for (
					var e, s, h, r, a, n, o = this._items.length, l = 0;
					l < o;
					l++
				)
					if (
						!(
							(n = this._items[l]).type != i.Animation ||
							n.time > this._startTime ||
							(r = n.value).flag
						)
					) {
						(e = (a = n.target).getProp(t.ObjectPropID.Frame)),
							(s = a.getProp(t.ObjectPropID.Playing) ? 0 : -1),
							(h = 0);
						for (var _ = l; _ < o; _++)
							(n = this._items[_]).type != i.Animation ||
								n.target != a ||
								n.time > this._startTime ||
								(((r = n.value).flag = !0),
								-1 != r.frame
						...
						s >= 0 && (h += this._startTime - s),
							...
							a.setProp(t.ObjectPropID.Frame, e),
							h > 0 &&
								a.setProp(t.ObjectPropID.DeltaTime, 1e3 * h);
					}
			}
			onDelayedPlayItem(t) {
				var e = t.target;
			...
			onTweenStart(t) {
				var e,
					s,
					h = t.target;
				(h.type != i.XY && h.type != i.Size) ||
					(this._reversed
						? ((e = h.tweenConfig.endValue),
						  (s = h.tweenConfig.startValue))
						: ((e = h.tweenConfig.startValue),
						  (s = h.tweenConfig.endValue)),
					h.type == i.XY
						? h.target != this._owner
							? (e.b1
									? e.b3 &&
									  (t.startValue.x =
											e.f1 * this._owner.width)
									: (t.startValue.x = h.target.x),
							  e.b2
									? e.b3 &&
									  (t.startValue.y =
											e.f2 * this._owner.height)
									: (t.startValue.y = h.target.y),
							  s.b1
									? s.b3 &&
									  (t.endValue.x = s.f1 * this._owner.width)
									: (t.endValue.x = t.startValue.x),
							  s.b2
									? s.b3 &&
									  (t.endValue.y = s.f2 * this._owner.height)
									: (t.endValue.y = t.startValue.y))
							: (e.b1 ||
									(t.startValue.x =
										h.target.x - this._ownerBaseX),
							  e.b2 ||
									(t.startValue.y =
										h.target.y - this._ownerBaseY),
							  s.b1 || (t.endValue.x = t.startValue.x),
							  s.b2 || (t.endValue.y = t.startValue.y))
						: (e.b1 || (t.startValue.x = h.target.width),
						  e.b2 || (t.startValue.y = h.target.height),
						  s.b1 || (t.endValue.x = t.startValue.x),
						  s.b2 || (t.endValue.y = t.startValue.y)),
					h.tweenConfig.path &&
						((h.value.b1 = h.value.b2 = !0),
			...
			callHook(t, e) {
				e
					? null != t.tweenConfig &&
					  null != t.tweenConfig.endHook &&
					  t.tweenConfig.endHook.run()
					: t.time >= this._startTime &&
					  null != t.hook &&
					  t.hook.run();
			}
				...
				if (this._playing && 0 == this._totalTasks)
					if (this._totalTimes < 0) this.internalPlay();
						...
						for (var t = this._items.length, e = 0; e < t; e++) {
							var i = this._items[e];
							null != i.target &&
								0 != i.displayLockToken &&
								(i.target.releaseDisplayLock(
									i.displayLockToken
								),
			...
			applyValue(e) {
				...
				switch (e.type) {
					case i.XY:
						e.target == this._owner
							? s.b1 && s.b2
								? e.target.setXY(
										s.f1 + this._ownerBaseX,
										s.f2 + this._ownerBaseY
								  )
								: s.b1
								? (e.target.x = s.f1 + this._ownerBaseX)
								: (e.target.y = s.f2 + this._ownerBaseY)
							: s.b3
							? s.b1 && s.b2
								? e.target.setXY(
										s.f1 * this._owner.width,
										s.f2 * this._owner.height
								  )
								: s.b1
								? (e.target.x = s.f1 * this._owner.width)
								: s.b2 &&
								  (e.target.y = s.f2 * this._owner.height)
							: s.b1 && s.b2
							? e.target.setXY(s.f1, s.f2)
							: s.b1
							? (e.target.x = s.f1)
							: s.b2 && (e.target.y = s.f2);
						break;
					case i.Size:
						s.b1 || (s.f1 = e.target.width),
							s.b2 || (s.f2 = e.target.height),
							e.target.setSize(s.f1, s.f2);
						break;
					case i.Pivot:
					...
					case i.Color:
						e.target.setProp(
							t.ObjectPropID.Color,
							t.ToolSet.convertToHtmlColor(s.f1, !1)
						);
						break;
					case i.Animation:
						s.frame >= 0 &&
							e.target.setProp(t.ObjectPropID.Frame, s.frame),
							e.target.setProp(t.ObjectPropID.Playing, s.playing),
							e.target.setProp(
								t.ObjectPropID.TimeScale,
								this._timeScale
							);
						break;
					case i.Visible:
					...
					case i.Transition:
						if (this._playing) {
							...
							if (null != h) {
								this._totalTasks++;
								var r =
										this._startTime > e.time
											? this._startTime - e.time
											: 0,
									a =
										this._endTime >= 0
											? this._endTime - e.time
											: -1;
								s.stopTime >= 0 &&
									(a < 0 || a > s.stopTime) &&
									(a = s.stopTime),
					...
					case i.Shake:
						e.target.setXY(
							e.target.x - s.lastOffsetX + s.offsetX,
							e.target.y - s.lastOffsetY + s.offsetY
						),
							(s.lastOffsetX = s.offsetX),
							(s.lastOffsetY = s.offsetY);
						break;
					case i.ColorFilter:
						t.ToolSet.setColorFilter(e.target.displayObject, [
							s.f1,
							s.f2,
							s.f3,
							s.f4
			...
			setup(e) {
				...
				for (var i = e.getInt16(), r = 0; r < i; r++) {
					var a = e.getInt16(),
						n = e.pos;
					e.seek(n, 0);
					var o = new s(e.readByte());
					(this._items[r] = o), (o.time = e.getFloat32());
					var l = e.getInt16();
					if (
						((o.targetId =
							l < 0 ? '' : this._owner.getChildAt(l).id),
						(o.label = e.readS()),
						e.readBool())
					) {
						if (
								...
								for (var d = new Array(), c = 0; c < _; c++) {
									...
									switch (u) {
										...
										case t.CurveType.CubicBezier:
											d.push(
												t.GPathPoint.newCubicBezierPoint(
													e.getFloat32(),
													e.getFloat32(),
													e.getFloat32(),
													e.getFloat32(),
						...
						o.time > this._totalDuration &&
							(this._totalDuration = o.time),
							e.seek(n, 2),
			...
			decodeValue(t, e, s) {
				switch (t.type) {
					...
					case i.Transition:
						...
						break;
					case i.Shake:
						(s.amplitude = e.getFloat32()),
							(s.duration = e.getFloat32());
						break;
					case i.ColorFilter:
						(s.f1 = e.getFloat32()),
							(s.f2 = e.getFloat32()),
	...
	(function (t) {
		class e {
			...
			static loadFromXML(t) {
				e.strings = {};
				for (
					var i = Laya.Utils.parseXMLFromString(t),
						s = e.findChildNode(i, 'resources').childNodes,
						h = s.length,
						r = 0;
					r < h;
					r++
					...
					if (null != s) {
						...
						for (o = 0; o < g; o++) {
							...
							if (p == t.ObjectType.Component && u.version >= 2) {
								...
								for (var m = u.getUint16(), w = 0; w < m; w++) {
									var v = u.readS();
									0 == u.getUint16() &&
									null != (r = s[h + '-cp-' + v])
										? u.writeS(r)
							...
							switch (f) {
								...
								case t.ObjectType.InputText:
									null != (r = s[h]) &&
										(u.seek(d, 6), u.writeS(r)),
										null != (r = s[h + '-prompt']) &&
											(u.seek(d, 4), u.writeS(r));
									break;
	...
	(function (t) {
		class e {
			static setExtension(i, s) {
				...
				null != h && (h.extensionType = s),
					(e.packageItemExtensions[i] = s);
			}
			...
			static resolvePackageItemExtension(t) {
				...
				i ||
					(i =
						e.packageItemExtensions[
							'ui://' + t.owner.name + '/' + t.name
						]),
					i && (t.extensionType = i);
			}
			static newObject(t) {
		...
		class e {
			...
			static addPackage(i, s) {
				if (
					!(
						s ||
						((s = t.AssetProxy.inst.getRes(
							i + '.' + t.UIConfig.packageFileExtension
						)) &&
							0 != s.byteLength)
					)
				)
					throw new Error('namespace sunnyboxs not ready: ' + i);
			...
			static loadPackage(i, s) {
				let h = i + '.' + t.UIConfig.packageFileExtension;
				var r = Laya.Handler.create(this, function (h) {
					let r = new e();
					r.loadPackage(new t.ByteBuffer(h), i);
					let a = r._items.length,
						n = [];
					for (var o = 0; o < a; o++) {
						var l = r._items[o];
						l.type == t.PackageItemType.Atlas
							? n.push({ url: l.file, type: Laya.Loader.IMAGE })
							: l.type == t.PackageItemType.Sound &&
							  n.push({ url: l.file, type: Laya.Loader.SOUND });
					}
					n.length > 0
						? t.AssetProxy.inst.load(
								n,
				...
				t.AssetProxy.inst.load(h, r, null, Laya.Loader.BUFFER);
			}
			static removePackage(t) {
				var i = e._instById[t];
				if ((i || (i = e._instByName[t]), !i))
			...
			loadPackage(s, h) {
				if (1179080009 != s.getUint32())
					throw new Error(
						"FairyGUI: old namespace sunnyboxs found in '" + h + "'"
					);
				s.version = s.getInt32();
				var r = s.version >= 2,
					a = s.readBool();
				if (
					((this._id = s.readUTFString()),
					(this._name = s.readUTFString()),
					s.skip(20),
					a)
				) {
					var n = new Uint8Array(s.buffer, s.pos, s.length - s.pos);
					(n = new Zlib.RawInflate(n).decompress()),
						(s = new t.ByteBuffer(n));
				}
				var o,
					l,
					_,
					...
					c,
					u = s.pos;
				s.seek(u, 4), (o = s.getInt32());
				var g,
					p = [];
				for (l = 0; l < o; l++) p[l] = s.readUTFString();
				for (
					s.stringTable = p, s.seek(u, 0), o = s.getInt16(), l = 0;
					l < o;
					l++
				)
					this._dependencies.push({ id: s.readS(), name: s.readS() });
				for (
					r &&
						((o = s.getInt16()) > 0 &&
							((this._branches = s.readSArray(o)),
							e._branch &&
								(this._branchIndex = this._branches.indexOf(
									e._branch
								))),
						(c = o > 0)),
						s.seek(u, 1),
					...
					switch (
						((_ = s.getInt32()),
						(_ += s.pos),
						((g = new t.PackageItem()).owner = this),
						(g.type = s.readByte()),
						(g.id = s.readS()),
						(g.name = s.readS()),
						s.readS(),
						...
						case t.PackageItemType.Image:
							...
							var f = s.readByte();
							1 == f
								? ((g.scale9Grid = new Laya.Rectangle()),
								  (g.scale9Grid.x = s.getInt32()),
								  (g.scale9Grid.y = s.getInt32()),
								  (g.scale9Grid.width = s.getInt32()),
								  (g.scale9Grid.height = s.getInt32()),
								  (g.tileGridIndice = s.getInt32()))
								: 2 == f && (g.scaleByTile = !0),
								(g.smoothing = s.readBool());
							break;
						case t.PackageItemType.MovieClip:
							(g.smoothing = s.readBool()),
								(g.objectType = t.ObjectType.MovieClip),
								(g.rawData = s.readBuffer());
							break;
						...
						case t.PackageItemType.Component:
							var y = s.readByte();
							(g.objectType = y > 0 ? y : t.ObjectType.Component),
								(g.rawData = s.readBuffer()),
								t.UIObjectFactory.resolvePackageItemExtension(
									g
								);
							break;
					...
					if (r) {
						(d = s.readS()) && (g.name = d + '/' + g.name);
						var m = s.getUint8();
						m > 0 &&
							(c
								? (g.branches = s.readSArray(m))
								: (this._itemsById[s.readS()] = g));
						var w = s.getUint8();
						w > 0 && (g.highResolution = s.readSArray(w));
					}
					this._items.push(g),
						(this._itemsById[g.id] = g),
						null != g.name && (this._itemsByName[g.name] = g),
						(s.pos = _);
				}
				for (s.seek(u, 2), o = s.getUint16(), l = 0; l < o; l++) {
					(_ = s.getUint16()), (_ += s.pos);
					var v = s.readS();
					g = this._itemsById[s.readS()];
					var C = new i();
					(C.atlas = g),
						(C.rect.x = s.getInt32()),
						(C.rect.y = s.getInt32()),
						(C.rect.width = s.getInt32()),
						(C.rect.height = s.getInt32()),
						(C.rotated = s.readBool()),
						r && s.readBool()
							? ((C.offset.x = s.getInt32()),
							  (C.offset.y = s.getInt32()),
							  (C.originalSize.x = s.getInt32()),
							  (C.originalSize.y = s.getInt32()))
							: ((C.originalSize.x = C.rect.width),
							  (C.originalSize.y = C.rect.height)),
						(this._sprites[v] = C),
						(s.pos = _);
				}
				if (s.seek(u, 3))
					for (o = s.getUint16(), l = 0; l < o; l++)
						(_ = s.getInt32()),
							(_ += s.pos),
							(g = this._itemsById[s.readS()]) &&
								g.type == t.PackageItemType.Image &&
								((g.pixelHitTestData =
									new t.PixelHitTestData()),
								g.pixelHitTestData.load(s)),
							(s.pos = _);
			}
			loadAllAssets() {
				for (var t = this._items.length, e = 0; e < t; e++) {
			...
			unloadAssets() {
				for (var e = this._items.length, i = 0; i < e; i++) {
					var s = this._items[i];
					s.type == t.PackageItemType.Atlas &&
						null != s.texture &&
						Laya.loader.clearTextureRes(s.texture.url);
				}
			}
			dispose() {
				for (var e = this._items.length, i = 0; i < e; i++) {
					...
					s.type == t.PackageItemType.Atlas
						? null != s.texture &&
						  (s.texture.destroy(), (s.texture = null))
						: s.type == t.PackageItemType.Sound &&
						  Laya.SoundManager.destroySound(s.file);
				}
			}
			get id() {
				return this._id;
			...
			set customId(t) {
				null != this._customId && delete e._instById[this._customId],
					(this._customId = t),
					null != this._customId &&
						(e._instById[this._customId] = this);
			}
			createObject(t, e) {
			...
			internalCreateObject(i, s) {
				...
				return null ==
					(h =
						i.type == t.PackageItemType.Component && s
							? new s()
							: t.UIObjectFactory.newObject(i))
					? null
					: (e._constructing++,
					  (h.packageItem = i),
				...
				switch (e.type) {
					...
					case t.PackageItemType.Atlas:
						return (
							e.decoded ||
								((e.decoded = !0),
								(e.texture = t.AssetProxy.inst.getRes(e.file))),
							e.texture
						);
					case t.PackageItemType.Font:
						return (
					...
					case t.PackageItemType.MovieClip:
						return (
							e.decoded ||
								((e.decoded = !0), this.loadMovieClip(e)),
							e.frames
						);
					case t.PackageItemType.Component:
						return e.rawData;
			...
			loadMovieClip(e) {
				var i = e.rawData;
				i.seek(0, 0),
					(e.interval = i.getInt32()),
					(e.swing = i.readBool()),
					(e.repeatDelay = i.getInt32()),
					i.seek(0, 1);
				var s,
					h,
					r,
				...
				for (var l = 0; l < o; l++) {
					...
					if (
						...
						i.getInt32(),
						i.getInt32(),
						(h.addDelay = i.getInt32()),
						null != (s = i.readS()) &&
							null != (r = this._sprites[s]))
					) {
						var d = this.getItemAsset(r.atlas);
						h.texture = Laya.Texture.create(
							d,
							r.rect.x,
							r.rect.y,
							r.rect.width,
			...
			loadFont(e) {
				...
				var h,
					...
					n = s.getInt32(),
					o = null,
					l = this._sprites[e.id];
				null != l && (o = this.getItemAsset(l.atlas)), s.seek(0, 1);
				for (var _ = null, d = s.getInt32(), c = 0; c < d; c++) {
					var u = s.getInt16();
					(u += s.pos), (_ = new t.BMGlyph());
					var g = s.readChar();
					i.glyphs[g] = _;
					var p = s.readS(),
						f = s.getInt32(),
					...
					if (
						...
						(h = s.getInt32()),
						(r = s.getInt32()),
						(_.advance = s.getInt32()),
						(_.channel = s.readByte()),
						1 == _.channel
							? (_.channel = 3)
							: 2 == _.channel
							? (_.channel = 2)
							: 3 == _.channel && (_.channel = 1),
						i.ttf)
					)
						(_.texture = Laya.Texture.create(
							o,
							f + l.rect.x,
							y + l.rect.y,
							h,
						...
						var m = this._itemsById[p];
						m &&
							((h = (m = m.getBranch()).width),
							(r = m.height),
							(m = m.getHighResolution()),
							this.getItemAsset(m),
							(_.texture = m.texture)),
							0 == _.advance &&
								(_.advance = 0 == a ? _.x + h : a),
							(_.lineHeight = _.y < 0 ? r : _.y + r),
							_.lineHeight < i.size && (_.lineHeight = i.size);
					}
					(_.xMax = _.x + h), (_.yMax = _.y + r), (s.pos = u);
				}
			}
		}
		(e._constructing = 0),
		...
		t.Window = class extends t.GComponent {
			constructor() {
				super(),
					...
					(this.focusable = !0),
					(this._uiSources = []),
					(this.bringToFontOnClick =
						t.UIConfig.bringWindowToFrontOnClick),
					this.displayObject.on(
						Laya.Event.DISPLAY,
						this,
						this.__onShown
			...
			set contentPane(e) {
				this._contentPane != e &&
					(null != this._contentPane &&
						this.removeChild(this._contentPane),
					(this._contentPane = e),
					null != this._contentPane &&
						(this.addChild(this._contentPane),
						this.setSize(
							this._contentPane.width,
							this._contentPane.height
						),
						this._contentPane.addRelation(
							this,
							t.RelationType.Size
						...
						null != this._frame &&
							((this.closeButton =
								this._frame.getChild('closeButton')),
							(this.dragArea = this._frame.getChild('dragArea')),
							(this.contentArea =
								this._frame.getChild('contentArea')))));
			}
			get contentPane() {
				return this._contentPane;
			}
			...
			set dragArea(e) {
				this._dragArea != e &&
					...
					(this._dragArea = e),
					null != this._dragArea &&
						(this._dragArea instanceof t.GGraph &&
			...
			centerOn(e, i = !1) {
				this.setXY(
					Math.round((e.width - this.width) / 2),
					Math.round((e.height - this.height) / 2)
				),
					i &&
			...
			showModalWait(e = 0) {
				0 != e && (this._requestingCmd = e),
					t.UIConfig.windowModalWaiting &&
						(this._modalWaitPane ||
							(this._modalWaitPane =
				...
				if (null != this._contentArea) {
					...
					(t = this.globalToLocal(t.x, t.y, t)),
						this._modalWaitPane.setXY(
							t.x + this._contentArea.x,
							t.y + this._contentArea.y
						),
						this._modalWaitPane.setSize(
							this._contentArea.width,
							this._contentArea.height
						);
				} else this._modalWaitPane.setSize(this.width, this.height);
			}
			closeModalWait(t = 0) {
				return (
					(0 == t || this._requestingCmd == t) &&
					((this._requestingCmd = 0),
					this._modalWaitPane &&
						null != this._modalWaitPane.parent &&
						this.removeChild(this._modalWaitPane),
			...
			get modalWaiting() {
				return (
					this._modalWaitPane && null != this._modalWaitPane.parent
				);
			}
			init() {
				if (!this._inited && !this._loading)
					if (this._uiSources.length > 0) {
						this._loading = !1;
						for (
							var t = this._uiSources.length, e = 0;
							e < t;
							e++
						) {
			...
			dispose() {
				null != this.parent && this.hideImmediately(), super.dispose();
			}
			closeEventHandler() {
				this.hide();
			}
	...
	(function (t) {
		t.ControllerAction = class {
			...
			run(t, e, i) {
				(null != this.fromPage &&
					0 != this.fromPage.length &&
					-1 == this.fromPage.indexOf(e)) ||
				(null != this.toPage &&
					0 != this.toPage.length &&
					-1 == this.toPage.indexOf(i))
					? this.leave(t)
					: this.enter(t);
			}
			enter(t) {}
		...
		t.ChangePageAction = class extends t.ControllerAction {
			...
			enter(t) {
				...
				if (
					this.controllerName &&
					(e = this.objectId
						? t.parent.getChildById(this.objectId)
						: t.parent)
				) {
					...
					i &&
						...
						!i.changing &&
						('~1' == this.targetPage
							? t.selectedIndex < i.pageCount &&
							  (i.selectedIndex = t.selectedIndex)
							: '~2' == this.targetPage
							? (i.selectedPage = t.selectedPage)
							: (i.selectedPageId = this.targetPage));
				}
			}
			setup(t) {
				super.setup(t),
	...
	(function (t) {
		t.PlayTransitionAction = class extends t.ControllerAction {
			...
			enter(t) {
				...
				e &&
					(this._currentTransition && this._currentTransition.playing
						? e.changePlayTimes(this.playTimes)
						: e.play(null, this.playTimes, this.delay),
	...
	(function (t) {
		class e {
			static fill(i, s, h, r, a, n) {
				if (n <= 0) return null;
				if (n >= 0.9999) return [0, 0, i, 0, i, s, 0, s];
				var o;
				switch (h) {
					case t.FillMethod.Horizontal:
						o = e.fillHorizontal(i, s, r, n);
						break;
					case t.FillMethod.Vertical:
						o = e.fillVertical(i, s, r, n);
						break;
					case t.FillMethod.Radial90:
						o = e.fillRadial90(i, s, r, a, n);
						break;
					case t.FillMethod.Radial180:
						o = e.fillRadial180(i, s, r, a, n);
						break;
					case t.FillMethod.Radial360:
						o = e.fillRadial360(i, s, r, a, n);
				}
				return o;
			}
			static fillHorizontal(e, i, s, h) {
				var r = e * h;
				return s == t.FillOrigin.Left || s == t.FillOrigin.Top
					? [0, 0, r, 0, r, i, 0, i]
					: [e, 0, e, i, e - r, i, e - r, 0];
			}
			static fillVertical(e, i, s, h) {
				var r = i * h;
				return s == t.FillOrigin.Left || s == t.FillOrigin.Top
					? [0, 0, 0, r, e, r, e, 0]
					: [0, i, e, i, e, i - r, 0, i - r];
			}
			static fillRadial90(e, i, s, h, r) {
				var a, n, o;
				switch (
					(((!h ||
						(s != t.FillOrigin.TopRight &&
							s != t.FillOrigin.BottomLeft)) &&
						(h ||
							(s != t.FillOrigin.TopLeft &&
								s != t.FillOrigin.BottomRight))) ||
						(r = 1 - r),
			...
			static movePoints(t, e, i) {
				for (var s = t.length, h = 0; h < s; h += 2)
					(t[h] += e), (t[h + 1] += i);
			}
			static fillRadial180(i, s, h, r, a) {
				var n;
				switch (h) {
						...
						a <= 0.5
							? ((a /= 0.5),
							  (n = e.fillRadial90(
									...
									s,
									r
										? t.FillOrigin.TopLeft
										: t.FillOrigin.TopRight,
									r,
									a
							  )),
							  r && e.movePoints(n, i / 2, 0))
							: ((a = (a - 0.5) / 0.5),
							  (n = e.fillRadial90(
									i / 2,
									s,
						...
						a <= 0.5
							? ((a /= 0.5),
							  (n = e.fillRadial90(
									...
									s,
									r
										? t.FillOrigin.BottomRight
										: t.FillOrigin.BottomLeft,
									r,
									a
							  )),
							  r || e.movePoints(n, i / 2, 0))
			...
			static fillRadial360(i, s, h, r, a) {
				var n;
				switch (h) {
					case t.FillOrigin.Top:
						a <= 0.5
							? ((a /= 0.5),
							  (n = e.fillRadial180(
									i / 2,
									s,
									r ? t.FillOrigin.Left : t.FillOrigin.Right,
									r,
									a
							  )),
							  r && e.movePoints(n, i / 2, 0))
							: ((a = (a - 0.5) / 0.5),
							  (n = e.fillRadial180(
									i / 2,
									s,
									r ? t.FillOrigin.Right : t.FillOrigin.Left,
									r,
									a
							  )),
							  r
									? n.push(i, s, i, 0, i / 2, 0)
									: (e.movePoints(n, i / 2, 0),
									  n.push(0, s, 0, 0, i / 2, 0)));
						break;
					case t.FillOrigin.Bottom:
						a <= 0.5
							? ((a /= 0.5),
							...
							: ((a = (a - 0.5) / 0.5),
							  ...
							  r
									? (e.movePoints(n, i / 2, 0),
									  n.push(0, 0, 0, s, i / 2, s))
									: n.push(i, 0, i, s, i / 2, s));
						break;
					case t.FillOrigin.Left:
						a <= 0.5
							? ((a /= 0.5),
							  (n = e.fillRadial180(
									i,
									s / 2,
									r ? t.FillOrigin.Bottom : t.FillOrigin.Top,
									r,
									a
							  )),
							  r || e.movePoints(n, 0, s / 2))
							: ((a = (a - 0.5) / 0.5),
							  (n = e.fillRadial180(
									i,
									s / 2,
									r ? t.FillOrigin.Top : t.FillOrigin.Bottom,
									r,
									a
							  )),
							  r
									? (e.movePoints(n, 0, s / 2),
									  n.push(i, 0, 0, 0, 0, s / 2))
									: n.push(i, s, 0, s, 0, s / 2));
						break;
					case t.FillOrigin.Right:
						a <= 0.5
							? ((a /= 0.5),
							...
							: ((a = (a - 0.5) / 0.5),
							  ...
							  r
									? n.push(0, s, i, s, i, s / 2)
									: (e.movePoints(n, 0, s / 2),
									  n.push(0, 0, i, 0, i, s / 2)));
				}
				return n;
			}
		}
	...
	(function (t) {
		t.Image = class extends Laya.Sprite {
			...
			set height(t) {
				this._height !== t &&
					(super.set_height(t), this.markChanged(1));
			}
			get texture() {
				return this._source;
			}
			...
			set scaleByTile(t) {
				this._scaleByTile != t &&
					((this._scaleByTile = t), this.markChanged(1));
			}
			get tileGridIndice() {
				return this._tileGridIndice;
			}
			set tileGridIndice(t) {
				this._tileGridIndice != t &&
					((this._tileGridIndice = t), this.markChanged(1));
			}
			get fillMethod() {
				...
				this._fillMethod != t &&
					...
					0 != this._fillMethod
						? (this._mask ||
						  ...
						  this.markChanged(2))
						: this.mask &&
						  (this._mask.graphics.clear(), (this.mask = null)));
			}
			get fillOrigin() {
			...
			set color(e) {
				this._color != e &&
					((this._color = e), t.ToolSet.setColorFilter(this, e));
			}
			markChanged(t) {
				this._needRebuild
					? (this._needRebuild |= t)
			...
			doDraw() {
				var t = this._width,
					...
					i = this.graphics,
					s = this._source;
				if ((i.clear(), null != s && 0 != t && 0 != e))
					if (this._scaleByTile) i.fillTexture(s, 0, 0, t, e);
			...
			doFill() {
				...
				if ((s.clear(), 0 != e && 0 != i)) {
					...
					if (null == h)
						return (
							(this.mask = null), void (this.mask = this._mask)
						);
	...
	(function (t) {
		(t.MovieClip = class extends t.Image {
			...
			setPlaySettings(t = 0, e = -1, i = 0, s = -1, h = null) {
				(this._start = t),
					(this._end = e),
					(-1 == this._end || this._end > this._frameCount - 1) &&
						(this._end = this._frameCount - 1),
					(this._times = i),
					(this._endAt = s),
			...
			checkTimer() {
				this._playing && this._frameCount > 0 && null != this.stage
	...
	(function (t) {
		class e {
			...
			dispose() {
				null != this._tweenConfig &&
					null != this._tweenConfig._tweener &&
			...
			set controller(t) {
				t != this._controller &&
					((this._controller = t), this._controller && this.init());
			}
			get tweenConfig() {
				return (
			...
			setup(e) {
				var s, h;
				(this._controller = this._owner.parent.getControllerAt(
					e.getInt16()
				)),
					this.init();
				var r = e.getInt16();
				if (this instanceof t.GearDisplay) this.pages = e.readSArray(r);
				...
				e.readBool() &&
					...
					e.version >= 2 &&
						(this instanceof t.GearXY
							? (this.positionsInPercent = e.readBool())
							: this instanceof t.GearDisplay2 &&
							  (this.condition = e.readByte()));
			}
	...
	(function (t) {
		t.GearAnimation = class extends t.GearBase {
			...
			init() {
				(this._default = new e(
					this._owner.getProp(t.ObjectPropID.Playing),
					this._owner.getProp(t.ObjectPropID.Frame)
				)),
					(this._storage = {});
			}
			addStatus(t, i) {
			...
			updateState() {
				var i = this._storage[this._controller.selectedPageId];
				i ||
					((i = new e()),
					(this._storage[this._controller.selectedPageId] = i)),
					(i.playing = this._owner.getProp(t.ObjectPropID.Playing)),
					(i.frame = this._owner.getProp(t.ObjectPropID.Frame));
			}
		};
		class e {
			constructor(t = !0, e = 0) {
	...
	(function (t) {
		t.GearColor = class extends t.GearBase {
			...
			init() {
				(this._default = new e(
					this._owner.getProp(t.ObjectPropID.Color),
					this._owner.getProp(t.ObjectPropID.OutlineColor)
				)),
					(this._storage = {});
			}
			addStatus(t, i) {
				...
				null == t
					? (s = this._default)
					: ((s = new e()), (this._storage[t] = s)),
					(s.color = i.readColorS()),
					(s.strokeColor = i.readColorS());
			}
			apply() {
				this._owner._gearLocked = !0;
				var e = this._storage[this._controller.selectedPageId];
			...
			updateState() {
				...
				i ||
					((i = new e(null, null)),
					(this._storage[this._controller.selectedPageId] = i)),
					(i.color = this._owner.getProp(t.ObjectPropID.Color)),
					(i.strokeColor = this._owner.getProp(
						t.ObjectPropID.OutlineColor
					));
			}
		};
		class e {
			constructor(t = null, e = null) {
				(this.color = t), (this.strokeColor = e);
			}
		}
	})(fgui || (fgui = {})),
	(function (t) {
		t.GearDisplay = class extends t.GearBase {
			...
			apply() {
				this._displayLockToken++,
					this._displayLockToken <= 0 && (this._displayLockToken = 1),
					null == this.pages ||
					0 == this.pages.length ||
					-1 != this.pages.indexOf(this._controller.selectedPageId)
						? (this._visible = 1)
						: (this._visible = 0);
			}
		};
	...
	(function (t) {
		t.GearFontSize = class extends t.GearBase {
			...
			addStatus(t, e) {
				null == t
					? (this._default = e.getInt32())
					: (this._storage[t] = e.getInt32());
			}
			apply() {
				this._owner._gearLocked = !0;
				var e = this._storage[this._controller.selectedPageId];
				null != e
					? this._owner.setProp(t.ObjectPropID.FontSize, e)
					: this._owner.setProp(
							t.ObjectPropID.FontSize,
							this._default
					  ),
					(this._owner._gearLocked = !1);
			}
	...
	(function (t) {
		t.GearIcon = class extends t.GearBase {
			...
			addStatus(t, e) {
				null == t
					? (this._default = e.readS())
					: (this._storage[t] = e.readS());
			}
			apply() {
				this._owner._gearLocked = !0;
	...
	(function (t) {
		t.GearLook = class extends t.GearBase {
			...
			init() {
				(this._default = new e(
					this._owner.alpha,
					this._owner.rotation,
					this._owner.grayed,
					this._owner.touchable
				)),
					(this._storage = {});
			}
			addStatus(t, i) {
				...
				null == t
					? (s = this._default)
					: ((s = new e()), (this._storage[t] = s)),
					(s.alpha = i.getFloat32()),
					(s.rotation = i.getFloat32()),
					(s.grayed = i.readBool()),
					(s.touchable = i.readBool());
			}
			apply() {
				var e = this._storage[this._controller.selectedPageId];
				if (
					(e || (e = this._default),
					null == this._tweenConfig ||
						!this._tweenConfig.tween ||
						t.UIPackage._constructing ||
						t.GearBase.disableAllTweenEffect)
				)
					(this._owner._gearLocked = !0),
					...
					if (
						...
						if (
							this._tweenConfig._tweener.endValue.x == e.alpha &&
							this._tweenConfig._tweener.endValue.y == e.rotation
						)
							return;
					...
					(i || s) &&
						(this._owner.checkGearController(0, this._controller) &&
							(this._tweenConfig._displayLockToken =
								this._owner.addDisplayLock()),
						(this._tweenConfig._tweener = t.GTween.to2(
							this._owner.alpha,
							this._owner.rotation,
							e.alpha,
							e.rotation,
							this._tweenConfig.duration
						)
							.setDelay(this._tweenConfig.delay)
							.setEase(this._tweenConfig.easeType)
							.setUserData((i ? 1 : 0) + (s ? 2 : 0))
							.setTarget(this)
			...
			__tweenComplete() {
				0 != this._tweenConfig._displayLockToken &&
					(this._owner.releaseDisplayLock(
						this._tweenConfig._displayLockToken
					),
		...
		t.GearSize = class extends t.GearBase {
			...
			addStatus(t, i) {
				...
				null == t
					...
					(s.width = i.getInt32()),
					(s.height = i.getInt32()),
					(s.scaleX = i.getFloat32()),
					(s.scaleY = i.getFloat32());
			}
			apply() {
				var e = this._storage[this._controller.selectedPageId];
				if (
					...
					(this._owner._gearLocked = !0),
						this._owner.setSize(
							e.width,
							e.height,
							this._owner.checkGearController(1, this._controller)
						),
					...
					if (null != this._tweenConfig._tweener) {
						if (
							this._tweenConfig._tweener.endValue.x == e.width &&
							this._tweenConfig._tweener.endValue.y == e.height &&
							this._tweenConfig._tweener.endValue.z == e.scaleX &&
							this._tweenConfig._tweener.endValue.w == e.scaleY
						)
							return;
						this._tweenConfig._tweener.kill(!0),
							(this._tweenConfig._tweener = null);
					...
					var i =
							e.width != this._owner.width ||
							e.height != this._owner.height,
						s =
							e.scaleX != this._owner.scaleX ||
							e.scaleY != this._owner.scaleY;
					(i || s) &&
						(this._owner.checkGearController(0, this._controller) &&
							(this._tweenConfig._displayLockToken =
								this._owner.addDisplayLock()),
						(this._tweenConfig._tweener = t.GTween.to4(
							this._owner.width,
							this._owner.height,
							this._owner.scaleX,
							this._owner.scaleY,
		...
		t.GearXY = class extends t.GearBase {
			...
			addStatus(t, e) {
				...
				null == t
					...
					(i.y = e.getInt32()),
					e.version >= 2
						? ((i.px = e.getFloat32()), (i.py = e.getFloat32()))
						: ((i.px = i.x / this._owner.parent.width),
						  (i.py = i.y / this._owner.parent.height));
			}
			apply() {
				var e,
					i,
				...
				if (
					(s || (s = this._default),
					this.positionsInPercent && this._owner.parent
						? ((e = s.px * this._owner.parent.width),
						  (i = s.py * this._owner.parent.height))
						: ((e = s.x), (i = s.y)),
					null == this._tweenConfig ||
						!this._tweenConfig.tween ||
						t.UIPackage._constructing ||
					...
					if (null != this._tweenConfig._tweener) {
						if (
							this._tweenConfig._tweener.endValue.x == e &&
							this._tweenConfig._tweener.endValue.y == i
						)
							return;
						this._tweenConfig._tweener.kill(!0),
							(this._tweenConfig._tweener = null);
	...
	(function (t) {
		class e {
			static evaluate(s, h, r, a, n) {
				switch (s) {
					case t.EaseType.Linear:
						return h / r;
					case t.EaseType.SineIn:
						return 1 - Math.cos((h / r) * e._PiOver2);
					case t.EaseType.SineOut:
						return Math.sin((h / r) * e._PiOver2);
					case t.EaseType.SineInOut:
						return -0.5 * (Math.cos((Math.PI * h) / r) - 1);
					...
					case t.EaseType.ElasticIn:
						...
						return 0 == h
							...
							: (0 == n && (n = 0.3 * r),
							  a < 1
									? ((a = 1), (o = n / 4))
									: (o = (n / e._TwoPi) * Math.asin(1 / a)),
							  -a *
									Math.pow(2, 10 * (h -= 1)) *
									Math.sin(((h * r - o) * e._TwoPi) / n));
					case t.EaseType.ElasticOut:
						...
						return 0 == h
							...
							: (0 == n && (n = 0.3 * r),
							  a < 1
									? ((a = 1), (l = n / 4))
									: (l = (n / e._TwoPi) * Math.asin(1 / a)),
							  a *
									Math.pow(2, -10 * h) *
									Math.sin(((h * r - l) * e._TwoPi) / n) +
									1);
					case t.EaseType.ElasticInOut:
						...
						return 0 == h
							...
							: (0 == n && (n = r * (0.3 * 1.5)),
							  a < 1
									? ((a = 1), (_ = n / 4))
									: (_ = (n / e._TwoPi) * Math.asin(1 / a)),
							  h < 1
									? a *
									  Math.pow(2, 10 * (h -= 1)) *
									  Math.sin(((h * r - _) * e._TwoPi) / n) *
									  -0.5
									: a *
											Math.pow(2, -10 * (h -= 1)) *
											Math.sin(
					...
					case t.EaseType.BounceOut:
						return i.easeOut(h, r);
					case t.EaseType.BounceInOut:
						return i.easeInOut(h, r);
					default:
						return -(h /= r) * (h - 2);
				}
			}
		}
		(e._PiOver2 = 0.5 * Math.PI),
			(e._TwoPi = 2 * Math.PI),
			(t.EaseManager = e);
		class i {
			static easeIn(t, e) {
				return 1 - i.easeOut(e - t, e);
			}
			static easeOut(t, e) {
				return (t /= e) < 1 / 2.75
					? 7.5625 * t * t
			...
			static easeInOut(t, e) {
				return t < 0.5 * e
					? 0.5 * i.easeIn(2 * t, e)
					: 0.5 * i.easeOut(2 * t - e, e) + 0.5;
			}
		}
	})(fgui || (fgui = {})),
	(function (t) {
	...
	(function (t) {
		class e {
			...
			create(s) {
				...
				var h = s.length;
				if (0 != h) {
					var r = e.helperPoints;
					r.length = 0;
					var a = s[0];
					a.curveType == t.CurveType.CRSpline &&
						r.push(new Laya.Point(a.x, a.y));
					for (var n = 1; n < h; n++) {
						var o = s[n];
						if (a.curveType != t.CurveType.CRSpline) {
							var l = new i();
							(l.type = a.curveType),
								(l.ptStart = this._points.length),
								a.curveType == t.CurveType.Straight
									? ((l.ptCount = 2),
									  this._points.push(
											new Laya.Point(a.x, a.y)
									  ),
									  this._points.push(
											new Laya.Point(o.x, o.y)
									  ))
									: a.curveType == t.CurveType.Bezier
									? ((l.ptCount = 3),
									  this._points.push(
											new Laya.Point(a.x, a.y)
									  ),
									...
									: a.curveType == t.CurveType.CubicBezier &&
									  ((l.ptCount = 4),
									  this._points.push(
											new Laya.Point(a.x, a.y)
									  ),
								...
								(l.length = t.ToolSet.distance(
									a.x,
									a.y,
									o.x,
									o.y
								)),
								(this._fullLength += l.length),
								this._segments.push(l);
						}
						o.curveType != t.CurveType.CRSpline
							? r.length > 0 &&
							  (r.push(new Laya.Point(o.x, o.y)),
							  this.createSplineSegment())
							: r.push(new Laya.Point(o.x, o.y)),
							(a = o);
					}
					r.length > 1 && this.createSplineSegment();
				}
			}
			createSplineSegment() {
				var s = e.helperPoints,
					h = s.length;
				s.splice(0, 0, s[0]), s.push(s[h]), s.push(s[h]), (h += 3);
				var r = new i();
				(r.type = t.CurveType.CRSpline),
					(r.ptStart = this._points.length),
					(r.ptCount = h),
					(this._points = this._points.concat(s)),
					(r.length = 0);
				for (var a = 1; a < h; a++)
					r.length += t.ToolSet.distance(
						s[a - 1].x,
						s[a - 1].y,
						s[a].x,
						s[a].y
					);
				(this._fullLength += r.length),
					this._segments.push(r),
					(s.length = 0);
			}
			clear() {
			...
			getPointAt(e, i) {
				i ? i.setTo(0, 0) : (i = new Laya.Point()),
					(e = t.ToolSet.clamp01(e));
				var s,
					h = this._segments.length;
				if (0 == h) return i;
				if (1 == e)
					return (s = this._segments[h - 1]).type ==
						t.CurveType.Straight
						? ((i.x = t.ToolSet.lerp(
								this._points[s.ptStart].x,
								this._points[s.ptStart + 1].x,
								e
						  )),
						  (i.y = t.ToolSet.lerp(
								this._points[s.ptStart].y,
								this._points[s.ptStart + 1].y,
								e
						  )),
						  i)
						: s.type == t.CurveType.Bezier ||
						  s.type == t.CurveType.CubicBezier
						? this.onBezierCurve(s.ptStart, s.ptCount, e, i)
						: this.onCRSplineCurve(s.ptStart, s.ptCount, e, i);
				for (var r = e * this._fullLength, a = 0; a < h; a++)
					if ((r -= (s = this._segments[a]).length) < 0) {
						(e = 1 + r / s.length),
							s.type == t.CurveType.Straight
								? ((i.x = t.ToolSet.lerp(
										this._points[s.ptStart].x,
										this._points[s.ptStart + 1].x,
										e
			...
			getAnchorsInSegment(t, e) {
				...
				for (var i = this._segments[t], s = 0; s < i.ptCount; s++)
					e.push(
						new Laya.Point(
							this._points[i.ptStart + s].x,
							this._points[i.ptStart + s].y
						)
					);
				return e;
			}
			getPointsInSegment(e, i, s, h, r, a) {
				...
				if (n.type == t.CurveType.Straight)
					h.push(
						new Laya.Point(
							t.ToolSet.lerp(
								this._points[n.ptStart].x,
								this._points[n.ptStart + 1].x,
								i
							),
							t.ToolSet.lerp(
								this._points[n.ptStart].y,
								this._points[n.ptStart + 1].y,
								i
							)
						)
					),
					...
					var o;
					(o =
						n.type == t.CurveType.Bezier ||
						n.type == t.CurveType.CubicBezier
							? this.onBezierCurve
							: this.onCRSplineCurve),
						h.push(
							o.call(
					...
					for (
						var l = Math.min(n.length * a, 50), _ = 0;
						_ <= l;
						_++
					) {
						var d = _ / l;
					...
					h.push(
						o.call(this, n.ptStart, n.ptCount, s, new Laya.Point())
					);
				}
				return null != r && r.push(s), h;
			}
			getAllPoints(t, e, i) {
				null == t && (t = new Array()), (i && !isNaN(i)) || (i = 0.1);
	...
	(function (t) {
		class e {
			...
			static to4(e, i, s, h, r, a, n, o, l) {
				return t.TweenManager.createTween()._to4(
					e,
					i,
					s,
					h,
	...
	(function (t) {
		class e {
			...
			onComplete(t, e) {
				return (
					(this._onComplete = t), (this._onCompleteCaller = e), this
				);
			}
			get startValue() {
				...
				this._killed ||
					(t &&
						(0 == this._ended &&
							(this._breakpoint >= 0
								? (this._elapsedTime =
										this._delay + this._breakpoint)
								: this._repeat >= 0
								? (this._elapsedTime =
										this._delay +
										this._duration * (this._repeat + 1))
								: (this._elapsedTime =
										this._delay + 2 * this._duration),
							this.update()),
			...
			_reset() {
				(this._target = null),
					...
					(this._onStartCaller =
						this._onUpdateCaller =
						this._onCompleteCaller =
							null);
			}
			_update(t) {
			...
			update() {
				if (((this._ended = 0), 0 != this._valueSize)) {
					...
					if (
						(this._breakpoint >= 0 &&
							s >= this._breakpoint &&
							((s = this._breakpoint), (this._ended = 2)),
						0 != this._repeat)
					) {
					...
					if (
						((this._normalizedTime = t.EaseManager.evaluate(
							this._easeType,
							i ? this._duration - s : s,
							this._duration,
						...
						if (0 == this._ended) {
							var r =
									this._startValue.w *
									(1 - this._normalizedTime),
								a = r * (Math.random() > 0.5 ? 1 : -1),
						...
						for (var l = 0; l < this._valueSize; l++) {
							var _ = this._startValue.getField(l),
								d =
									_ +
									(this._endValue.getField(l) - _) *
										this._normalizedTime;
							this._snapping && (d = Math.round(d)),
								this._deltaValue.setField(
									l,
									d - this._value.getField(l)
								),
								this._value.setField(l, d);
						}
					if (null != this._target && this._propType)
						if (this._propType instanceof Function)
							...
							5 == this._valueSize
								? (this._target[this._propType] =
										this._value.color)
								: (this._target[this._propType] =
										this._value.x);
					this.callUpdateCallback();
				} else
					this._elapsedTime >= this._delay + this._duration &&
						(this._ended = 1);
			}
			callStartCallback() {
			...
			callUpdateCallback() {
				if (null != this._onUpdate)
					try {
						...
						console.log(
							'FairyGUI: error in update callback > ' + t
						);
					}
			}
			callCompleteCallback() {
				if (null != this._onComplete)
					try {
						...
						console.log(
							'FairyGUI: error in complete callback > ' + t
						);
					}
			}
		}
	...
	(function (t) {
		class e {
			static createTween() {
				...
				return (
					e._inited ||
						(Laya.timer.frameLoop(1, null, e.update),
						(e._inited = !0)),
					(i =
						e._tweenerPool.length > 0
							? e._tweenerPool.pop()
							: new t.GTweener())._init(),
					(e._activeTweens[e._totalActiveTweens++] = i),
					i
				);
			}
			static isTweening(t, i) {
				if (null == t) return !1;
				for (var s = !i, h = 0; h < e._totalActiveTweens; h++) {
					var r = e._activeTweens[h];
					if (
						null != r &&
						r.target == t &&
						!r._killed &&
			...
			static killTweens(t, i, s) {
				if (null == t) return !1;
				for (
					var h = !1, r = e._totalActiveTweens, a = !s, n = 0;
					n < r;
					n++
				) {
					var o = e._activeTweens[n];
					null == o ||
						o.target != t ||
						o._killed ||
						(!a && o._propType != s) ||
			...
			static getTween(t, i) {
				if (null == t) return null;
				for (var s = e._totalActiveTweens, h = !i, r = 0; r < s; r++) {
					var a = e._activeTweens[r];
					if (
						null != a &&
						a.target == t &&
						!a._killed &&
			...
			static update() {
				for (
					var i = Laya.timer.delta / 1e3,
						s = e._totalActiveTweens,
						h = -1,
						r = 0;
					r < s;
					r++
					...
					null == a
						...
						: a._killed
						? (a._reset(),
						  e._tweenerPool.push(a),
						  (e._activeTweens[r] = null),
						  -1 == h && (h = r))
						: (a._target instanceof t.GObject &&
						  a._target.isDisposed
								? (a._killed = !0)
								: a._paused || a._update(i),
						  -1 != h &&
								((e._activeTweens[h] = a),
								(e._activeTweens[r] = null),
								h++));
				...
				if (h >= 0) {
					if (e._totalActiveTweens != s) {
						var n = s;
						for (s = e._totalActiveTweens - s, r = 0; r < s; r++)
							e._activeTweens[h++] = e._activeTweens[n++];
					}
					e._totalActiveTweens = h;
				}
			}
		}
		(e._activeTweens = new Array()),
			(e._tweenerPool = []),
			(e._totalActiveTweens = 0),
			(e._inited = !1),
			(t.TweenManager = e);
	})(fgui || (fgui = {})),
	((fgui || (fgui = {})).TweenValue = class {
		constructor() {
		...
		class e extends Laya.Byte {
			...
			seek(t, e) {
				...
				return (
					...
					e < this.getUint8()
						? (1 == this.getUint8()
								? ((this.pos += 2 * e), (i = this.getUint16()))
								: ((this.pos += 4 * e), (i = this.getUint32())),
						  i > 0
								? ((this.pos = t + i), !0)
								: ((this.pos = s), !1))
						: ((this.pos = s), !1)
		...
		t.ChildHitArea = class extends Laya.HitArea {
			constructor(t, e) {
				super(),
					...
					(this._reversed = e),
					this._reversed
						? (this.unHit = t.hitArea.hit)
						: (this.hit = t.hitArea.hit);
			}
			contains(t, i) {
				var s;
				return (
					(s = Laya.Point.TEMP).setTo(0, 0),
					(s = this._child.toParentPoint(s)),
					this._reversed
						? !e(t - s.x, i - s.y, this.unHit)
						: e(t - s.x, i - s.y, this.hit)
				);
			}
		};
	})(fgui || (fgui = {})),
	(function (t) {
		(t.PixelHitTest = class extends Laya.HitArea {
			...
			contains(t, e) {
				if (
					((t = Math.floor(
						(t / this.scaleX - this.offsetX) * this._data.scale
					)),
					(e = Math.floor(
						(e / this.scaleY - this.offsetY) * this._data.scale
					)),
				...
				return (
					s >= 0 &&
					s < this._data.pixels.length &&
					1 == ((this._data.pixels[s] >> h) & 1)
				);
			}
		}),
		...
		class e {
			...
			onTag_URL(t, e, i) {
				return e
					...
					: '<a href="' + this.getTagText() + '" target="_blank">';
			}
			onTag_IMG(t, e, i) {
				if (e) return null;
				var s = this.getTagText(!0);
				return s
					? this.defaultImgWidth
						? '<img src="' +
						  s +
						  '" width="' +
						  this.defaultImgWidth +
			...
			onTag_COLOR(t, e, i) {
				return e
					? '</span>'
					: ((this.lastColor = i), '<span style="color:' + i + '">');
			}
			onTag_FONT(t, e, i) {
			...
			getTagText(t = !1) {
				for (
					var e, i = this._readPos, s = '';
					-1 != (e = this._text.indexOf('[', i));
					...
					if (i > 0 && 92 == this._text.charCodeAt(i - 1))
						...
						(h = '/' == this._text.charAt(l + 1)),
							...
							-1 != (s = r.indexOf('=')) &&
								...
								(r = r.substring(0, s))),
							(r = r.toLowerCase()),
							null != (o = this._handlers[r])
								? e ||
								  (null != (n = o.call(this, r, h, a)) &&
										(_ += n))
								: (_ += this._text.substring(l, this._readPos)),
							(l = this._readPos);
					}
				return (
					l < this._text.length && (_ += this._text.substr(l)),
					(this._text = null),
					_
				);
			}
	...
	(function (t) {
		class e {
			static getFileName(t) {
				...
				return (
					-1 != e && (t = t.substr(e + 1)),
					-1 != (e = t.lastIndexOf('\\')) && (t = t.substr(e + 1)),
					-1 != (e = t.lastIndexOf('.')) ? t.substring(0, e) : t
				);
			}
			static startsWith(t, e, i = !1) {
				return !(
					!t ||
					t.length < e.length ||
			...
			static convertToHtmlColor(t, e = !1) {
				var i;
			...
			static convertFromHtmlColor(t, e = !1) {
				return t.length < 1
					? 0
					: ('#' == t.charAt(0) && (t = t.substr(1)),
					  8 == t.length
							? (parseInt(t.substr(0, 2), 16) << 24) +
							  parseInt(t.substr(2), 16)
							: e
							? 4278190080 + parseInt(t, 16)
							: parseInt(t, 16));
			}
			...
			static setColorFilter(t, e) {
				...
				if (r)
					for (var a = 0; a < r.length; a++) {
						var n = r[a];
						if (n instanceof Laya.ColorFilter) {
							i = n;
							break;
						}
					}
				if ('boolean' == typeof e) (s = i ? i._color_ : null), (h = e);
				else {
					if ('string' == typeof e) {
						var o = Laya.ColorUtils.create(e).arrColor;
						e =
							1 == o[0] && 1 == o[1] && 1 == o[2]
								? null
								: [
					...
					? (i ||
					  ...
					  h
							...
							: s &&
							  (20 == s.length
									? i.setByMatrix(s)
									: (i.adjustBrightness(s[0]),
									  i.adjustContrast(s[1]),
									  i.adjustSaturation(s[2]),
									  i.adjustHue(s[3]))))
					: r &&
					  -1 != (a = r.indexOf(i)) &&
					  (r.splice(a, 1),
					  r.length > 0 ? (t.filters = r) : (t.filters = null));
			}
		}
