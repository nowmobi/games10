let PurchaseFailed = new Phaser.Class({
...
init(params) {
    let temp = {'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '1', 'values': []}
    ...
    res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '3', 'values': [], 'base_size': 65});
	...
	let sad = new Phaser.GameObjects.Image(this.scene, 0, -45, 'common1', 'sad');
	this.add(sad);
},
