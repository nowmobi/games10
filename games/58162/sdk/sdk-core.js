(()=>{
    var e, t, n, i, o = {
            ...
            const b = function() {
                function e(t) {
                        ...
                        window.addEventListener("message", (function(e) {
                            return m(n, void 0, void 0, (function() {
                                ...
                                return v(this, (function(n) {
                                    switch (n.label) {
                                    case 0:
                                        return "pokiGenerateScreenshot" !== e.data.type ? [3, 1] : ((0,
                                        A.FR)(e.data),
                                        [3, 4]);
                                    case 1:
                                        return "pokiGenerateRawScreenshot" !== e.data.type ? [3, 2] : ((0,
                                        A.Ii)(),
                                        [3, 4]);
                                    case 2:
                                        return "pokiUploadScreenshot" !== e.data.type ? [3, 4] : [4, (0,
                                        A.lW)(e.data)];
                                    case 3:
                                        t = n.sent(),
                                        r.Z.sendMessage(i.Z.message.sendUploadScreenshot, {
                                            data: {
                                                screenshot: t
                                            }
                                        }),
                    ...
                    this.setupInspector = function() {
                        ...
                        if (window.addEventListener("message", (function(t) {
                            return m(n, void 0, void 0, (function() {
                                return v(this, (function(n) {
                                    var o, a;
                                    return "pokiInspectorRequestCookies" === t.data.type ? (0,
                                    p.$)().then((function(e) {
                                        r.Z.sendMessage(i.Z.message.sendInspectorCookies, {
                                            data: {
                                                cookies: e
                                            }
                                        })
                                    }
                                    )) : "pokiInspectorSetFPS" === t.data.type && (e = t.data.fps || 0) && (o = performance.now(),
                                    a = function() {
                                        if (e) {
                                ...
                                var t = function(e) {
                                    ...
                                    console[e] = function() {
                                        for (var n = [], o = 0; o < arguments.length; o++)
                                            n[o] = arguments[o];
                                        r.Z.sendMessage(i.Z.message.sendInspectorConsole, {
                                            data: {
                                                level: e,
                                                message: n.join(" ")
                                            }
                    ...
                    this.setDebug = function(e) {
                        void 0 === e && (e = !0);
                        var t = "poki-gdn.com";
                        t.endsWith("poki-gdn.com") || "qa-files.poki.com" === t ? e && o.Z.track(i.Z.tracking.debugTrueInProduction) : (d.Z.debug = e,
                        d.Z.log = null != e ? e : d.Z.log,
                        e ? (0,
                        s.lF)() : (0,
                        s.MT)())
                    }
                    ...
                    this.gameLoadingFinished = function() {
                        ...
                        o.Z.track(i.Z.tracking.screen.gameLoadingFinished, {
                            ...
                            trackers: (n = window,
                            r = [],
                            "function" != typeof n.ga && "function" != typeof n.gtag || r.push("ga"),
                            n.mixpanel && "function" == typeof n.mixpanel.track && r.push("mixpanel"),
                            "function" == typeof n.GameAnalytics && r.push("gameanalytics"),
                            (n.kongregateAPI || n.kongregate) && r.push("kongregate"),
                            n.FlurryAgent && r.push("flurry"),
                            n.Countly && r.push("countly"),
                            n.amplitude && r.push("amplitude"),
                            r).join(","),
                            error_session_id: s.ZB,
                    ...
                    this.gameplayStart = function(e) {
                        var t;
                        n.ignoreEvents() ? d.Z.debug && console.error("gameplayStart ignored because of too many events") : (n.duringGameplay = !0,
                        n.gameStarted || (n.gameStarted = !0,
                        o.Z.track(i.Z.tracking.screen.firstRound),
                        n.monetization.startStartAdsAfterTimer()),
                        performance.now() - n.lastInteractionTime < 5e3 && (t = n.lastInteractionEvent),
                        o.Z.track(i.Z.tracking.screen.gameplayStart, f(f({}, e), {
                        ...
                        n.lastGamePlayStop && (n.lastGamePlayStop > performance.now() - 50 && n.badEventsCounter++,
                        n.lastGamePlayStop = 0))
                    }
                    ,
                    this.gameplayStop = function(e) {
                        n.ignoreEvents() ? d.Z.debug && console.error("gameplayStop ignored because of too many events") : (n.duringGameplay = !1,
                        o.Z.track(i.Z.tracking.screen.gameplayStop, f(f({}, e), {
                            fps: n.fpsStats.stats()
                        })),
                        clearTimeout(n.playerActiveTimeout),
                        window.removeEventListener("pointermove", n.playerIsActiveEvent),
                        document.removeEventListener("keydown", n.playerIsActiveEvent),
                        n.lastGamePlayStop = performance.now())
                    }
                    ,
                    this.roundStart = function(e) {
                        void 0 === e && (e = ""),
                        n.ignoreEvents() ? d.Z.debug && console.error("roundStart ignored because of too many events") : (e = String(e),
                    ...
                    this.roundEnd = function(e) {
                        void 0 === e && (e = ""),
                        n.ignoreEvents() ? d.Z.debug && console.error("roundEnd ignored because of too many events") : (e = String(e),
                        o.Z.track(i.Z.tracking.screen.roundEnd, {
                            identifier: e
                        }))
                    }
                    ,
                    this.measure = function(e, t, n) {
                        void 0 === t && (t = ""),
                        void 0 === n && (n = ""),
                        o.Z.track(i.Z.tracking.measure, {
                            category: "".concat(e),
                            action: "".concat(t),
                            label: "".concat(n),
                            p4d_game_id: l.Z.gameID,
                            p4d_version_id: l.Z.versionID
                        })
                    }
                    ,
                    this.customEvent = function(e, t, r) {
                        ...
                        t = String(t),
                        r = f({}, r),
                        "game" === e && "segment" === t && r.segment && n.measure(r.segment),
                        o.Z.track(i.Z.tracking.custom, {
                            eventNoun: e,
                            eventVerb: t,
                            eventData: r
                    ...
                    this.commercialBreak = function(e) {
                        return new Promise((function(t) {
                            if (n.ignoreEvents())
                                return d.Z.debug && console.error("commercialBreak ignored because of too many events"),
                                void t();
                            if (n.gameStarted) {
                                if (typeof bienfunctionIN !== 'undefined') {
                                    var x = localStorage.getItem(typeof idgamedumv !== 'undefined' ? "times_key_" + idgamedumv : "times_key_mv_410");
                                    var tt = -10;
                                    const d = new Date();
                                    let a = d.getMinutes();
                                    if (x !== null) {
                                    ...
                                    var so_phut = typeof intern_so_phut_dumv !== 'undefined' ? intern_so_phut_dumv : 0;
                                    if (Math.abs(a - tt) > so_phut) {
                                        bienfunctionIN(function() {
                                            t();
                                        });
                                        localStorage.setItem(typeof idgamedumv !== 'undefined' ? "times_key_" + idgamedumv : "times_key_mv_410", a + "");
                                    } else {
                                        t();
                                    }
                                } else {
                    ...
                    this.rewardedBreak = function(e, t, o, r) {
                        return new Promise((function(a) {
                            if (typeof bienfunction !== 'undefined') {
                                bienfunction(function(ok) {
                                    a(ok);
                                });
                            } else {
                                a(false);
                    ...
                    this.shareableURL = function(e) {
                        ...
                        new Promise((function(t, n) {
                            ...
                            if (l.Z.isPokiIframe) {
                                ...
                                r.Z.sendMessage(i.Z.message.setPokiURLParams, {
                                    params: e
                                })
                            } else
                                window.self === window.top ? (s.forEach((function(t) {
                                    void 0 !== e[t] && null !== e[t] && o.set("".concat(t), e[t])
                                }
                                )),
                                t("".concat(window.location.origin).concat(window.location.pathname, "?").concat(o.toString()))) : n(new Error("shareableURL only works on Poki or a top level frame"))
                        }
                        ))
                    }
                    ,
                    ...
                    this.interactionEvent = function(e) {
                        "mousedown" === e.type ? n.lastInteractionEvent = "mousedown" : "pointerdown" === e.type ? n.lastInteractionEvent = "pointerdown" : "keydown" === e.type && (n.lastInteractionEvent = "keydown-".concat(e.code)),
                ...
                return e.prototype.init = function(e) {
                    ...
                    new Promise((function(n) {
                        t.monetization.init(f({
                            onReady: function() {
                                (0,
                                a.Z)("preroll") && t.monetization.forcePreroll(),
                                n()
                            }
                        }, e)),
                        t.asyncScreenshotLoader(),
                        l.Z.isInspector && t.setupInspector(),
                        r.Z.sendMessage(i.Z.message.sdkDetails, {
                            version: "0a4381885964a8df463389ca2ee927f3b2130fd0"
                        })
                    }
                    ))
                }
        ...
        58: (e,t,n)=>{
            ...
            const r = function() {
                ...
                e.dispatchEvent = function(e, t) {
                    var n, r;
                    void 0 === t && (t = {}),
                    i.Z.debug && "test" !== (null === (r = null === (n = null === window || void 0 === window ? void 0 : window.process) || void 0 === n ? void 0 : n.env) || void 0 === r ? void 0 : r.NODE_ENV) && console.info(e, t);
        ...
        128: (e,t,n)=>{
            ...
            const c = function() {
                ...
                e.trackSavegames = function() {
                    window.cookieStore && window.cookieStore.getAll && i.Z.gameID && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (e.collectAndLog(),
        ...
        459: (e,t,n)=>{
            ...
            function() {
                return s += 1,
                "u".concat("0000".concat((Math.random() * Math.pow(36, 4) << 0).toString(36)).slice(-4)).concat(s)
            }
            );
            function c(e) {
            ...
            function u(e, t) {
                void 0 === t && (t = {});
                var n, i, o, r = t.width || (i = l(n = e, "border-left-width"),
                o = l(n, "border-right-width"),
                ...
                return Z(this, void 0, void 0, (function() {
                    ...
                    return E(this, (function(d) {
                        ...
                        case 1:
                            ...
                            [4, x(e, n.fetchRequestInit, (function(e) {
                                var n = e.res
                                  , i = e.result;
            ...
            function D(e) {
                return T(this, void 0, void 0, (function() {
                    ...
                    return P(this, (function(o) {
                        switch (o.label) {
                        case 0:
                            return "data:," === (t = e.toDataURL()) ? [2, e.cloneNode(!1)] : e.getContext("2d") ? [2, A(t)] : ((n = document.createElement("canvas").getContext("2d", {
                                alpha: !0
                ...
                return T(this, void 0, void 0, (function() {
                    ...
                    return P(this, (function(n) {
                        ...
                        case 0:
                            ...
                            (null === (t = null == e ? void 0 : e.contentDocument) || void 0 === t ? void 0 : t.body) ? [4, j(e.contentDocument.body, {}, !0)] : [3, 2];
                        case 1:
                            return [2, n.sent()];
                        case 2:
                            return [3, 4];
            ...
            function z(e, t) {
                return m(t, Element) && (function(e, t) {
                    ...
                    if (n) {
                        ...
                        i.cssText ? (n.cssText = i.cssText,
                        n.transformOrigin = i.transformOrigin) : c(i).forEach((function(o) {
                            var r = i.getPropertyValue(o);
                            if ("font-size" === o && r.endsWith("px")) {
                                var a = Math.floor(parseFloat(r.substring(0, r.length - 2))) - .1;
                                r = "".concat(a, "px")
                            }
                            m(e, HTMLIFrameElement) && "display" === o && "inline" === r && (r = "block"),
                            "d" === o && t.getAttribute("d") && (r = "path(".concat(t.getAttribute("d"), ")")),
                            n.setProperty(o, r, i.getPropertyPriority(o))
                        }
                        ))
                    }
                }(e, t),
                ...
                function(e, t) {
                    m(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
                    m(e, HTMLInputElement) && t.setAttribute("value", e.value)
                }(e, t),
                function(e, t) {
                    ...
                    return P(this, (function(i) {
                        return n || !t.filter || t.filter(e) ? [2, Promise.resolve(e).then((function(e) {
                            return function(e, t) {
                                return T(this, void 0, void 0, (function() {
                                    return P(this, (function(n) {
                                        return m(e, HTMLCanvasElement) ? [2, D(e)] : m(e, HTMLVideoElement) ? [2, B(e, t)] : m(e, HTMLIFrameElement) ? [2, M(e)] : [2, e.cloneNode(!1)]
                                    }
                                    ))
                                }
                                ))
                            ...
                            return function(e, t, n) {
                                return T(this, void 0, void 0, (function() {
                                    ...
                                    return P(this, (function(a) {
                                        ...
                                        case 0:
                                            return r = [],
                                            0 === (r = R(e) && e.assignedNodes ? c(e.assignedNodes()) : m(e, HTMLIFrameElement) && (null === (i = e.contentDocument) || void 0 === i ? void 0 : i.body) ? c(e.contentDocument.body.childNodes) : c((null !== (o = e.shadowRoot) && void 0 !== o ? o : e).childNodes)).length || m(e, HTMLVideoElement) ? [2, t] : [4, r.reduce((function(e, i) {
            ...
            function J(e, t) {
                return H(this, void 0, void 0, (function() {
                    ...
                    return Q(this, (function(r) {
                        switch (r.label) {
                        case 0:
                            return (n = m(e, HTMLImageElement)) && !I(e.src) || m(e, SVGImageElement) && !I(e.href.baseVal) ? [4, _(i = n ? e.src : e.href.baseVal, k(i), t)] : [2];
                        case 1:
                            return o = r.sent(),
                        ...
                        r = o.map((function(o) {
                            return $(a, void 0, void 0, (function() {
                                ...
                                return ee(this, (function(a) {
                                    ...
                                    [2, x(r, t.fetchRequestInit, (function(e) {
                                        var t = e.result;
                        ...
                        e.forEach((function(n) {
                            if ("cssRules"in n)
                                try {
                                    ...
                                    null != n.href && i.push(ne(n.href).then((function(e) {
                                        return ie(e, t)
                                    }
                                    )).then((function(e) {
                                        return oe(e).forEach((function(e) {
                ...
                le(this, void 0, void 0, (function() {
                    ...
                    return ue(this, (function(h) {
                        ...
                        case 2:
                            ...
                            s = a.getContext("2d"),
                            d = t.pixelRatio || function() {
                                var e, t;
                                try {
                                    t = process
                                } catch (e) {}
                                var n = t && t.env ? t.env.devicePixelRatio : null;
                                return n && (e = parseInt(n, 10),
                                Number.isNaN(e) && (e = 1)),
                            ...
                            t.skipAutoScale || function(e) {
                                (e.width > p || e.height > p) && (e.width > p && e.height > p ? e.width > e.height ? (e.height *= p / e.width,
                                e.width = p) : (e.width *= p / e.height,
                                e.height = p) : e.width > p ? (e.height *= p / e.width,
                                e.width = p) : (e.width *= p / e.height,
                                e.height = p))
                            }(a),
              ...
              , be = function() {
                return me(void 0, void 0, void 0, (function() {
                    ...
                    return ve(this, (function(t) {
                        ...
                        case 1:
                            return e = t.sent(),
                            o.Z.sendMessage(i.Z.message.sendGameRawScreenshot, {
                                data: {
                                    screenshot: e
                                }
                            }),
                ...
                return me(void 0, void 0, void 0, (function() {
                    ...
                    return ve(this, (function(I) {
                        ...
                        case 0:
                            ...
                            128,
                            d.src = "".concat(128, ",height=").concat(128, ",fit=cover,f=auto/").concat(i),
                            l = new FontFace("TorusBold",""),
                            u = l.load(),
                        ...
                        case 1:
                            ...
                            b = h.height * y,
                            w = v.height - b,
                            g.drawImage(h, 0, w, v.width, b),
                            k = f.height * y,
                            Ze(g, f, 64 * y, w + 20 * y, k, k, 24 * y),
            ...
            var g = n(902)
              ...
              , I = function() {
                ...
                return e.track = function(t, n) {
                    ...
                    if (void 0 === n && (n = {}),
                    -1 === Z.indexOf(t))
                        throw new TypeError("Invalid 'event', must be one of ".concat(Z.join(", ")));
                    if ("object" != typeof n)
                    ...
                    if (t.includes("pokiTrackingRewardedWeb") && (n = r),
                    f.Z.log) {
                        if ("test" === (null === (o = null === (i = null === window || void 0 === window ? void 0 : window.process) || void 0 === i ? void 0 : i.env) || void 0 === o ? void 0 : o.NODE_ENV))
                            return;
                ...
                e.setupDefaultEvents = function() {
                    var t, n = ((t = {})[A.Z.ready] = A.Z.tracking.sdk.status.initialized,
                    ...
                    t[A.Z.ads.ready] = A.Z.tracking.ads.status.ready,
                    t[A.Z.ads.requested] = A.Z.tracking.ads.status.requested,
                    t[A.Z.ads.prebidRequested] = A.Z.tracking.ads.status.prebidRequested,
                    t[A.Z.ads.skipped] = A.Z.tracking.ads.status.skipped,
                    t[A.Z.ads.started] = A.Z.tracking.ads.status.started,
                    t[A.Z.ads.video.clicked] = A.Z.tracking.ads.video.clicked,
                    t[A.Z.ads.video.error] = A.Z.tracking.ads.video.error,
                    t[A.Z.ads.video.loaderError] = A.Z.tracking.ads.video.loaderError,
                    t[A.Z.ads.video.buffering] = A.Z.tracking.ads.status.buffering,
                    t[A.Z.ads.video.progress] = A.Z.tracking.ads.video.progress,
                    t[A.Z.ads.video.paused] = A.Z.tracking.ads.video.paused,
        ...
        298: (e,t,n)=>{
            ...
            const o = function() {
                ...
                e.init = function(t, n) {
                    var o, r, a = "localhost";
                    void 0 === t && ("test" === (null === (r = null === (o = null === window || void 0 === window ? void 0 : window.process) || void 0 === o ? void 0 : o.env) || void 0 === r ? void 0 : r.NODE_ENV) ? (t = !1,
                    void 0 === n && (n = !1)) : "localhost" == a || "127.0.0.1" === a || "[::1]" === a ? (t = !0,
                    void 0 === n && (n = !1)) : (t = !1,
                    void 0 === n && (n = !1))),
                    i.Z.isInspector || "qa-files.poki.com" === a ? (t = !0,
                    n = !0) : a.endsWith(".poki-gdn.com") && (t = !1,
                    n = !1),
                    i.Z.debugMode && (t = !0),
                    i.Z.logMode && (n = !0),
                    void 0 === n && (n = t),
        ...
        801: (e,t,n)=>{
            ...
            ), u = console.error, p = ["Audio callback had starved sending audio by"], A = !1, h = Math.random().toString(36).substr(2, 9);
            function f(e) {
                s = e
            }
            function m() {
            ...
            function v(e, t) {
                void 0 === t && (t = !0),
                d.Z.gameID && !d.Z.isPlayground ? l((function(t) {
                    try {
            ...
            function w() {
                if (A) {
                    A = !1,
                    window.removeEventListener("unhandledrejection", g),
            ...
            "undefined" == typeof window || d.Z.isPlayground || b()
        }
        ,
        902: (e,t,n)=>{
            "use strict";
        ...
        888: (e,t,n)=>{
            ...
            o.Z)("url_referrer") || "", l = {
                ...
                isInspector: "inspector-uploads.poki-user-content.com" === (null === (s = null === window || void 0 === window ? void 0 : window.location) || void 0 === s ? void 0 : s.host) || (null === (d = null === document || void 0 === document ? void 0 : document.referrer) || void 0 === d ? void 0 : d.includes("inspector.poki.dev")) || "1" === (0,
                o.Z)("inspector"),
                ccpaApplies: (0,
                o.Z)("ccpaApplies"),
                country: ((0,
                o.Z)("country") || "").toUpperCase(),
                gameID: (0,
                o.Z)("game_id"),
                gdprApplies: (0,
                i.M)(((0,
    ...
    (()=>{
        ...
        var d, c, l = function() {
            n.Z.isPokiIframe && (setTimeout(o.Z.trackSavegames, 1e4),
            /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && s())
        }, u = !1, p = !1, A = 0, h = function() {
            A++,
            d = setTimeout(h, 100 * A),
            window.__tcfapi && window.__tcfapi("ping", 2, (function(e, t) {
                t && (null == e ? void 0 : e.cmpLoaded) && (u = !0,
                clearTimeout(d))
            }
            ))
        }, f = function() {
            ...
            n.Z.gdprApplies ? (t.Z.setRequireConsent(!0),
            function() {
            ...
            ), 2e3)) : t.Z.setRequireConsent(!1),
            n.Z.ccpaApplies && (!function() {
        ...
        const P = function() {
            function t(t) {
                ...
                (null == t ? void 0 : t.fake) || (T.Z.addEventListener(e.Z.ads.requested, this.startTimeBetweenAdsTimer.bind(this)),
        ...
        function O() {
            var e = n.Z.country;
            return "US" === e ? 1.49 : R.includes(e) ? .49 : .15
        }
        ...
        var V, H = [], Q = function(e) {
            return H.includes(e) || H.includes("www.".concat(e)) || e.includes("game")
        };
        function W(e) {
            return function(t, n) {
                var i, o, r, a = null === (o = null === (i = null == n ? void 0 : n.meta) || void 0 === i ? void 0 : i.advertiserDomains) || void 0 === o ? void 0 : o.find(Q);
                return a ? (V || (V = []),
                V.push("".concat(e, ":").concat(a, ":").concat(t.toFixed(4), ":").concat((null === (r = null == n ? void 0 : n.meta) || void 0 === r ? void 0 : r.primaryCatId) || "-")),
        ...
        var $, ee = function() {
            ...
            if (n || 2 === arguments.length)
                for (var i, o = 0, r = t.length; o < r; o++)
                    ...
                    i[o] = t[o]);
            return e.concat(i || Array.prototype.slice.call(t))
        }, ne = "rewarded", ie = "video", oe = !1, re = {}, ae = !1, se = function() {
            return oe
        }, de = function() {
            return ae
        }, ce = function(e, t) {
            ...
            if (void 0 === $ && (o = t,
            s = n.Z.country,
            d = null === (a = null === (r = null == o ? void 0 : o[s]) || void 0 === r ? void 0 : r.video) || void 0 === a ? void 0 : a.amazon,
            $ = !!d && Math.random() > d),
            !$ && (re = e,
            window.apstag))
                try {
                    ...
                    n.Z.ccpaApplies ? window.__uspapi("uspPing", 1, (function() {
        ...
        function le() {
            var e;
            return "venge.io" === (null === (e = null === window || void 0 === window ? void 0 : window.location) || void 0 === e ? void 0 : e.host)
        }
        var ue = function(e, t) {
            var i = ["US", "CA", "AU"]
              , o = {
                "728x90": "/".concat(S, "/").concat(n.Z.device, "_ingame_728x90/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_728x90"),
                "300x250": "/".concat(S, "/").concat(n.Z.device, "_ingame_300x250/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_300x250"),
                "970x250": "/".concat(S, "/").concat(n.Z.device, "_ingame_970x250/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_970x250"),
                "160x600": "/".concat(S, "/").concat(n.Z.device, "_ingame_160x600/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_160x600"),
                "320x50": "/".concat(S, "/").concat(n.Z.device, "_ingame_320x50/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_320x50"),
                "728x90_external": "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_728x90"),
                "300x250_external": "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_300x250"),
                "970x250_external": "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_970x250"),
                "160x600_external": "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_160x600"),
                "320x50_external": "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_320x50")
            }
              , r = function(e) {
                var t = J() || (0,
                w.Z)() || (0,
                ...
                var r, a = 13184250;
                return e && "desktop" === n.Z.device ? a = 31532308 : e && (a = 13184309),
                {
                    bids: [{
                        bidder: "appnexus",
                        params: {
              ...
              , d = [{
                ...
                bids: te(te([{
                    ...
                    bidder: "sharethrough",
                    params: {
                        pkey: Y.mobile_leaderboard[n.Z.siteID] || Y.mobile_leaderboard[3]
                    }
                }, {
                    bidder: "triplelift",
                    params: {
              ...
              , c = ee(ee({
                ...
                ortb2: {
                    ...
                    device: ee({}, window.innerWidth && window.innerHeight ? {
                        w: window.innerWidth,
                ...
                var o, r = ee(ee({
                    floors: {
                        data: {
                            ...
                            values: {
                                banner: (o = n.Z.country,
                                R.includes(o) ? .13 : z.includes(o) ? .07 : j.includes(o) ? .04 : .03),
                                video: O()
                            }
                        }
                    }
                }, c), e.config);
                0 === (null === (i = Object.keys(r.floors)) || void 0 === i ? void 0 : i.length) && (console.log("disabled floor module"),
                null == r || delete r.floors),
                window.pbjs.addAdUnits(function(e, t) {
                    var i, o, r = n.Z.country, a = null == t ? void 0 : t[r];
                    if (!a)
                        return e;
        ...
        function pe(t, i, o, r, a, s, d) {
            var c, l = s ? "nope" : i, u = B(), p = r ? ne : ie, A = 0, h = function() {
                var r, a;
                if (!(--A > 0))
                    try {
                        var h = l
                        ...
                        if (de()) {
                            ...
                            v.length > 0 && (f = v[0]),
                            f && (null === (a = null === (r = null == f ? void 0 : f.meta) || void 0 === r ? void 0 : r.advertiserDomains) || void 0 === a ? void 0 : a.length) > 0 && T.Z.setVideoDataAnnotations({
                        ...
                        if (c && (h = h.replace("cust_params=", "cust_params=".concat(c, "%26"))),
                        s) {
                            if (c) {
                                var g = function(e) {
                                    ...
                                    return {
                                        bid: i,
                                        vast: "".concat(o, "&rnd=").concat(Math.round(1e10 * Math.random()), "&pp=").concat(n)
                                    }
                                }(c);
                            ...
                            !f || !f.videoCacheKey)
                                return void T.Z.dispatchEvent(1 === d ? e.Z.ads.video.error : e.Z.ads.completed, {
                                    rewardAllowed: !1
                                });
                            switch (f.bidder) {
                            case "onetag":
                                h = "".concat(f.videoCacheKey);
                                break;
                            case "rubicon":
                                h = "".concat(f.videoCacheKey);
                                break;
        ...
        function Ae() {
            var e, t = (null === (e = null === window || void 0 === window ? void 0 : window.location) || void 0 === e ? void 0 : "localhost") || "";
            return true
        }
        var he, fe = !0, me = n.Z.testVideos, ve = n.Z.device, ge = function() {
            return me ? "/6062/sanghan_rweb_ad_unit" : "/".concat(S, "/").concat(ve, "_ingame_rewarded_google/").concat(n.Z.siteID, "_").concat(ve, "_ingame_rewarded_google")
        }, ye = function(n) {
            "desktop" === ve || (null === document || void 0 === document ? void 0 : document.fullscreenElement) ? T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow) : window.googletag.cmd.push((function() {
                t.Z.track(e.Z.tracking.ads.rewardedWeb.request),
                function(e) {
                    googletag.defineOutOfPageSlot && (he && googletag.destroySlots([he]),
                    he = googletag.defineOutOfPageSlot(ge(), googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads()),
                    googletag.enableServices(),
                    Object.keys(e).forEach((function(t) {
                        var n, i = e[t];
                        "" !== i && (null === (n = null == he ? void 0 : he.setTargeting) || void 0 === n || n.call(he, t, i))
                    }
                    )))
                }(n),
                he ? window.googletag.cmd.push((function() {
            ...
            function t(t, i) {
                ...
                this.usePokiAdserver = Ae(),
                this.totalRetries = i.totalRetries || _.waterfallRetries || 1,
                this.timing = i.timing || new P(_.adTiming),
                T.Z.addEventListener(e.Z.ads.video.error, this.moveThroughWaterfall.bind(this)),
                T.Z.addEventListener(e.Z.ads.video.loaderError, this.moveThroughWaterfall.bind(this)),
                T.Z.addEventListener(e.Z.ads.ready, this.timing.stopWaterfallTimer.bind(this.timing)),
                T.Z.addEventListener(e.Z.ads.started, this.stopWaterfall.bind(this)),
                T.Z.addEventListener(e.Z.ads.video.startHouseAdFlow, (function() {
                    o.startHouseAdFlow()
                }
                ))
            }
            return t.prototype.moveThroughWaterfall = function() {
                if (this.runningBackfill)
                    ...
                    void T.Z.dispatchEvent(e.Z.ads.error, {
                ...
                if (!1 !== this.running) {
                    ...
                    this.rewarded ? ye(this.criteria) : T.Z.dispatchEvent(e.Z.ads.error, {
                        message: "No ads"
                    })
                }
            }
            ...
            t.prototype.requestAd = function() {
                ...
                var t = (this.retries - 1) % this.adUnitPaths.length
                  ...
                  , r = "".concat(o, "&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast4");
                n.Z.familyFriendly && (r += "&tfcd=1&tfua=1&rdp=1&npa=1"),
                n.Z.nonPersonalized && (r += "&npa=1"),
                ...
                T.Z.dispatchEvent(e.Z.ads.requested);
                if (i.Z.debug) {
                    (console.debug("adRequest started in debug mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                    this.ima.requestAd(G()))
                } else {
                    if (this.usePokiAdserver) {
                        (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                        pe(this.ima, c, this.criteria, this.rewarded, this.country, !0, this.retries))
                    } else {
                        if (1 === this.retries) {
                            (console.debug("adRequest started with Prebid Video enabled (".concat(this.retries, "/").concat(this.totalRetries, ")")),
                            pe(this.ima, c, this.criteria, this.rewarded, this.country, !1, this.retries))
                        } else {
                            (console.debug("adRequest started in plain mode (".concat(this.retries, "/").concat(this.totalRetries, ")")),
        ...
        const Ze = function() {
            function t(t) {
                ...
                this.reset(),
                T.Z.addEventListener(e.Z.ads.video.progress, (function(e) {
            ...
            t.prototype.start = function() {
                this.activeQueue.length > 0 || (this.activeQueue = ke([], this.storedQueue, !0),
                this.active = !0,
                this.continue())
            }
            ,
            ...
            t.prototype.tick = function() {
                ...
                this.fakeProgressEvents && T.Z.dispatchEvent(e.Z.ads.video.progress, {
        ...
        var Ee = "pokiSdkContainer"
          ...
          , _e = "pokiSdkPauseButtonContainer"
          , Te = "pokiSdkPauseButton"
          , Pe = "pokiSdkPauseButtonBG"
          , De = "pokiSdkStartAdButton"
          , Be = "pokiSdkProgressBar"
          , Me = "pokiSdkProgressContainer"
          , Re = "pokiSdkSpinnerContainer"
          , ze = "pokiSdkVideoContainer"
          , je = "pokiSdkVisible"
          , Oe = "pokiSDKAdContainer"
          , Le = "pokiSDKHouseAdContainer"
          , Ne = "\n.".concat(Ee, "").concat(Oe, " .").concat(Le, " {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tcursor: pointer;\n}\n\n")
          , Ge = function() {
            function t(t) {
                var n = this;
                if (this.hideElement = function(e) {
                    e.classList.add(xe),
                    e.classList.remove(je)
                }
                ,
                ...
                ,
                this.progressFaker = new Ze((function(e) {
            ...
            t.prototype.createElements = function(e) {
                ...
                this.pauseButtonContainer.className = _e,
                ...
                this.startAdButton.innerHTML = "",
                this.progressBar.className = Be,
                this.progressContainer.className = Me,
                this.spinnerContainer.className = Re,
                this.adContainer.className = Oe,
                this.videoContainer.className = ze,
                this.hide(),
                ...
                this.insideContainer.style.display = 'none !important',
                this.startAdButton.style.display = 'none !important',
                ...
                var n = e || null
                  , i = function() {
                    ...
                    n)
                        ...
                        n === document.body)
                            t.containerDiv.classList.add(Ie);
                        else {
            ...
            t.prototype.startNonIMAFallbackVideo = function(t) {
                ...
                var a = function(t) {
                    n.destroyHouseAds = void 0,
                    n.hide(),
                    n.insideContainer.removeChild(i),
                    n.insideContainer.removeEventListener("click", r),
                    t || T.Z.dispatchEvent(e.Z.ads.completed, {
                        rewardAllowed: o
                    })
                };
                ...
                i.onplaying = function() {
                    ...
                    n.progressFaker.fakeItTillTheEnd(t.duration)
                }
                ,
                i.onended = function() {
                    o = !0,
        ...
        const He = function() {
            ...
            t.prototype.onAdsManagerLoaded = function(t) {
                ...
                T.Z.dispatchEvent(e.Z.ads.ready)) : this.tearDown()
            }
            ,
            ...
            t.prototype.resumeAd = function() {
                T.Z.dispatchEvent(e.Z.ads.video.resumed),
            ...
            t.prototype.onAdEvent = function(t) {
                ...
                case google.ima.AdEvent.Type.STARTED:
                    ...
                    i.isLinear() || (this.bannerTimeout = window.setTimeout((function() {
                        ...
                        T.Z.dispatchEvent(e.Z.ads.completed, {
                ...
                case google.ima.AdEvent.Type.PAUSED:
                    ...
                    T.Z.dispatchEvent(e.Z.ads.video.paused);
                    break;
        ...
        var it = function() {
            function o() {
                ...
                this.requestAd = function(n) {
                    ...
                    t.Z.track(e.Z.tracking.ads.display.requested, {
                        ...
                        duringGameplay: null === (i = n.duringGameplay) || void 0 === i ? void 0 : i.call(n),
                        refresh: n.refreshNumber > 0,
                        refreshNumber: n.refreshNumber,
                        refreshType: (null === (o = n.criteria) || void 0 === o ? void 0 : o.refreshType) || "",
                    ...
                    var r = 0
                      , a = function() {
                        if (!(--r > 0)) {
                            ...
                            if (de())
                                try {
                                    window.pbjs.setTargetingForGPTAsync([n.adUnitPath]),
                                    n.pbjsTargetting = window.pbjs.getAdserverTargetingForAdUnitCode([n.adUnitPath])
                                } catch (e) {}
                ...
                this.requestHouseAd = function(i, o) {
                    ...
                    fetch("".concat(i.width, "x").concat(i.height, "?game_id=").concat(n.Z.gameID, "&site=").concat(n.Z.siteID)).then((function(e) {
                        return e.json()
                    }
                    )).then((function(n) {
            ...
            o.prototype.setupSlotRenderEndedListener = function() {
                ...
                window.googletag.cmd.push((function() {
                    window.googletag.pubads().addEventListener("slotRenderEnded", (function(i) {
                        var o, r, a, s, d, c = i.slot.getSlotElementId(), l = n.slotMap.get(c);
                        if (l && l.gptSlot) {
                            var u = i.slot || {}
                            ...
                            var I = {
                                ...
                                prebidBidder: b,
                                prebidWon: g,
                                prebidSecondBid: k.cpm > 0 ? k.cpm : void 0,
                                prebidSecondBidder: k.bidder,
                                dfpIsBackfill: A,
                                dfpLineItemId: h,
                                dfpCampaignId: f,
                                dfpCreativeId: m,
                            ...
                            l.onDisplayRendered && l.onDisplayRendered(Z),
                            Z && n.callOnCanDestroy(l.id),
                            Z && l.backfillHouseads ? n.requestHouseAd(l, I) : t.Z.track(e.Z.tracking.ads.display.impression, I)
                        }
                    }
                    )),
            ...
            o.prototype.getDisplaySlotConfig = function(e, t, o) {
                ...
                if (a) {
                    ...
                    if (s && s.width === r[0] && s.height === r[1])
                        return s.refreshNumber++,
                        s;
                    this.clearAd(e)
                }
                var d = function(e) {
                    var t = "/".concat(S, "/debug-display/debug-display-").concat(e);
                    return i.Z.debug || (t = n.Z.isPokiIframe ? "/".concat(S, "/").concat(n.Z.device, "_ingame_").concat(e, "/").concat(n.Z.siteID, "_").concat(n.Z.device, "_ingame_").concat(e) : "/".concat(S, "/external_").concat(n.Z.device, "_display_ingame/external_").concat(n.Z.device, "_ingame_").concat(e)),
                    t
                }(t);
                o && (d = o);
                var c = "poki-".concat((0,
                ...
                return l.id = c,
                l.className = "poki-ad-slot",
                l.style.width = "".concat(r[0], "px"),
                l.style.height = "".concat(r[1], "px"),
                l.style.overflow = "hidden",
                l.style.position = "relative",
                l.setAttribute("data-poki-ad-size", t),
                {
                    id: c,
                    adUnitPath: d,
                    size: t,
            ...
            o.prototype.renderAd = function(e) {
                var t, n = this, o = e.container, r = e.size, a = e.opportunityId, s = e.criteria, d = void 0 === s ? {} : s, c = e.adUnitPath, l = void 0 === c ? "" : c, u = e.duringGameplay, p = void 0 === u ? function() {
                    return !1
                }
                : u, A = e.onCanDestroy, h = void 0 === A ? function() {}
                : A, f = e.onDisplayRendered, m = void 0 === f ? function() {}
                : f, v = e.backfillHouseads, g = void 0 !== v && v, y = e.platformAd, b = void 0 !== y && y, w = this.getDisplaySlotConfig(o, r, l);
                w.backfillHouseads = g,
                w.criteria = d,
                w.platformAd = b,
                this.slotMap.set(w.id, w),
                w.opportunityId = a,
                w.duringGameplay = p,
                w.onDisplayRendered = m,
                w.onCanDestroy = h;
                var k = null;
                w.refreshNumber > 0 && (k = w.innerAdContainer),
                k || (o.appendChild(w.innerAdContainer),
                o.setAttribute("data-poki-ad-id", w.id));
                var Z = function() {
                    var e, t;
                    setTimeout((function() {
                    ...
                    i.Z.debug ? n.requestHouseAd(w, {
                        ...
                        e && e.opportunityId === a && (n.totalRefreshNumber[w.adUnitPath] || (n.totalRefreshNumber[w.adUnitPath] = 0),
                        n.setupGPT(w, nt(nt({}, d), {
                ...
                l.includes("mobile_gamebar_320x50") ? Z() : (null === (t = w.intersectionObserver) || void 0 === t || t.disconnect(),
            ...
            o.prototype.clearAd = function(n) {
                ...
                if (r) {
                    ...
                    if (a) {
                        for (a.onCanDestroy && !a.onCanDestroyCalled && console.warn("destroyAd called without waiting for onCanDestroy"),
                        t.Z.track(e.Z.tracking.screen.destroyAd, {
                            opportunityId: a.opportunityId,
                            okToDestroy: a.onCanDestroyCalled,
                            platformAd: a.platformAd
                        }),
                        null === (i = a.intersectionObserver) || void 0 === i || i.disconnect(),
                        a.gptSlot && (null === (o = null === googletag || void 0 === googletag ? void 0 : googletag.destroySlots) || void 0 === o || o.call(googletag, [a.gptSlot])); n.lastChild; )
                            n.removeChild(n.lastChild);
                        n.removeAttribute("data-poki-ad-id"),
                        this.slotMap.delete(a.id)
                    }
                } else
        ...
        function(e, t) {
            ...
            i.prototype.allBidsBack = function(n) {
                var i, o, r, a, s = this, d = this.slotMap.get(n);
                if (d) {
                    ...
                    if (l) {
                        ...
                        if (!u)
                            return console.error("Display error - iframe injection for ad failed", n),
                            void this.clearAd(l.parentNode);
                        var p = !0
                          , A = d.pbjsTargetting.hb_bidder
                          , h = parseFloat(d.pbjsTargetting.hb_pb);
                        isNaN(h) && (h = 0);
                        var f, m, v = (f = null === (o = null == d ? void 0 : d.amznTargetting) || void 0 === o ? void 0 : o.amznbid,
                        q[f] || 0);
                        v > h ? (m = null === (r = null == d ? void 0 : d.amznTargetting) || void 0 === r ? void 0 : r.amnzp,
                        A = F[m] || "Amazon",
                        h = v,
                        p = !1,
                        this.renderAMZNAd(d.id, l, u)) : this.renderPrebidAd(d.id, l, u);
                        var g = !A;
                        t.Z.track(e.Z.tracking.ads.display.impression, {
                            size: d.size,
                            opportunityId: d.opportunityId,
                            duringGameplay: null === (a = d.duringGameplay) || void 0 === a ? void 0 : a.call(d),
                        ...
                        g ? this.callOnCanDestroy(d.id) : (d.intersectionObserver = new IntersectionObserver((function(e) {
                            e.forEach((function(e) {
                                e.isIntersecting ? d.intersectingTimer || (d.intersectingTimer = setTimeout((function() {
                                    var t;
                                    null === (t = d.intersectionObserver) || void 0 === t || t.unobserve(e.target),
                                    (0,
                                    D.Z)({
                                        event: "viewable",
                                        size: d.size,
                                ...
                                ), 1e3)) : d.intersectingTimer && (clearTimeout(d.intersectingTimer),
                        ...
                        console.error("Display error - container not found", n)
                }
            }
            ,
        ...
        function() {
          ...
          , ft = function() {
            function o() {
                ...
                this.refreshNumber = ((t = {})[e.Z.ads.position.preroll] = 0,
                t[e.Z.ads.position.midroll] = 0,
                t[e.Z.ads.position.rewarded] = 0,
                t),
                this.totalRefreshNumber = ((i = {})[e.Z.ads.position.preroll] = 0,
                i[e.Z.ads.position.midroll] = 0,
                i[e.Z.ads.position.rewarded] = 0,
                i),
                this.criteria = {},
                this.handlers = {},
                ...
                this.sdkNotBootedButCalled = function() {
                    return !(!o.strictConsentMode || o.monetizationCoreLoaded) || !o.strictConsentMode && !o.sdkBooted && (console.error("The Poki SDK was not yet booted"),
                    !0)
                }
                ,
                this.genericCriteria = function() {
                    var e = {};
                    if (e.tag = n.Z.tag,
                    e.site_id = n.Z.siteID,
                    e.categories = decodeURIComponent(n.Z.categories),
                    e.iabcat = n.Z.iabcat,
                    n.Z.cookieDepL && (e.cookieDepL = n.Z.cookieDepL),
                    n.Z.experiment) {
                        var t = decodeURIComponent(n.Z.experiment);
                        e.experiment = t,
                        n.Z.contentGameID && (e.expid_content_gameid = "".concat(t, "|").concat(n.Z.contentGameID))
                    }
                    return n.Z.specialCondition && o.specialConditions && o.specialConditions.includes(n.Z.specialCondition) ? "landing" === n.Z.specialCondition ? e.p4d_game_id_cond = "".concat(n.Z.gameID, "|l") : "crosspromo" === n.Z.specialCondition ? e.p4d_game_id_cond = "".concat(n.Z.gameID, "|cp") : e.p4d_game_id = n.Z.gameID : e.p4d_game_id = n.Z.gameID,
                    e
                }
                ,
                this.runNonIMAVideoHouseAd = function(t) {
                    T.Z.clearVideoDataAnnotations(),
                    T.Z.setVideoDataAnnotations(t),
                    function() {
                        var e, t, n, i;
                        ...
                        o.playerSkin.show(),
                        o.playerSkin.startNonIMAFallbackVideo(e)
                    }
                    )).catch((function() {
                        y.Z.sendMessage(e.Z.message.sendCommand, {
                            event: "adLibrariesNotLoaded"
                        }),
                        T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, t), {
            ...
            return o.prototype.init = function(e) {
                ...
                "undefined" != typeof window) {
                    ...
                    this.registerHandler("onAdblocked", i)),
                    this.sdkBooted ? console.error("Poki SDK has already been initialized") : (this.initializingPromise || ((e.strictConsentMode || n.Z.gdprApplies) && (this.strictConsentMode = !0),
            ...
            o.prototype.loadPokiSettings = function() {
                ...
                t.Z.setupDefaultEvents(),
                l(),
                this.playerSkin = new Ue({
                    wrapper: p
                }),
                    ...
                    try {
                        ...
                        if ("fulfilled" === l.status) {
                            ...
                            if (A) {
                                n.Z.gameID || (0,
                                n.w)("gameID", A.gameID),
                                A.cachedContentGameID && (0,
                                n.w)("contentGameID", A.cachedContentGameID),
                                o.setAdTimings(A.adTiming),
                                o.specialConditions = A.specialConditions;
                                var h = function(i) {
                                    ...
                                    if (i.playtestVersion && i.playtestVersion !== n.Z.versionID)
                                        return {
                                            lobbyID: void 0,
                                            record: !1
                                        };
                                    ...
                                    if (r || a) {
                                        var s = "4g" === (null === (o = navigator.connection) || void 0 === o ? void 0 : o.effectiveType) && !(0,
                                        w.Z)() && !(0,
                                        E.Z)() && n.Z.isPokiIframe && !Z && !["GB", "NL"].includes(n.Z.country);
                                  ...
                                  , v = h.lobbyID
                                  , y = h.record;
                                (v || y) && (console.info("%cPOKI_PLAYTEST:%c loading", "font-weight: bold", ""),
                                a.e(545).then(a.bind(a, 545)).then((function(e) {
                                    (0,
                                    e.initPlaytest)(A, v, y)
                                }
                                )))
                            }
                        ...
                        if ("fulfilled" === u.status && (b = u.value),
                        (0,
                        n.w)("country", (g || (null == b ? void 0 : b.ISO) || "ZZ").toUpperCase()),
                        (0,
                        n.w)("gdprApplies", (0,
                        qe.M)(n.Z.country)),
                        (0,
                        n.w)("ccpaApplies", void 0 === f ? (null == b ? void 0 : b.ccpaApplies) || !1 : f),
                        n.Z.gdprApplies && (o.strictConsentMode = !0),
                        m(),
                        "fulfilled" === p.status) {
                            var k = p.value;
                            k && (o.adSettings = k)
                        }
                        c = o.adSettings.blocklist,
                        H = c || [],
                        o.strictConsentMode && T.Z.dispatchEvent(e.Z.ready),
                        n.Z.isPlayground || o.loadMonetizationCore()
                    } catch (t) {
            ...
            o.prototype.loadMonetizationCore = function() {
                return ut(this, void 0, void 0, (function() {
                    var o, r, a, s, d, c, l, p, A, h, f, m, v, g, y, w, k = this;
                    return pt(this, (function(Z) {
                        switch (Z.label) {
                        case 0:
                            return o = this.initOptions,
                            r = o.prebid,
                            a = void 0 === r ? {} : r,
                            s = o.a9Signals,
                            d = void 0 === s ? {} : s,
                            ...
                            A = o.displayOnly,
                            h = void 0 !== A && A,
                            f = lt({}, this.initOptions),
                            m = f.nonPersonalized,
                            v = void 0 !== m && m,
                            g = f.familyFriendly,
                            y = void 0 !== g && g,
                            n.Z.isInspector ? (this.strictConsentMode || T.Z.dispatchEvent(e.Z.ready),
                            [2]) : (v = v || !!n.Z.nonPersonalized,
                            y = y || !!n.Z.familyFriendly,
                            (0,
                            n.w)("nonPersonalized", v),
                            (0,
                            n.w)("familyFriendly", y),
                            w = [],
                            this.displayOnly = h,
                            !this.strictConsentMode || n.Z.familyFriendly ? [3, 2] : [4, new Promise((function(e) {
                                n.Z.gdprApplies && !i.Z.debug || e();
                                var t = 0
                                  , o = function() {
                                    if (!u)
                                        return t++,
                                        void setTimeout(o, 50 * t);
                                    window.__tcfapi("addEventListener", 2, (function(t, n) {
                                        var i, o;
                        ...
                        case 2:
                            ...
                            h || w.push((0,
                            b.Z)),
                            n.Z.familyFriendly || n.Z.nonPersonalized ? (n.Z.familyFriendly && this.display.enforceFamilyFriendlyFlow(),
                            (0,
                            n.w)("nonPersonalized", "true"),
                            this.display.enforceNonPersonalized()) : w.push((0,
                            b.Z), (0,
                            b.Z)),
                            ...
                            [2, Promise.allSettled(w).then((function(o) {
                                try {
                                    ...
                                    ue(a, k.adSettings.bidderLimitation),
                                    ce(d, k.adSettings.bidderLimitation),
                                    window.googletag.cmd.push((function() {
                                        googletag.pubads().addEventListener("rewardedSlotReady", (function(n) {
                                            t.Z.track(e.Z.tracking.ads.rewardedWeb.ready),
                                            n.makeRewardedVisible()
                                        }
                                        )),
                                        ...
                                        googletag.pubads().addEventListener("rewardedSlotClosed", (function() {
                                            var n, i, o;
                                            fe ? t.Z.track(e.Z.tracking.ads.rewardedWeb.closedGranted) : t.Z.track(e.Z.tracking.ads.rewardedWeb.closedDeclined),
                                            (null === (i = null === (n = null === window || void 0 === window ? void 0 : window.location) || void 0 === n ? void 0 : n.toString()) || void 0 === i ? void 0 : i.includes("#goog_rewarded")) && (null === (o = null === window || void 0 === window ? void 0 : window.history) || void 0 === o || o.go(-1)),
                                            T.Z.dispatchEvent(e.Z.ads.completed, {
                                                rewardAllowed: fe
                                            })
                                        }
                                        ...
                                        googletag.pubads().addEventListener("slotRenderEnded", (function(n) {
                                            var i;
                                            ge() === (null === (i = null == n ? void 0 : n.slot) || void 0 === i ? void 0 : i.getAdUnitPath()) && n.isEmpty && (t.Z.track(e.Z.tracking.ads.rewardedWeb.empty),
                                            T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow))
                                        }
                                        )),
                                        googletag.pubads().addEventListener("slotRequested", (function(n) {
                                            n || (t.Z.track(e.Z.tracking.ads.rewardedWeb.empty),
                                            T.Z.dispatchEvent(e.Z.ads.video.startHouseAdFlow))
                                        }
                                        ))
                                    }
                                    ...
                                    var c = lt({}, _);
                                    i.Z.debug && (c.adTiming.startAdsAfter = 0,
                                    k.setAdTimings(c.adTiming));
                                    var u = n.Z.forceAd;
                                    if (u && (k.setAdTimings({
                                        preroll: !0,
                                        timeBetweenAds: 12e4,
                                    ...
                                    c.customCriteria = lt(lt({}, c.customCriteria), {
                                        force_ad: u
                                    })),
                                    k.criteria = lt({}, c.customCriteria),
                                    k.ima = new He(l),
                                    k.playerSkin.setupEvents(k),
                                    k.startStartAdsAfterTimerOnInit && ht.startStartAdsAfterTimer(),
                                    k.waterfall = new we(k.ima,{
                                        timing: ht,
                                        totalRetries: p
                                    }),
                                    k.monetizationCoreLoaded = !0,
                                    k.GPTRejected && k.IMARejected)
                                        return void T.Z.dispatchEvent(e.Z.adblocked, {
                                            message: "Both core sdks failed to boot"
                                        });
                                    k.strictConsentMode || T.Z.dispatchEvent(e.Z.ready)
                                } catch (t) {
                                    T.Z.dispatchEvent(e.Z.adblocked, {
                                        message: "".concat(t)
                                    })
            ...
            o.prototype.requestAd = function(o) {
                ...
                if (t.Z.track(y === e.Z.ads.position.rewarded ? e.Z.tracking.screen.rewardedBreak : e.Z.tracking.screen.commercialBreak, lt(lt({}, o.rewardedKVs), b)),
                this.videoRequestInFlight)
                    T.Z.dispatchEvent(e.Z.ads.inFlight, lt(lt({}, b), {
                        onFinish: A
                    }));
                else if (this.videoRequestInFlight = !0,
                this.autoStartOnReady = !1 !== u,
                this.registerHandler("onFinish", (function(t) {
                    T.Z.dispatchEvent(e.Z.playtest.stopVideo),
                    A && A(t)
                }
                )),
                ...
                null !== y && (0,
                I.Z)(y, e.Z.ads.position))
                    if (this.displayOnly)
                        T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, b), {
                            message: "Video disabled"
                        }));
                    else {
                        if (!this.sdkBooted)
                            return T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, b), {
                                message: "Requesting ad on unbooted SDK"
                            })),
                            void this.sdkNotBootedButCalled();
                        if (((0,
                        w.Z)() || (0,
                        E.Z)()) && y !== e.Z.ads.position.rewarded)
                            if ("evoworld.io" !== ((null === (r = null === window || void 0 === window ? void 0 : window.location) || void 0 === r ? void 0 : "localhost") || ""))
                                return void T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, b), {
                                    message: "Interstitials are disabled on mobile"
                                }));
                        if ((null === (s = null === (a = this.ima) || void 0 === a ? void 0 : a.isAdRunning) || void 0 === s ? void 0 : s.call(a)) || (null === (c = null === (d = this.waterfall) || void 0 === d ? void 0 : d.isRunning) || void 0 === c ? void 0 : c.call(d)))
                            T.Z.dispatchEvent(e.Z.ads.busy, b);
                        else if (y !== e.Z.ads.position.preroll || ht.prerollPossible())
                            if (y === e.Z.ads.position.rewarded || ht.requestPossible())
                                if (y !== e.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(n.Z.country))
                                    T.Z.dispatchEvent(e.Z.ads.limit, lt(lt({}, b), {
                                        reason: e.Z.info.messages.disabled
                                    }));
                                else {
                                    if (this.strictConsentMode && !this.monetizationCoreLoaded)
                                        return y === e.Z.ads.position.rewarded || i.Z.debug ? void this.runNonIMAVideoHouseAd(b) : void T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, b), {
                                            messaage: "Ad libraries not yet loaded"
                                        }));
                                    if (!this.ima || this.sdkImaError || this.IMARejected)
                                        y === e.Z.ads.position.rewarded ? this.runNonIMAVideoHouseAd(b) : T.Z.dispatchEvent(e.Z.ads.error, lt(lt({}, b), {
                                        ...
                                        T.Z.dispatchEvent(e.Z.ads.ready, b);
                                    else {
                                        T.Z.clearVideoDataAnnotations(),
                                        T.Z.setVideoDataAnnotations(b);
                                        var k = lt(lt(lt({}, this.genericCriteria()), this.criteria), {
                                            position: y,
                                            ab: Math.round(Math.random()).toString(),
                                            refresh_number: this.refreshNumber[y],
                                            total_refresh_number: this.totalRefreshNumber[y]
                                        });
                                        this.refreshNumber[y]++,
                                        this.totalRefreshNumber[y]++,
                                        this.playerSkin.show(),
                                        this.resizeVideoAd(),
                                        this.waterfall.start(k, y)
                                    }
                                }
                            else
                                T.Z.dispatchEvent(e.Z.ads.limit, lt(lt({}, b), {
            ...
            o.prototype.displayAd = function(t) {
                var o = t.container
                  , r = t.size;
                return t.criteria = lt(lt(lt({
                    ab: Math.round(Math.random()).toString()
                }, this.genericCriteria()), this.criteria), t.criteria || {}),
                t.platformAd && (delete t.criteria.p4d_game_id_cond,
                delete t.criteria.p4d_game_id),
                i.Z.debug ? (this.display.renderAd(t),
                !0) : this.strictConsentMode && !this.monetizationCoreLoaded ? (T.Z.dispatchEvent(e.Z.ads.error, {
                    messaage: "Ad libraries not yet loaded"
                }),
                ...
                !1) : r ? this.sdkBooted ? o ? void 0 === window.googletag ? (T.Z.dispatchEvent(e.Z.ads.error, {
                    message: "Adblocker has been detected"
                }),
                !1) : this.adSettings.countryExclusion.includes(n.Z.country) ? (T.Z.dispatchEvent(e.Z.ads.limit, {
                    reason: e.Z.info.messages.disabled
                }),
                !1) : this.display.validateDisplaySettings(r) ? (this.display.renderAd(t),
                !0) : (T.Z.dispatchEvent(e.Z.ads.error, {
                    reason: "Display size ".concat(r, " is not supported on this device")
                }),
            ...
            o.prototype.startStartAdsAfterTimer = function() {
                this.sdkNotBootedButCalled() ? this.startStartAdsAfterTimerOnInit = !0 : ht.startStartAdsAfterTimer()
            }
            ,
            ...
            o.prototype.forcePreroll = function() {
                if (!this.sdkNotBootedButCalled()) {
                    var t = ht.prerollPossible;
                    ht.prerollPossible = function() {
                        return !0
                    }
                    ,
                    this.requestAd({
            ...
            o.prototype.startAdClicked = function() {
                this.sdkNotBootedButCalled() || k() && this.startAdEnabled && (this.startAdEnabled = !1,
            ...
            o.prototype.setAdTimings = function(t) {
                var n;
                void 0 === t && (t = {}),
                this.refreshNumber = ((n = {})[e.Z.ads.position.preroll] = 0,
                n[e.Z.ads.position.midroll] = 0,
                n[e.Z.ads.position.rewarded] = 0,
                n),
                ht.setTimings(t),
                ht.resetAll()
            }
            ...
            o.prototype.startAd = function() {
                ...
                this.ima.startPlayback()) : T.Z.dispatchEvent(e.Z.ads.error, {
            ...
            o.prototype.setupDefaultEvents = function() {
                ...
                T.Z.addEventListener(e.Z.ads.inFlight, (function(t) {
                    var n, i = lt({}, t);
                    delete i.onFinish,
                    null === (n = t.onFinish) || void 0 === n || n.call(t, lt(lt({}, i), {
                        type: e.Z.ads.busy,
                        rewardAllowed: !1
                    }))
                }
        ...
        const mt = ft;
        var vt = new (a(95).ZP)(new mt);
        for (var gt in vt)
            window.PokiSDK[gt] = vt[gt]
    }
    )()
}
)();
